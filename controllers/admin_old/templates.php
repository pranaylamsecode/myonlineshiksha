...
class Templates extends MLMS_Controller {
    ...
    {			  
		...
		$file = FCPATH.'public/uploads/settings/img/'. $generate1 . '.png';
		...
		if(file_put_contents($file, $data))//for upload file to the server
		{
			//executed
                ...
                $config = array();
        		$config['image_library'] = 'gd2';
        		$config['source_image'] = FCPATH.'public/uploads/settings/img/'. $generate1 . '.png';
        		$config['new_image'] = FCPATH.'public/uploads/settings/img/logo/'. $generate1 . '.png';
        		$config['create_thumb'] = TRUE;
        		$config['maintain_ratio'] = FALSE;
        		$config['master_dim'] = 'width';        		
                $config['width'] = 1140;
    ...
    {		
		...
		{
			$file = FCPATH.'public/classic/'. $generate1 . '.png';
                ...
                $config = array();
        		$config['image_library'] = 'gd2';
        		$config['source_image'] = FCPATH.'public/classic/'. $generate1 . '.png';
        		$config['new_image'] = FCPATH.'public/classic/images/'. $generate1 . '.png';
        		$config['create_thumb'] = TRUE;
        		$config['maintain_ratio'] = FALSE;
        		$config['master_dim'] = 'width';
                $config['width'] = 1350;
    ...
    {
    	$file = FCPATH.'public/classic/images/'. $generate1 . '.png';
