...
class Programs extends MLMS_Controller 
{
   ...
   /*	function authenticate()
	...
	{	 //exit("yes");
		...
		// setcookie("user", "program/program/$pro_id", time()+3600,"base_url()",1,1);
		...
		$certificate_term = $program->certificate_term;		
		
		$certinfo = $this->Program_model->getCertificates(1);
		$avg_cert = $certinfo->avg_cert;
		$id_final_exam = $program->id_final_exam;
		$result_maxs = $this->Program_model->getQuiz($id_final_exam);
		$result_maxs = $result_maxs->max_score;
		$course_image ="";*/
 ...
 //         // echo $_FILES[$file_element_name];
  ...
  //       if($this->input->post('media_id'))
	 //    {
		...
		// 	//commented by yogesh on dated 05-01-2014
		...
		// 					   'access' => $access[$i]
		// 				   );
		// 				   $this->program_model->insertMediarel($ins_data);
		// 				   $i++;
		// 	}
		// }
