...
class Blogs extends MLMS_Controller
{
  ...
  /*function create_blog()
  {
    $tags = $this->Crud_model->GetData('mlms_blog_tags');
    $categories = $this->Crud_model->GetData('mlms_blog_category',"","status = 'publish' and is_delete = 'no'");
    $data = array(
          'heading'     => "New Blog Post",
          'button'      => 'create',
          'actionUrl'   => 'admin/blogs/create_process',
          'tags'        => $tags,
          'categories'  => $categories,
          'title'       => set_value('title'),
          'blog_image'  => set_value('blog_image'),
          'tags_id'     => set_value('tags_id'),
          'post'        => set_value('post'),
    ...
    $this->template->title("Create Post");
    $this->template->set_layout('backend');
    $this->template->build('admin/blogs/create_view',$data);
  }*/
