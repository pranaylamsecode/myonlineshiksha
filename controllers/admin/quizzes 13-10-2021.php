...
class Quizzes extends MLMS_Controller {
  ...
  $questions = $this->exam_model->getexamdetail($exam_id);
    if($questions)
    {
      // echo $questions->exam_title;

      // print_r($questions);
       echo "<span href='javascript:void(0)' class='col-sm-8'>".$questions->exam_title."</span><span class='col-sm-4'><a target='_blank' href='".base_url()."admin/exams/edit_exam/".$questions->exam_id." '>view</a> <a target='_blank' href='".base_url()."admin/exams/edit_exam/".$questions->exam_id." '>edit</a></span>";
     }
  }
