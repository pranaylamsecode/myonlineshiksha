...
class webinars extends MLMS_Controller {
 ...
 $data['fromemail'] = $urldomain;
	...
	function edit($id = FALSE, $proid = FALSE)
	{
		...
		//$proid = ( $this->uri->segment(5) )  ? $this->uri->segment(5) : $this->input->post('proid', TRUE);
		...
		$this->template->set('webinar', $this->webinars_model->getItems($proid,$id));
