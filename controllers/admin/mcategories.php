...
class Mcategories extends MLMS_Controller {
	...
	function delete()
	{
		...
		if($mids)
		{
		echo 'Any of the Media is assigned under this Category. You cannot delete it';
		}
		else
		{
			$id = ($id != 0) ? filter_var($id, FILTER_VALIDATE_INT) : NULL;
	 ...
	 public function changeStatus()
  	{
		...
		if($published==1)
		{
			echo 'Media category published successfully!';
		}
		else
		{
			echo 'Media category unpublished successfully!';
		}
  	}
}