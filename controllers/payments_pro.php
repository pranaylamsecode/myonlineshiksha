...
class Payments_pro extends CI_Controller 
{
	...
	function index()
	{
		...
		//$this->load->view('paypal/get_balance');
	}
	...
	function Do_direct_payment()
	{
		...
		$CCDetails = array(
							...
							'acct' => '132132156464', 								// Required.  Credit card number.  No spaces or punctuation.  
							'expdate' => '0820', 							// Required.  Credit card expiration date.  Format is MMYYYY
							'cvv2' => '', 								// Requirements determined by your PayPal account settings.  Security digits for credit card.
							'startdate' => '082014', 							// Month and year that Maestro or Solo card was issued.  MMYYYY
							'issuenumber' => '132132156464'							// Issue number of Maestro or Solo card.  Two numeric digits max.
						);
	...
	$today=date('Y-m-d H:i:s');
		...
		$CCDetails = array(
							...
							'expdate' => '032018', 							// Required.  Credit card expiration date.  Format is MMYYYY
							'cvv2' => '123', 								// Requirements determined by your PayPal account settings.  Security digits for credit card.
							'startdate' => $today, 							// Month and year that Maestro or Solo card was issued.  MMYYYY
							'issuenumber' => ''							// Issue number of Maestro or Solo card.  Two numeric digits max.
						);
						
		$PayerInfo = array(
							'email' => 'rajesh.pelne90-facilitator@gmail.com', 								// Email address of payer.
							'payerid' => '321654654', 							// Unique PayPal customer ID for payer.
							'payerstatus' => '', 						// Status of payer.  Values are verified or unverified
							'business' => 'Rajesh P' 							// Payer's business name.
						);
