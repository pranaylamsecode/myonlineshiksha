...
date_default_timezone_set($configarr[0]['time_zone']);
	...
	public function index($user_id = NULL)
	{
      ...
      $path=base_url() . "questions/index";

      $start = ($this->uri->segment(3)) ? $this->uri->segment(3) : 0;
      $baseurl = base_url() . "questions/index";
      ...
      $data['questions'] = $this->questions_model->getQuestions($user_id,$config['per_page'],$start,$search_string,$search_ugroup);  
      $data['countusers'] = $this->questions_model->getcountQuestion();
     ...
     $this->load->view('new_template_design/footer');
      ...
      // $this->template->build('questions/list');
	}
    ...
    {    
      ...
      $createdBy = $this->questions_model->questionCreatedBy($q_id);
      ...
      $this->authenticate();
        ...
        if($this->input->post('btnSave') == '')
        {
        	$this->template->build('questions/edit');
        }
        else
        {
            // if($this->input->post('chkInpool') == 'on')
