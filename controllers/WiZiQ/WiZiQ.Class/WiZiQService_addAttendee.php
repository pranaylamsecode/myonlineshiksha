<?php
		...
		//$obj_add=new AddAttendee($secretAcessKey,$access_key,$webServiceUrl,$webinarobj,$sessionarray,$dbname,$db_uname,$username);
		
		//require_once("create.php");
		//$obj=new ScheduleClass($secretAcessKey,$access_key,$webServiceUrl,$data);
