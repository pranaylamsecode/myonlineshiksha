<?php
		...
		// $obj=new ModifyClass($secretAcessKey,$access_key,$webServiceUrl,$dbname,$db_uname,$id);
		
		//require_once("AddAttendee.php");
		//$obj=new AddAttendee($secretAcessKey,$access_key,$webServiceUrl);
		
		require_once("CancelClass.php");
		$obj=new CancelClass($secretAcessKey,$access_key,$webServiceUrl,$id,$class_id);
		// $obj=new CancelClass($secretAcessKey,$access_key,$webServiceUrl,$dbname,$db_uname,$id,$class_id);
