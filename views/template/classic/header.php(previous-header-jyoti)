...
?>
<link rel="stylesheet" href="<?php echo base_url(); ?>public/classic/css/bootstrap.css" type="text/css" media="screen" />
<link rel="stylesheet" href="<?php echo base_url(); ?>public/classic/css/bootstrap-responsive.css" type="text/css" media="screen" />
      ...
      <div id="headtop1" class="top_bar_right">
        <div class="mainmenu" id="headd">
          <div class="main_menu menupos_right">
			...
			if(@$get_student_instr->is_instructor == '1' || @$userDetail[0]['group_id'] == '2' || @$userDetail[0]['group_id'] == 5 || @$userDetail[0]['group_id'] == 4 || @$userDetail[0]['group_id'] == 3) // added by jayesh
			{
			?>
              <?php
			}
			...
			?>
			  ...
			  <?php
				...
				if(@$get_student_instr->is_instructor == '1' || @$userDetail[0]['group_id'] == '2' || @$userDetail[0]['group_id'] == 5 || @$userDetail[0]['group_id'] == 4 || @$userDetail[0]['group_id'] == 3) //added by jayesh
				{
					...
					{
				?>
				<li onclick="viewsite();" ><a href="#" title='Manage Academy'><i class="entypo-vcard ent-vc"></i><span class="ent-vc1" style="color:white">Manage Academy</span></a>
				 |
				 <?php
				}
				 ?>
				<li class="dropdown"><a href="#" title='Your Teaching Zone'><i class="entypo-sound ent-vc"></i><span class="ent-vc1" style="color:white">Your Teaching Zone</span><i class="entypo-down-open-mini"></i></a>
				...
				{			   
				?>            
				<li class="dropdown "><a href="#" title='Your Learning Zone'><i class="entypo-brush ent-vc"></i><span class="ent-vc1" style="color:white">Your Learning Zone</span><i class="entypo-down-open-mini"></i></a>
                <ul>
...
<!-- 				  <li><a href="<?php echo base_url(); ?>your-support"><span>Support / Query</span></a></li>
 -->
                </ul>
				</li>
				<?php			   
