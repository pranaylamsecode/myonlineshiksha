...
<div class="span4">
	<div class="item">
    	<div class="ch-item ch-img-1 thumb" style="background-image: url('<?php echo base_url(); ?>public/uploads/programs/img/thumb_232_216/<?php echo $prodata[0]->image;?>'); background-repeat: no-repeat;">
					<?php
