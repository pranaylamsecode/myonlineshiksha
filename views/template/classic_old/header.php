...
<script type="text/javascript" src="<?php echo base_url();?>public/js/jquery.lightbox_me.js"></script>
<script type="text/javascript" src="<?php echo base_url();?>public/js/jquery.leanModal.min.js"></script>
<script type="text/javascript" src="<?php echo base_url();?>public/js/redactor-js-master/redactor/redactor.min.js"></script>
        ...
        <div class="mainmenu" id="headd">
          <div class="main_menu menupos_right">
			...
			?>
			  ...
			  <?php
				...
				if(@$get_student_instr->is_instructor == '1' || @$userDetail[0]['group_id'] == '2' || @$userDetail[0]['group_id'] == 5 || @$userDetail[0]['group_id'] == 4) //added by jayesh
				{
					...
					{
				?>
				<li onclick="viewsite();" ><a href="#"><span style="color:white">Manage Academy</span></a>
				 |
				 <?php
				}
				 ?>
				<li class="dropdown"><a href="#"><span style="color:white">Your Teaching Zone</span><i class="entypo-down-open-mini"></i></a>
                <ul>
                  <li><a href="<?php echo base_url(); ?>manage/courses"><span>Courses You Teach</span></a></li>
                  <li><a href="<?php echo base_url(); ?>manage-exams"><span>Your Question Papers</span></a></li>
                  <li><a href="<?php echo base_url(); ?>questions/manage"><span>Your Questions</span></a></li>
				...
				{			   
				?>            
				<li class="dropdown "><a href="#"><span style="color:white">Your Learning Zone</span><i class="entypo-down-open-mini"></i></a>
                <ul>
			...
			if($auth)
			{
				...
				{
			?>
			 <li class="dropdown "> <a href="#notification" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true"> <i class="entypo-bell" style="color:#FFFFFF; font-size: 18px;"></i> <span class="badge badge-info"><?php echo $viewed; ?></span></a> </li>
			  <!--<li class="dropdown "> <a href="#messages" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true"> <i class="entypo-mail"></i><?php if(count($message) > 0) { ?> <span class="badge badge-secondary"><?php echo count($message);  ?></span><?php } ?></a> </li>-->
            ...
            <?php
			 // print_r($userDetail[0]['show_facebook'];
...
<nav>
  <div class="container">
    <div class="row-fluid"> 
      <!-- Logo-->
      <div class="span3" id='span33' >  <a href="<?php echo base_url(); ?>" class="logo"><img border="0" alt="" width="209" height="54" src="<?php echo base_url(); ?>public/uploads/settings/img/logo/<?php echo $logoimage;?>" ></a> </div>
      <!-- End Logo--> 
      <!-- Intro Text-->
      <div class="span9">
  ...
  <div id="header">
    ...
    <div class="logoright">
      	<div class="socialicon"> 
		    ...
		    <a target="_blank" href="http://<?php echo $allsociallinks[1]->siteurl;?>"><img alt="" width='24' height='24' src="<?php echo base_url(); ?>public/default/images/social_icons/icon-twitter.png"></a> 
		    <a target="_blank" href="http://<?php echo $allsociallinks[2]->siteurl;?>"><img alt="" width='24' height='24' src="<?php echo base_url(); ?>public/default/images/social_icons/icon-google-plus.png"></a> 
		    <a target="_blank" href="http://<?php echo $allsociallinks[3]->siteurl;?>"><img alt="" width='24' height='24' src="<?php echo base_url(); ?>public/default/images/social_icons/icon-rss.png"></a> 
		    <a target="_blank" href="http://<?php echo $allsociallinks[4]->siteurl;?>"><img alt="" width='24' height='24' src="<?php echo base_url(); ?>public/default/images/social_icons/icon-you-tube.png"></a>-->
...
<span id="msgspan"></span>
	...
	<div class="left_panel_log_popup">
		...
		if($this->config->item('facebook_id', 'oauth2'))
			{			
		?>
		<div class="social_btn_space">
		<a href="<?php echo base_url(); ?>hauth/login/Facebook" class="btn btn-fb-social"><i class="entypo-facebook social-icon"></i>
		<span>Login with Facebook</span></a>
		</div>
		<?php
			}
			if($this->config->item('google_id', 'oauth2'))
			{
		?>
		<div class="social_btn_space">
		<a href="<?php echo base_url(); ?>auth_oa2/session/google/" class="btn btn-google-social"><i class="entypo-gplus social-icon"></i>
...
<div id="forget-ct">
    ...
    <div id="messageForget"></div>
		...
		<div class="txt-fld">
			<input id="emailForget" type="text" size="15" name="emailForget" autocomplete="off" value="" placeholder="E-mail" />
		</div>
		
		<div class="btn-fld" style="  margin: 0 auto;
  width: 300px;">
...
<div id="showFirstTime-ct">
    ...
    <div id="messageForget"></div>
		...
		<!--<div class="btn-fld" style="  margin: 0 auto;
  width: 300px;">
		<button type="button" onclick="forgetPassword();" id ="resetPassword" class="btn-primary_stb" style="width:50%">Admin Console</button>
...
<div id="notification">
	<ul class="dropdown-menu">  
		<li class="top"> 
            ...
            <a href="#" class="pull-right">Mark all Read</a>You have <strong style="font-weight: normal;">
		...
		<li> 
			<ul class="dropdown-menu-list scroller" tabindex="5001" style="overflow: hidden; outline: none;"> 
				<?php				    
					...
					?>
					<li class="unread notification-success"> <a href="<?php echo base_url().'notification/activity/'.$notify->activity_id; ?>">  <?php  if($notify->viewed == 0) { echo "   <span class='line'><strong>".$notify->activity."</strong></span>"; } else { echo $notify->activity; } ?> <span class="line small" style="font-size: 85%;"> <?php echo ' '.$notify_date;  ?>  </span>  </a> </li> 
					<?php
					}
                ?>				
			</ul>
    ...
    $('#submitPopup').click(function () {	
        ...
        $.ajax({
            ...
            success: function(response) 
			{
                ...
                if(response == 'success') 
				{
					/*$("#registerPopup").slideUp('slow', function() 
					{
						$("#messageRegistration").html('<div class=txt-fld><p style="color:green; text-align:center;"><b>Log In Successful. Welcome To HIC.</b></p></div>');
					});*/
            ...
            var base_url = window.location.origin;
				...
				{ 
                    ...
                    $("#messageRegistration").html('<div class=txt-fld><p style="color:red; text-align:center;"><b>Password and confirm password is not equal...</b></p></div>');
                }
				else if(response == 'Please fill proper data...')
				{
					$("#passwordPopup").val('');
					$("#password_confirmPopup").val('');
                    $("#messageRegistration").html('<div class=txt-fld><p style="color:red; text-align:center;"><b>Please fill proper data...</b></p></div>');
				}
				else if(response == 'Email Already Exist.')
				{
					$("#passwordPopup").val('');
					$("#password_confirmPopup").val('');
                    $("#messageRegistration").html('<div class=txt-fld><p style="color:red; text-align:center;"><b>Email Already Exist.</b></p></div>');
				}
				else if(response == 'Password atleast 6 digits')
				{
					$("#passwordPopup").val('');
					$("#password_confirmPopup").val('');
                    $("#messageRegistration").html('<div class=txt-fld><p style="color:red; text-align:center;"><b>Password atleast 6 digits</b></p></div>');
				}
            }
         }); 
        return false;      
        ...
        //alert(response);
			    if(response == 'success') 
				{
                  ...
                  $("#msgspan").html('<p style="color:green; text-align:center;"><h2>Log In Successful.</h2></p>');
					...
					//window.location.replace("http://216.185.43.221/prshah8333/index.php/category");
                } 
