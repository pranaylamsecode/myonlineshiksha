		...
		<div>		
				...
				<!-- ........................... Regular.............................................. -->
					<div class="tab-pane active" id="regular">
						...
						<form action="<?php echo base_url();?>questions/create" method='post' name='frmRegular' id='frmRegular' onsubmit='return regularSubmit();'>
						<div class="panel-heading">
							<div class="panel-title" style="padding-bottom: 0px;">	
								<h3 style="margin-top: 0;">Regular</h3>
								<p style="margin-bottom: 0px;">This would be a Multiple choice question having only one correct answer</p>
							</div>
						...
						<div class="form-group">						
							...
							<div class="col-sm-5">							
	                      		<textarea id="txtQuestion" name="txtQuestion" class="form-control" rows="6"  data-validation="required" data-validation-error-msg="Enter valid Question" /></textarea>
						...
						<div class="form-group">						
							...
							<div class="col-sm-5">							
	                      		<input type='text' id="txtPoints" name="txtPoints" class="form-control" onkeypress="return isNumberKey(event)"  data-validation="number" data-validation-error-msg="Enter valid Marks" />
						...
						<?php echo lang('que_correct');?>
								...
								<tbody>
									<tr>
									 	<td>1</td>
									 	<td><input type='text' class='form-control' name='txtRegOpt1' id='txtRegOpt1' data-validation="required" data-validation-error-msg="Enter valid Option" /></td>
									 	<td><input type='checkbox' name='chkReg1' id='chkReg1'></td> 
									</tr>
									<tr>
									 	<td>2</td>
									 	<td><input type='text' class='form-control' name='txtRegOpt2' id='txtRegOpt2' data-validation="required" data-validation-error-msg="Enter valid Option" /></td>
					...
					<form action="<?php echo base_url();?>questions/create" method='post' name='frmMatch' id='frmMatch' onsubmit='return matchThePairSubmit()'>
					...
					<div class="panel-heading">
						...
						<!-- @@@@@@@@@@@@ tooltip end @@@@@@@@ -->
								...
								<tbody>
									<tr>
									 	<td>1</td>
									 	<td><input type='text' class='form-control' name='txtMatchque1' id='txtMatchque1' required onblur='addAtributeRequired(1)' data-validation="required" data-validation-error-msg="Enter valid Question" ></td>
									 	<td><input type='text' class='form-control' name='txtMatchpair1' id='txtMatchpair1' data-validation="required" data-validation-depends-on="txtMatchque1" data-validation-error-msg="Enter valid Pair" ></td> 
									 	<td><input type='text' class='form-control' name='txtMatchpoints1' id='txtMatchpoints1' onkeypress="return isNumberKey(event)" data-validation="required" data-validation-depends-on="txtMatchpair1" data-validation-error-msg="Enter valid score" /></td>
									</tr>
									<tr>
									 	<td>2</td>
									 	<td><input type='text' class='form-control' name='txtMatchque2' id='txtMatchque2' required onblur='addAtributeRequired(2)' data-validation="required" data-validation-error-msg="Enter valid Question" ></td>
									 	<td><input type='text' class='form-control' name='txtMatchpair2' id='txtMatchpair2' data-validation="required"  data-validation-depends-on="txtMatchque2" data-validation-error-msg="Enter valid Pair" ></td> 
									 	<td><input type='text' class='form-control' name='txtMatchpoints2' id='txtMatchpoints2' onkeypress="return isNumberKey(event)"  data-validation="required" data-validation-error-msg="Enter valid score"  data-validation-depends-on="txtMatchpair2" /></td>
									</tr>
									<tr>
									 	<td>3</td>
									 	<td><input type='text' class='form-control' name='txtMatchque3' id='txtMatchque3' onblur='addAtributeRequired(3)' ></td>
									 	<td><input type='text' class='form-control' name='txtMatchpair3' id='txtMatchpair3' data-validation="required" data-validation-error-msg="Enter valid Pair"  data-validation-depends-on="txtMatchque3" ></td> 
									 	<td><input type='text' class='form-control' name='txtMatchpoints3' id='txtMatchpoints3' onkeypress="return isNumberKey(event)" data-validation="required" data-validation-error-msg="Enter valid score"  data-validation-depends-on="txtMatchpair3" /></td>
									</tr>
									<tr>
									 	<td>4</td>
									 	<td><input type='text' class='form-control' name='txtMatchque4' id='txtMatchque4' onblur='addAtributeRequired(4)' ></td>
									 	<td><input type='text' class='form-control' name='txtMatchpair4' id='txtMatchpair4' data-validation="required" data-validation-error-msg="Enter valid Pair"  data-validation-depends-on="txtMatchque4" ></td> 
									 	<td><input type='text' class='form-control' name='txtMatchpoints4' id='txtMatchpoints4' onkeypress="return isNumberKey(event)" data-validation="required" data-validation-error-msg="Enter valid score"  data-validation-depends-on="txtMatchpair4" /></td>
									</tr>
									<tr>
									 	<td>5</td>
									 	<td><input type='text' class='form-control' name='txtMatchque5' id='txtMatchque5' onblur='addAtributeRequired(5)' ></td>
									 	<td><input type='text' class='form-control' name='txtMatchpair5' id='txtMatchpair5' data-validation="required" data-validation-error-msg="Enter valid Pair"  data-validation-depends-on="txtMatchque5" ></td> 
									 	<td><input type='text' class='form-control' name='txtMatchpoints5' id='txtMatchpoints5' onkeypress="return isNumberKey(event)"  data-validation="required" data-validation-error-msg="Enter valid score"  data-validation-depends-on="txtMatchpair5" /></td>
									</tr>
								</tbody>
							</table> 	 
					...
					<form action="<?php echo base_url();?>questions/create" method='post' name='frmTrueFalse' id='frmTrueFalse' onsubmit='return truefalseSubmit()'>
						...
						<div class="form-group">						
							<label class="col-sm-3 control-label" for="question">Enter Question</label>							
							<div class="col-sm-5">							
	                      		<textarea id="txtTFQuestion"  name="txtTFQuestion"  class="form-control" rows="6" data-validation="required" data-validation-error-msg="Enter valid Question"/></textarea>
						...
						<div class="form-group">						
							<label class="col-sm-3 control-label" for="points">Enter Marks</label>							
							<div class="col-sm-5">							
	                      		<input type='text' id="txtTFPoints" name="txtTFPoints" class="form-control" onkeypress="return isNumberKey(event)" data-validation="number" data-validation-error-msg="Enter valid Mark" />
	                      		<p>The Marks which this question would carry</p>
						...
						<div class="form-group">						
							...
							<div class="col-sm-5">	
							<div class="radio"> 
								<label><input type='radio' name="rbTrueFalse" value='True' id='txtTrue'> True</label> 
							</div> 
							<div class="radio"> 
								<label> <input type='radio' name="rbTrueFalse" value='False' id='txtFalse'> False</label> 
							</div> 
					...
					<form action="<?php echo base_url();?>questions/create" method='post' name='frmsubjective' id='frmsubjective' onsubmit='return subjectiveSubmit()'>
					...
					<div class="panel-body form-horizontal form-groups-bordered"> 
						...
						<div class="form-group">						
							...
							<div class="col-sm-5">							
	                      		<textarea id="txtSubjective"  name="txtSubjective"  class="form-control" rows="6" data-validation="required" data-validation-error-msg="Please enter valid question" /></textarea>
						...
						<div class="form-group">						
							...
							<div class="col-sm-7">							
	                      		<input type='text' id="txtPoints" name="txtPoints" onkeypress="return isNumberKey(event)" class="form-control" data-validation="required" data-validation-error-msg="Please enter valid score" />
					...
					<form action="<?php echo base_url();?>questions/create" method='post' name='frmMultiple' id='frmMultiple' onsubmit='return multipleTypeSubmit()'>
						<div class="panel-heading">
						<div class="panel-title" style="padding-bottom: 0px;">	
							<h3 style="margin-top: 0;">Multiple Type</h3>
						...
						<table class="table table-bordered table-responsive">
							...
							<thead>
								...
								<tbody>
									<tr>
									 	<td>1</td>
									 	<td><input type='text' class="form-control" name='txtMultiOpt1' id='txtMultiOpt1'  onblur='addAtributeRequiredMultiple(1)'></td>
									...
									<tr>
									 	<td>2</td>
									 	<td><input type='text' class="form-control" name='txtMultiOpt2' id='txtMultiOpt2'  onblur='addAtributeRequiredMultiple(2)'></td>
					...
					<form action="<?php echo base_url();?>questions/create" method='post' name='frmMedia' id='frmMedia'  enctype="multipart/form-data" onsubmit='return mediaTypeSubmit()'>
					...
					<div class="form-group">						
						...
						<div class="form-group">		
							<label class="col-sm-3 control-label" for="question">Enter Question</label>							
							<div class="col-sm-5">							
	                      		<textarea id="txtMediaQuestion" name="txtMediaQuestion" class="form-control" rows="6" required/></textarea>
						...
						<div class="form-group">						
							<label class="col-sm-3 control-label" for="points">Enter Marks</label>							
							<div class="col-sm-5">							
	                      		<input type='text' id="txtMedPoints" name="txtPoints" class="form-control" onkeypress="return isNumberKey(event)" required />
