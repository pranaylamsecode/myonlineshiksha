      	...
      	<div class="leftcontent">
            ...
            <form class="contact-form" role="form" method="post" action="" enctype="application/x-www-form-urlencoded">
					...
					<div class="form-group">						
                        <input type="text" placeholder="Name" style="width:100%;" id="ISContactForm_name" name="name" value="<?php echo $err ? set_value('name'):''; //echo ($this->input->post('name') ? $this->input->post('name') : '') ?>">
                    	<span class="error"><?php echo form_error('name'); ?></span>
					</div>
					
					<div class="form-group">						
                        <input type="text"  placeholder="E-mail" style="width:100%;" id="ISContactForm_email" name="email" value="<?php echo $err ? set_value('email'):''; //echo ($this->input->post('email') ? $this->input->post('email') : '') ?>">
						<span class="error"><?php echo form_error('email'); ?></span>
					</div>
					
                    <div class="form-group">						
                        <input type="text" placeholder="Subject" style="width:100%;" id="ISContactForm_subject" name="subject" maxlength="128" size="60" value="<?php echo $err ? set_value('subject'):'';  //echo ($this->input->post('subject') ? $this->input->post('subject') : '') ?>">
					...
					<div class="form-group">						
                        <textarea id="ISContactForm_body" placeholder="Massege" style="width:100%;" name="body" cols="30" rows="11"><?php echo $err ? set_value('body'):''; //echo ($this->input->post('body') ? $this->input->post('body') : '') ?></textarea>
