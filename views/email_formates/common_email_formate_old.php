        ...
        <tr>
            <td align="center">
                <table cellspacing="0" cellpadding="0" style="max-width: 580px; font-size: 14px; font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; width: 100%; color: #353535;">
                            <tr>
                                <td style="padding: 10px 0;"><a href="<?php echo base_url(); ?>"><img src="<?php echo base_url();?>public/uploads/settings/img/logo/<?php echo $logoimage;?>" alt="" border="0" width="250" height="80" /></a></td>
                            </tr>
                </table>
            </td>
        </tr>
