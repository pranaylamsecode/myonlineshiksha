...
<div id="m_main">
    <table width="100%" cellspacing="0" cellpadding="0" bgcolor="#F1F1F1" style="border-bottom: 1px solid #E0E0E0;">
        <tr>
            <td align="center">
                <table cellspacing="0" cellpadding="0" style="max-width: 580px; font-size: 14px; font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; width: 100%; color: #353535;">
                            <tr>
                                <td style="padding: 10px 0;"><a href="<?php echo base_url(); ?>"><img src="<?php echo base_url();?>public/uploads/settings/img/<?php echo $logoimage;?>" alt="Academy Logo" border="0" width="250" height="80"/></a></td>
                            </tr>
                </table>
            </td>
        </tr>
                ...
                <table cellspacing="0" cellpadding="0" style="max-width: 580px; font-size: 14px; font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; width: 100%; color: #353535;" bgcolor="#fff">
                    <tr>
                        ...
                        <table width="100%" cellspacing="0" cellpadding="0">
                            <tr>
                                <td>
<h6 style="padding: 5px 0; font-size: 30px; font-weight: normal; margin: 0 0 10px 0;">Please Activate Your Account</h6>
<p>Dear user,<br /><br />
<?php echo $content;?><br /><br />
If you need help or have any questions, please contact us.<br /><br />
Best regards,<br /><br />
The Maker’s Row Team</p>
                                </td>
                            </tr>
                        </table>
                        </td>
                    ...
                    <tr>
                        ...
                        <table width="100%" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td><a href="#" style="color: #282D32">SUPPORT</a></td>
