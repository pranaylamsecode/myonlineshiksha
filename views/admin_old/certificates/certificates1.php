                ...
                <tr>
                 ...
                 <tr>
                   ...
                   <div id="background_image">
                      ...
                      <div class="col-sm-6">
                      <input type="button" id="deletebtn" onclick="javascript:deleteImage();" value="Delete this background" class="img-align btn-border-blue">
...
<!-- 
                   <td colspan="5" style="padding-right:30px; position:relative;">
...
<!-- 
                   ...
                   <td style="padding-left:6px;">
					<label class="col-sm-12 field-title no-padding">Upload your own background</label>
					 ...
					 <div id="fileUploader">
                      ...
                      <div class="qq-upload-button btn-green col-sm-2" style="position: relative; overflow: hidden; direction: ltr;">
 ...
 <a style="border-radius: 4px 4px 4px 4px;
                float: left; height: 30px; margin-right: 10px; width: 110px; background-color:#<?php echo $design_background_color; ?>" id="pick_zdonecolor" onclick="document.getElementById('show_hide_box').style.display='none';" href="javascript:pickColor('pick_zdonecolor');"></a>
					...
					<div class="form-group">
						<label for="field-ta" class="col-sm-3 control-label">Text Color</label>
                    ...
                    <input type="text" class="form-control color" onkeyup="if (this.value.length == 6) {relateColor('pick_ydonecolor', this.value); changeBcolor();}" maxlength="6" onchange="if (this.value.length == 6) {relateColor('pick_ydonecolor', this.value);}" value="<?php echo $design_text_color; ?>" id="pick_ydonecolorfield" name="st_donecolor2" size="7">
...
<div class="col-sm-5"> 
<input type="text" class="form-control" value="<?php echo $subjectt3; ?>" name="subjectt3" id="subjectt3" size="100">
</div> 
