...
?>
 <div id="editcell">
        <table class="table table-bordered responsive" width="100%" style="background-color: #f1f1f1;height: 73px;">
            <tr>
            	<td class="content-top" align="middle" style="font-size:20px;">Question and Options</td>
            </tr>
        </table>
        
            <table class="table table-bordered responsive" style="padding:15px;border:1px solid rgb(241, 241, 241);">
                <thead>
                    <tr>
                        <th width="25%" style="color:#000;background-color:rgb(241, 241, 241);">Question</th>   
                        <th><?php echo $ques_data->question ?><br/>
                        	<?php
					...
					<tr>
                        <th width="25%" style="color:#000;background-color:rgb(241, 241, 241);">Question Type</th>   
                        <th><?php echo $ques_data->question_type ?></th>                     
					</tr>
					<tr>
                        <th width="25%" style="color:#000;background-color:rgb(241, 241, 241);">Options</th>     
                        <th>
                        	<table>
                        		<thead>
                        		    <?php
                        		    ...
                        		    ?>
                        			<tr>
                        				<th><input type="checkbox" <?php if($ques_opt['0']['is_correct_answer'] == 'True') { echo 'checked'; }  ?>  /> True </th>
                        			</tr>
                        			<tr>
                        				<th><input type="checkbox" <?php if($ques_opt['0']['is_correct_answer'] == 'False') { echo 'checked'; }  ?> /> False </th>
                        			</tr>
                        			<?php
                        				}
                        			...
                        			?>
                        			<tr>
                        				<th><input type="checkbox" <?php if($options['is_correct_answer'] == 1) { echo 'checked'; } ?> readonly />
                        			...
                        			?>
                        			<tr>
                        				<th><input type="checkbox" <?php if($options['is_correct_answer'] == 1) { echo 'checked'; } ?>  />
                        				<?php echo $options['ans_option']; ?></th>
                        			</tr> 
