...
<div id="toolbar-box">
	...
	<p class="pmaintitle main_subtitle">Here you can view the sales figures of online academy course wise or period wise.</p>
</div>
<div class='clear'></div>
<div class="row">
...
<div class='clear'></div>
	...
	<thead>
		<tr role="row">        	
            ...
            <th class="sorting col-sm-2" role="columnheader" tabindex="0" aria-controls="table-2" rowspan="1" colspan="1" aria-label="Average Grade: activate to sort column ascending" style="text-align:center"><div class="col-sm-12 no-padding table-title">Sale Percentage Amount</div></th>
         </tr>	
    </thead>
...
<!--<td><?php //echo $order->id;?></td>-->
			...
			<td class="field-title " style="text-transform: capitalize;color: #949494;"><?php echo $getAuther->first_name." ".$getAuther->last_name; ?></td>
			<td class="field-title " style="text-transform: capitalize;color: #949494;"><?php echo $this->users_model->getUserName($order->userid);?></td>
			<td class="field-title " style="text-transform: capitalize;color: #949494;"><?php echo $this->users_model->getProgramName(@$coursearr[0]);?></td>
			<!--<td class=" "><?php echo @$coursearr[1];?></td>-->
            <td class="field-title " style="text-transform: capitalize;color: #949494;"><?php echo $this->users_model->getPlanName(@$coursearr[2]);?></td>
			<td class="field-title " style="text-transform: capitalize;color: #949494;"><?php echo $order->order_date.' GMT';?></td>
			...
			?>
			<td class="field-title " style="text-transform: capitalize;color: #949494;text-align:center!important;"><?php echo $get_percentage;?></td>
			<!--<td class=" ">
            <?php
