        ...
        <div class="tab-content">
          <fieldset class="adminform form-horizontal form-groups-bordered">
            ...
            <div class="col-sm-6 no-padding">
              <label class='col-sm-12 control-label field-title'class='col-sm-12 no-left-padding control-label field-title' style="padding-left:0;" for="Lesson"><?php echo 'Lecture Name:'//echo lang('web_name')?> <span class="required">*</span></label>
        ...
        <span class="error"><?php echo form_error('name'); ?> </span>
           ...
           <div class="col-sm-3 no-padding">
             ...
             <div class="col-sm-12 no-left-padding">
                ...
                <input id="lecture_duration" class="form-control form-height" type="text" name="lecture_duration" placeholder="ex.1:00 Hrs" value="1:00 Hrs" />
              </div>
           </div>
            
            <!-- <div class="col-sm-6 no-padding">
              <label class="col-sm-11 control-label field-title">Level:</label>
              <div class="col-sm-11">
...
<div class="" style="margin-bottom:40px"> 
  <div class="row">
          <div class="col-sm-2">
             ...
             <ul class="nav nav-list "> 
              ...
              <!-- first layout -->
                ...
                <div class="lyrow ui-draggable">
                  ...
                  <div class="layout-orange-bg">
                    <a href="javascript:void(0);" class="close-layout-btn remove btn btn-xs" onclick="removeele(this.id);"><div class="sprite 99close" style="background-position: -280px 0; width: 18px; height: 18px;" title="Close"></div></a> 
                    <a class="drag-layout-btn drag btn btn-default btn-xs" title="drop & drag"><i class="sprite_old leftcol"></i><i class="entypo-window"></i></a> 
                    <a href="javascript:void(0)" class="info-layout-btn btn btn-xs clone" onclick="clonele(this.id);"><div class="sprite 3copy" style="background-position: -64px 0; width: 18px;" title="Copy"></div></a> 
            ...
            <a href="javascript:void(0)" class="btn btn-info btn-xs clone" onclick="clonele(this.id);"><div class="sprite 3copy" style="background-position: -64px 0; width: 18px;" title="Copy"></div></a> 
            ...
            <div class="element-main-table">
                  <div class="box box-element ui-draggable" data-type="code" style="display:flex;"> 
                    ...
                    <a class="element-drag-btn drag btn btn-default btn-xs"><i class="entypo-window"></i></a> 
                     <a href="javascript:void(0)" class="element-copy-btn btn btn-xs clone" onclick="innerclonele(this.id);"><div class="sprite 3copy" style="background-position: -64px 0; width: 18px;" title="Copy"></div></a> 
                    <span class="element-warning-btn configuration"> 
                      <a class="btn btn-xs btn btn-xs settings" data-toggle="modal" href="#" onclick="openmyModalCode(this.id);"><div class="sprite 7settings" style="background-position: -184px 0" title="Edit Module Settings"></div></a> 
                    </span> 
                    <select class="form-control" name="Alignment" onchange="setAlign(this)">                 
                       <option value="Left">Left</option>
                       <option value="Center">Center</option> 
        ...
        <ul class="nav nav-list"> 
          ...
          <li class="boxes" id="elmBase" style="height: 50px;"> 
            ...
            <div class="box box-element ui-draggable" style="margin: 10px 10px 0 0;display: inline-block;width: 55px;">
              <a href="javascript:void(0);" class="remove btn btn-xs" onclick="removeele(this.id);">
                <div class="sprite 99close" style="background-position: -280px 0; width: 18px; height: 18px;" title="Close"></div>
              </a> 
      ...
      <div class="col-sm-9" id="rightside">
        <div id="cart2">   
           <div class="htmlpage ui-sortable dragdroplayout scrollbar2" id="style-2" style="min-height: 600px;">
        ...
        <div class="tab-content">
          ...
          <div class="grey-background" style="display: -webkit-box;">
             <!--  <label class="col-sm-3 control-label"> </label> -->
               ...
               <label class='col-sm-11 no-padding control-label dark_label' style="padding-top: 2px;" for='active'>Activate <?//=lang('web_is_active')?> </label>
        ...
        {    
            if(msg)
            {
             ...
             title: 'successful',
              ...
              var editbtn ='<input type="button" id="lecture_save" name="lecture_save" class="btn btn-success btn-green" value="Save" onclick="edit_lecture('+msg+');">';
