...
<div id="toolbar-box">
	...
	<div class="m top_main_content">
      ...
      <?php 
        ...
        {
      ?>
        <a  class='' style="cursor: pointer;margin-right: 22px;" id="inform_btn" title="Inform about this change made in lecture to all the enrolled students of this course." ><span class="icon-32-cancel"> </span>Save and Inform</a>
      ...
      <?php
        ...
        ?>  
			 ...
			 <!-- 	<a id="preview_btn" onclick="lecture_preview();" class="btn btn-success btn-blue" title="Inform about this change made in lecture to all the enrolled students of this course." ><span class="icon-32-cancel"> -->
        <a id="preview_btn" onclick="openmyModalpreview(this.id);" class="btn btn-success btn-blue" title="Inform about this change made in lecture to all the enrolled students of this course." ><span class="icon-32-cancel"> </span>Lecture Preview</a>
			...
			<a><!-- <input type="button" id='lecture_save' name="lecture_save" class='btn btn-success btn-green' value="Save & Back to list" onclick="edit_lecture();" > -->
      <input type="button" id='lecture_save' name="lecture_save" class='btn btn-success btn-green' value="Save" onclick="edit_lecture();" ></a> 
    			...
    			<a href='<?php echo base_url(); ?>admin/section-management/<?php echo $pid?>' class='btn btn-danger btn-dark-grey' id="forward" data-toggle="tooltip" title="Back to list" data-placement="bottom"><span class="icon-32-cancel"> </span>Close</a>
       ...
       //  beforeSend : function(msg){ <div id="overlay"><img  style="width: 35px; margin-left: 95px;height: 26px;" src="<?php echo base_url(); ?>public/images/loading.gif" /></div> },
        ...
        {    
            if(msg)
            {
            	$.alert({
        		 title: 'successful',
               content: 'Lecture successfully Edited',
                confirm: function()
                          {
                          	$('.error').remove();
                          return true;
                ...
                // window.parent.location.href = "<?php echo base_url(); ?>admin/section-management/<?php echo $pid?>"
               window.parent.location.href = " <?php echo base_url()?>admin/tasks/edit/"+l_id+"/"+s_id+"/"+p_id;
            } 
