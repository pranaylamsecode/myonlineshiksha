...
<div class="main_subtitle"><p>Choose the type of the Question you with to create from the below tabs</p></div>
		...
		<div>		
				...
				<div class="tab-content form-body"> 
					...
					<div class="col-sm-7 field-title" style="font-size:21px">
						<h3>Regular</h3>
						<p class ="">This would be a Multiple choice question having only one correct answer</p>
					</div>
					<form action="<?php echo base_url();?>admin/questions/create" method='post' name='frmRegular' id='frmRegular' onsubmit='return regularSubmit();'>
						...
						<div id="sticky" class="form-group" style="text-align:right;">	
							<input type='submit' name='btnSave' id='btnSave' class="btn btn-default" value='Save'>
							<a href="<?php echo base_url();?>admin/questions/" class="btn btn-red"><span class="icon-32-cancel"> </span>Cancel</a>
						</div>
						...
						<div class="form-group">						
							...
							<div class="col-sm-7">							
	                      		<input type='text' id="txtPoints" name="txtPoints" class="form-control" onkeypress="return isNumberKey(event)" required /> <!-- required -->
					...
					<p class="pquestionsub">This would be a set of maximum ten pairs of items which the examinees needs to match as per the relevance.</p>
						...
						<div id="sticky1" class="form-group" style="text-align:right;">	
							<input type='submit' name='btnSave' id='btnSave' class="btn btn-default" value='Save'>
							<a href="<?php echo base_url();?>admin/questions/" class="btn btn-red"><span class="icon-32-cancel"> </span>Cancel</a>
						</div>
					...
					<p class="pquestionsub">This would be a question where the examinees would have to select either True or False as the answer.</p>
						...
						<div id="sticky2" class="form-group" style="text-align: right;">	
							<input type='submit' name='btnSave' id='btnSave' class="btn btn-default" value='Save'>
							<a href="<?php echo base_url();?>admin/questions/" class="btn btn-red"><span class="icon-32-cancel"> </span>Cancel</a>
						</div>
						...
						<div class="form-group">						
							<label class="col-sm-3 control-label" for="question">Enter Question</label>							
							<div class="col-sm-7">							
	                      		<textarea id="txtTFQuestion"  name="txtTFQuestion"  class="form-control" rows="6" required /></textarea>
						...
						<div class="form-group">						
							<label class="col-sm-3 control-label" for="points">Enter Score</label>							
							<div class="col-sm-7">							
	                      		<input type='text' id="txtTFPoints" name="txtTFPoints" class="form-control" onkeypress="return isNumberKey(event)" required />
						...
						<div class="form-group">						
							...
							<div class="col-sm-7">							
	                      		...
	                      		<input type='radio' name="rbTrueFalse" value='False' id='txtFalse' required />  False
					...
					<div class="tab-pane" id="subjective"> 
						...
						<div id="sticky3" class="form-group" style="text-align:right;">	
							<input type='submit' name='btnSave' id='btnSave' class="btn btn-default" value='Save'>
							<a href="<?php echo base_url();?>admin/questions/" class="btn btn-red"><span class="icon-32-cancel"></span>Cancel</a>
						</div>
						...
						<div class="form-group">						
							...
							<div class="col-sm-7">							
	                      		<textarea id="txtSubjective"  name="txtSubjective"  class="form-control" rows="6" /></textarea>
						...
						<div class="form-group">						
							<label class="col-sm-3 control-label" for="points">Enter Score</label>							
							<div class="col-sm-7">							
	                      		<input type='text' id="txtPoints" name="txtPoints" class="form-control" onkeypress="return isNumberKey(event)" required />
					...
					<p class="pquestionsub">This would be a multiple choice question having more than one correct answer.</p>
						...
						<div id="sticky4" class="form-group" style="text-align:right;">	
							<input type='submit' name='btnSave' id='btnSave' class="btn btn-default" value='Save'>
							<a href="<?php echo base_url();?>admin/questions/" class="btn btn-red"><span class="icon-32-cancel"> </span>Cancel</a>
						</div>
						...
						<div class="form-group">						
							...
							<div class="col-sm-7">							
	                      		<textarea id="txtMTQuestion" name="txtMTQuestion" class="form-control" rows="6" required /></textarea>
					...
					<p class="pquestionsub" >This would be a multiple choice question having one correct answer and the question would consist of any video, image etc. With the texts.</p>
						...
						<div id="sticky5" class="form-group" style="text-align:right;">	
							<input type='submit' name='btnSave' id='btnSave' class="btn btn-default" value='Save'>
							<a href="<?php echo base_url();?>admin/questions/" class="btn btn-red"><span class="icon-32-cancel"> </span>Cancel</a>
						</div>
