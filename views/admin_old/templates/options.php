...
<div id="toolbar-box">
	...
	<div class="m">
		...
		<div id="toolbar" class="toolbar-list">
            ...
            <a href='<?php echo base_url(); ?>admin<?php //echo $quiz->category_id?>/<?php //echo $page?>' class='bforward'><span class="btn btn-red btn-dark-grey" style="padding: 9px 22px 8px!important;"><i class="entypo-cancel"></i>Cancel</span> </a>
...
<div class="themegroup1">
	...
	<a onclick="this.href='<?php echo base_url()?>admin/templates/courselist/'+document.getElementById('total_course').value" class="btn-border-blue selcourse_pop btn btn-primary cboxElement" style="margin-top: 2%;">
...
<!-- tooltip area finish -->
					...
					<div class="form-group" >
                      ...
                      <option style="font-family : Lucida Console" value="Lucida Console" <?php echo ( @$templateOptions['widget_heading_font'] == 'Lucida Console' )? 'selected="selected"' : ''?>>Lucida Console</option>
						...
						<div style="" class="form-group form-border" >
								<label for="field-1" class="col-sm-12 control-label field-title">Meta Title:
				              ...
				              <div class="col-sm-12">
				              <input type="text" value="<?php echo @$templateOptions['meta_title'] ? @$templateOptions['meta_title'] :'' ?>"  name="meta_title" class="form-control form-height" id="m_title">											
							</div>
							</div>

							<div style="" class="form-group form-border" >
								<label for="field-1" class="col-sm-12 control-label field-title">Meta Description:
				              ...
				              <div class="col-sm-12">
				              <input type="text" value="<?php echo @$templateOptions['meta_desc'] ? @$templateOptions['meta_desc'] :'' ?>"  name="meta_desc" class="form-control form-height" id="m_desc">											
							</div>
							</div>

							<div style="" class="form-group form-border" >
								<label for="field-1" class="col-sm-12 control-label field-title">Meta Keywords:
				              	<p> (This Title showup in the Search Engine Result Page.Those are the Keywords that you expect people to search in a search engine to land in your lecture page.)</p>
				              </label>
				              <div class="col-sm-12">
				              <input type="text" value="<?php echo @$templateOptions['meta_keyword'] ? @$templateOptions['meta_keyword'] :'' ?>" name="meta_keyword" class="form-control form-height" id="m_kwd">											
							</div>
							</div>
						<br />
                    <br />
							  ...
							  if($field['name'] == 'slider_desc_color')
							      {
							      	...
							      	<label  class="field-title slider-heading-left-margin labelform" style="" id="sliderTitle_colorlabel<?php echo $i ?>" >Slider Heading color :</label>
							
						<input   name="sliderTitle_color<?php echo $i ?>" id="sliderTitle_color<?php echo $i ?>" class="form_control color form-height" value="<?php echo @$templateOptions['sliderTitle_color2'] ? @$templateOptions['sliderTitle_color2'] :'' ?>" style="width: 100%; margin-top: -47px; padding-top: 7px; color: rgb(0, 0, 0); background-image: none; background-color: rgb(51, 235, 255);">
							      	</div></br></br>
							      	<?php
							      }
							      	?>
