...
<div id="sticky-anchor"></div>
	<ul id="sticky" style="list-style: none; float: right;">
    	...
    	<a href="<?php echo base_url(); ?>admin/copy/exam-paper" onclick="Joomla.submitbutton('edit')" class="btn btn-blue">
...
<div class="pexampaper"><p class="pmaintitle main_subtitle">Here you can create, store and manage exams. These exams can be incorporated into your courses from the

Course Manager. If you have set the course to be fool proof while activating the course then webcam shots and 

screenshots of the examinee's computer will be automatically taken and stored. The questions to be included in 

the exams can be selected from the Exam Questions Bank.</p></div>
<div>
...
?>
    ...
    <a title="Publish Item" href="<?php echo base_url(); ?>admin/quizzes/unpublish/<?php echo $quiz ->id?>/"><div class="sprite 9999published center" style="background-position: -340px 0;"></div></a>
		<?php }else{?>
    ...
    <a title="Unpublish Item" href="<?php echo base_url(); ?>admin/quizzes/publish/<?php echo $quiz ->id?>/"><div class="sprite 999publish center" style=" background-position: -308px 0;"></div></a>
		<?php }?>
<?php
}
else
