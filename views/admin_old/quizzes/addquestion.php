...
.top-content-style{
  ...
  padding: 24px 30px 0 13px !important;
...
//echo form_open_multipart(base_url().'admin/quizzes/create_question', $attributes);
?>

<h2 class="top-content-style" style='padding-left: 10px;'>Create Question</h2>
	...
	<div class="col-md-12">
		...
		<div>		
				...
				<div class="tab-content"> 
					...
					<form action="<?php echo base_url();?>admin/quizzes/create_question" method='post' name='frmRegular' id='frmRegular' onsubmit='return regularSubmit();'>
						...
						<div class="form-group">						
							...
							<div class="col-sm-7">							
	                      		<textarea id="txtQuestion" name="txtQuestion" class="form-control" rows="6" required data-validation="required" data-validation-error-msg="Enter valid Question"/></textarea>
					...
					<p class="pquestionsub">This would be a set of maximum five pairs of items which the examinees needs to match as per the relevance.</p>
						<form action="<?php echo base_url();?>admin/quizzes/create_question" method='post' name='frmMatch' id='frmMatch'  onsubmit='return matchThePairSubmit()'>
						<div class="form-group" style="text-align:right;">	
							<input type='submit' name='btnSave' id='btnSave' class="btn btn-default" value='Save'>
						</div>
					...
					<div class="tab-pane" id="truefalse"> 
						...
						<form action="<?php echo base_url();?>admin/quizzes/create_question" method='post' name='frmTrueFalse' id='frmTrueFalse' onsubmit='return truefalseSubmit()'>
						<div class="form-group" style="text-align: right;">	
							<input type='submit' name='btnSave' id='btnSave' class="btn btn-default" value='Save'>							
						</div>
					...
					<div class="tab-pane" id="subjective"> 
					   	<h3>Subjective</h3>
						<form action="<?php echo base_url();?>admin/quizzes/create_question" method='post' name='frmsubjective' id='frmsubjective' onsubmit='return subjectiveSubmit()'>
						<div class="form-group" style="text-align:right;">	
							<input type='submit' name='btnSave' id='btnSave' class="btn btn-default" value='Save'>							
						</div>
						...
						<div class="form-group">						
							<label class="col-sm-3 control-label" for="points">Enter Score</label>							
							<div class="col-sm-7">							
	                      		<input type='text' id="txtSubPoints" name="txtSubPoints" class="form-control" required onkeypress="return isNumberKey(event)" data-validation="required" data-validation-error-msg="Enter valid Question"/>
					...
					<p class="pquestionsub">This would be a multiple choice question having more than one correct answer.</p>
						<form action="<?php echo base_url();?>admin/quizzes/create_question" method='post' name='frmMultiple' id='frmMultiple' onsubmit='return multipleTypeSubmit()'>
						<div class="form-group" style="text-align:right;">	
							<input type='submit' name='btnSave' id='btnSave' class="btn btn-default" value='Save'>							
						</div>
					...
					<p class="pquestionsub" >This would be a multiple choice question having one correct answer and the question would consist of any video, image etc. With the texts.</p>
						<form enctype="multipart/form-data" action="<?php echo base_url();?>admin/quizzes/create_question" method='post' name='frmMedia' id='frmMedia' onsubmit='return mediaTypeSubmit()'>
						<div class="form-group" style="text-align:right;">	
							<input type='submit' name='btnSave' id='btnSave' class="btn btn-default" value='Save'>							
						</div>
...
function subjectiveSubmit()
{
	...
	// 	return false;
	// }
	// if(document.getElementById('txtSubPoints').value == '')
	// {
