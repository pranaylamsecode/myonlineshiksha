...
<!-- tooltip area finish --><!--</label>
					...
					<div class="form-group form-border" style="padding-top:0!important;">						
						<label class='col-sm-12 control-label field-title' for="name">Show in the drop down menu of the 'More Information' Tab<span class="required">*</span></label>
						<div class="col-sm-12">	                      
...
<!--remove comment form here -->
               <div class="form-group form-border">
                        ...
                        <label class='col-sm-12 field-title control-label' for="name"><?php echo "Meta Title"; ?>
                     ...
                     <?php echo form_input('metaTitle',($this->input->post('metaTitle')) ? $this->input->post('metaTitle'):(isset($page[0]['meta_title']) ? $page[0]['meta_title']:''),'class="form-control form-height"'); ?>
				...
				<div class="form-group form-border" style="padding-top:0!important;">
						<label for="field-ta" class="col-sm-12 field-title control-label">Meta Description
						...
						<div class="col-sm-12">
                            <textarea  name="meta_descript" id="meta_descript" class="form-control select-box-border" rows="4"><?php echo ($this->input->post('meta_descript')) ? $this->input->post('meta_descript') : ((isset($page[0]['meta_desc'])) ? $page[0]['meta_desc'] : ''); ?></textarea>
					...
					<div class="form-group form-border">
                        ...
                        <label class='col-sm-12 field-title control-label' for="name"><?php echo "Meta Keyword"; ?><span class="required"></span>
