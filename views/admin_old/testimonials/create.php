...
<script type="text/javascript">
	...
	// 		        focus: true,
	// 		      //  imageUpload: window.location.origin+'/admin/testimonials/getImage',
			...
			<div class="panel-body form-body">
				...
				<form role="form" class="form-horizontal form-groups-bordered">
					...
					<div class="form-group form-border">
						<label for="field-1" class="col-sm-12 control-label field-title">Title<span style="color:#FF0000;">*</span></label>
...
<!-- tooltip area finish -->
					...
					<div class="form-group form-border top-padding">
						<label for="field-ta" class="col-sm-12 field-title control-label">Description
						</label>
...
<!-- tooltip area finish -->                         
					...
					<div class="form-group form-border top-padding">
						<label for="field-1" class="col-sm-12 field-title control-label">Upload image of Testimonial Writer</label>
						...
						<div class="col-sm-8">
                            ...
                            <?php if (isset($testimonials->image)){ ?>
                                 ...
                                 <img class="img-grey-bg" style="width: 130px;" src="<?php echo base_url();?>public/uploads/testimonials/img/thumb_56_56/<?php echo $testimonials->image?>" id="imgname">

                            <?php }else{    ?>

                                 <img class="img-grey-bg" style="width: 130px;" src="<?php echo base_url();?>public/uploads/testimonials/img/thumb_56_56/<?php echo ($this->input->post('imagename')) ? $this->input->post('imagename') : 'no_image.jpg'  ?>" id="imgname">
                            ...
                            <div class="col-sm-6">
                            	 <input type="file" name="file_i" id="file_i" class="form-control form-height img-align" value="">
					...
					<div class="form-group form-border chkbox_top_padding">
						<div class="col-sm-12">
							...
							<div class="grey-background" style="display: -webkit-box;">
								<label class='col-sm-1 no-padding control-label dark_label labelforminline' for='active'> <?=lang('web_is_active')?> </label>
...
<!-- tooltip area finish -->
                    ...
                    <a href='<?php echo base_url(); ?>admin/testimonials/' class='btn btn-red btn-dark-grey'><span class="icon-32-cancel"> </span>Cancel</a>
					</div>
					</div>
				</form>				
			</div>		
