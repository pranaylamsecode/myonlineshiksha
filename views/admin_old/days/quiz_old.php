					...
					<table align="center" style="width:200px; border:1px solid #eeeeee;">
						...
						<td style="text-align:center;" id="menu_med_15">
							<div id="before_menu_med_15">
								<a href='<?php echo base_url(); ?>admin/quizzes/quizesaddtotask/15' class="selexm_pop btn btn-primary">Select Exam</a>
								&nbsp;&nbsp;&nbsp;									
          ...
          <fieldset class="adminform form-horizontal form-groups-bordered">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
               ...
               <label class='col-sm-3 control-label' for='active'> <?=lang('web_is_active')?> </label>
						...
						success: function(data)
						{
							...
							$.alert({
		                      title: 'SuccessFully Save',
		                       content: ' ',
		                       confirm: function(){ 
		                                        window.location ="<?php echo base_url();?>admin/days/"+p_id;
...
function exm_data()
	{	
		...
		//var published = $('#published').val();
		 var textarea = $('.redactor-editor').text();
		  //alert(textarea);

		 $j.session.set('exm_data', JSON.stringify({txtname: txtname,diflevl:diflevl,textarea:textarea})); 
...
<?php	}	
   ...
   else if($updType == 'create' && $this->uri->segment(6))
	{	
	?>	
		if(obj)
		{
