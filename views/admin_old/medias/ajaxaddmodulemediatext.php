...
<link rel="stylesheet" href="css/reset.css" type="text/css" media="screen" /><link rel="stylesheet" href="css/colour_standard.css" type="text/css" media="screen" /><link rel="stylesheet" href="css/style.css" type="text/css" media="screen" />-->

<div class="col-md-12">

<div id="toolbar-box">
	<div class="m">
		<div class="pagetitle icon-48-generic"><h2><?php echo 'List Text';?></h2></div>
		<p class="list_media">Click on the Name of the Media to select</p>
	</div>
</div>
<div class='clear'></div>
<?php
$attributes = array('class' => 'tform', 'name' => 'topform1');
echo form_open_multipart(base_url().'admin/medias/ajaxaddmodulemediatext/'.$medfldgroup."/".$medfldid,$attributes);
?>
...
<tbody>
	...
	<tr class="camp<?php echo $i;?>">
	    ...
	    <td>
			<a href="javascript:addmedia(<?php echo $media->id?>,'audio chat1','1gh7-(Muskurahat.Com).mp3','<?php echo $medfldgroup?>')" class="a_mlms">
