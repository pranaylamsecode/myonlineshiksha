...
echo ($updType == 'create') ? form_open_multipart(base_url().'admin/medias/createlecturemedia', $attributes) : form_open_multipart(base_url().'admin/medias/createlecturemedia/'.$id, $attributes);
...
<div class="main-content">
     ...
     ?>    
    <div>
      <legend>Add New Lecture Video</legend>
    </div>
    ...
    ?>
     <div>
      <legend>Add New Lecture Audio</legend>
    </div>
    <?php
      }
      if($m_type == 'image')
    ...
    ?>
    <div>
      <legend>Add New Lecture Image</legend>
    </div>
    <?php
      }
    ?>
            		...
            		<div class="tab-pane active" id="v_url"> 
		            	<div id="url_v" >
                            <div class="in-uvr">
                              ...
                              <br>
                              <small>e.g.: https://www.youtube.com/watch?v=Vd4iNPuRlx4</small>
	        	...
	        	<ul class="nav nav-tabs bordered">
            		...
            		<li class="active"> 
            			<a href="#a_url" data-toggle="tab"> 
            				<span class="visible-xs"><i class="entypo-user"></i></span> 
            				<span class="hidden-xs">Audio by URL</span> 
            			</a> 

            		</li> 

            		<li> 
            			<a href="#embedd_a_code" data-toggle="tab"> 
            				<span class="visible-xs"><i class="entypo-home"></i>
            				</span> <span class="hidden-xs">Embedded Audio Code</span> </a> 
            		</li> 

            		<li> 
            			<a href="#a_upload" data-toggle="tab"> 
            				<span class="visible-xs"><i class="entypo-mail"></i></span> 
            				<span class="hidden-xs">Upload Audio</span> 
            			</a> 
            		</li> 
  ...
  padding-left: 33px;">
              ...
              <br />
		            ...
		            <div class="tab-pane active" id="a_url"> 
		            	<div id="url_v" >
                            <div >
                              <input type="text" onchange="javascript:changeSource('url_a');" name="url_a" id="url_a" value="<?php echo ($this->input->post('url_a')) ? $this->input->post('url_a') : ((isset($media->url)) ? $media->url : ''); ?>" size="40" onpaste="javascript:changeSource('url_a')" onkeypress="javascript:changeSource('url_a');" >
		            ...
		            <div class="tab-pane" id="embedd_a_code"> 
	            		
	            			
	            		<div id="code_v" >
                            <div>
                             	<textarea onpaste="javascript:changeSource('code_a')" onkeypress="javascript:changeSource('code_a')" name="code_a" id="code_a" cols="35" ><?php echo ($this->input->post('code_a')) ? $this->input->post('code_a') : ((isset($media->code)) ? $media->code : ''); ?></textarea>
                            </div>
                          </div>
		            ...
		            <div class="tab-pane" id="a_upload"> 
		            	<div id="audioUploader">
                                              <div class="qq-uploader">
                                                <div class="qq-upload-drop-area" style="display: none;"><span>Drop files here to upload</span></div>
                                                <div class="qq-upload-button" style="position: relative; overflow: hidden; direction: ltr;">Choose file
                                                  <input type="file" onclick="changeSource('file_a')" name="file_a" id="file_a" class="upload_btn">
                                                </div>
                                                <ul class="qq-upload-list">
                                                </ul>
                                              </div>
		            ...
		            <input type="hidden"  name="source_a"  value=""  id="source_a">
	        </div>
	        ...
	        ?>
	        	<ul class="nav nav-tabs bordered">
            		<!-- available classes "bordered", "right-aligned" --> 
            		<li class="active"> 
            			<a href="#upload_i" data-toggle="tab"> 
            				<span class="visible-xs"><i class="entypo-home"></i>
            				</span> <span class="hidden-xs">Upload Image</span> </a> 
            		</li> 
            	</ul>

            	<div>

            	 <div class="tab-pane active" id="upload_i"> 
              ...
              <br />
		            	...
		            	<div id="imageUploader">
                            <div class="qq-uploader">
                              ...
                              <input id="image" type="file" name="file_i" />
                              ...
                              <div id="localimage_i">
                                ...
                                <?php } ?>
                                  ...
                                  <!-- <span>  
                                    <img  style="cursor:pointer" width='125px' height='130px' src="" id="imgname" class="img-responsive profile-image">
                                    <img id="blah" src="#" width="125px" height="130px" alt="your image" class="img-responsive profile-image">
                                    <div id='figDivSelect' style='display:block'>
                                      <p>Change Photo</p>
	        ...
	        ?>
              ...
              <div style="display:none;">
               ...
               <a href="#" id="disOpt"><span class="dis1">Advanced Options</span> <span class="dis2">v</span></a> 
               <br/>
            ...
            <tbody>
              <tr>
                <td><table width="100%" cellspacing="0" cellpadding="5" border="0">
                    <tbody>
                      <!-- <tr id="code_of_file">
                        <td width="20px" align="center">
                           <input type="radio" name="source_v" value="code" onchange='displayContainer(this.value)' <?php echo ($this->input->post('source_v') == "code") ? "checked" : (isset($media->source) && $media->source == 'code') ? "checked" :'';?> id="source_code_v" /></td>
                        <td> Video Code </td>
                     ...
                     <!--  <tr>
                        <td><input type="radio" onchange='displayContainer(this.value)'  name="source_v" value="url" <?php echo ($this->input->post('source_v') == 'url') ? "checked" : ((isset($media->source) && $media->source == 'url') ? "checked" : ''); ?> id="source_url_v">
                   ...
                   <!--   <tr>
                        <td><input type="radio" onchange='displayContainer(this.value)' onchange="javascript:hide_hidden_row1();" name="source_v"  value="local" <?php echo ($this->input->post('source_v') == "local") ? "checked" : (isset($media->source) && $media->source == 'local') ? "checked" : ''; ?> id="source_local_v2"></td>
                        <td colspan="2"><div>
                     ...
                     <!-- <tr>
                        ...
                        <td width="80%"><div id="imageUploader">
                            <div class="qq-uploader">
                              ...
                              <input id="image" type="file" name="file_i" id="file_i" />
              ...
              <tr>
                ...
                <td><?php
                       ...
                       // $code = ($this->input->post('description')) ? $this->input->post('description') : (isset($media->code)? $media->code : '');
                        ...
                        ?>
                  <textarea id="description" name="description" class="stinput" rows="6" ><?php echo ($this->input->post('description')) ? $this->input->post('description') : ((isset($media->description)) ? $media->description : ''); ?></textarea>
