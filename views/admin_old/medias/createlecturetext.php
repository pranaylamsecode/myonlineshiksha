...
echo ($updType == 'create') ? form_open_multipart(base_url().'admin/medias/createlecturetext', $attributes) : form_open_multipart(base_url().'admin/medias/createlecturetext/'.$id, $attributes);
              ...
              <div style="display:none;">
                ...
                <div class="col-sm-5">
                  <select onchange="changeType(this.value)" size="1" name="type" id="type">
                    ...
                    <?php if($type->name == 'docs' || $type->name == 'text') { ?> 
             ...
             <div id="advancedOptions" style="display:none"> 
              ...
              <div>
                ...
                <div class="col-sm-5">
                  ...
                  <span class="error"><?php echo form_error('category_id'); ?></span> </div>
              </div>
              <br />
