...
<div id="toolbar-box">
	<div class="m" id="content-top">
		<div class="pagetitle icon-48-generic">
			<h2 class="list-media-style"><?php echo 'List Media';?></h2>
			<p class="list_media">Click on the Name of the Media to select</p></div>
	</div>
</div>
<div>
...
echo form_open_multipart(base_url().'admin/medias/ajaxaddmodulemedia/'.$medfldgroup."/".$medfldid,$attributes);
?>
...
<?php echo form_close(); ?>
<div style="padding:15px;padding-top:0px!important;margin-top:8%">
...
<thead>
	<tr>
		...
		<th width="20" style="width:5.5%;color:#000;font-weight:bold">ID</th>
		<th style="width:54.4%;color:#000;font-weight:bold">Media Storage</th>
        <th style="width:4%;color:#000;font-weight:bold">Type </th>
		<th style="width:14.8%;color:#000;font-weight:bold">Category</th>
		<!-- <th>Publish</th> -->
   </tr>
</thead>
<?php if ($medias): ?>
...
<?php foreach ($medias as $media): ?>
	<tr class="camp<?php echo $i;?>">
	    ...
	    <td style="width:68%">
			<a href="javascript:addmedia1(<?php echo $media->id?>,'audio chat1','1gh7-(Muskurahat.Com).mp3','<?php echo $medfldgroup?>')" class="a_lms">
