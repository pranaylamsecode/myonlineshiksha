...
<div id="toolbar-box">
	<div class="m">
		...
		<div class="pagetitle icon-48-generic"><h2><?php echo 'User Permissions Manager';?></h2></div>
	</div>
</div>
...
<table class="table table-bordered datatable dataTable" id="table-2" aria-describedby="table-2_info">
	<thead>
		<tr role="row">
			...
			<th class="sorting col-sm-1" role="columnheader" tabindex="0" aria-controls="table-2" rowspan="1" colspan="1" aria-label="Student Name: activate to sort column ascending" style="text-align:center;"><div class="col-sm-12 no-padding table-title">ID</div></th>
            ...
            <th class="sorting col-sm-2" role="columnheader" tabindex="0" aria-controls="table-2" rowspan="1" colspan="1" aria-label="Student Name: activate to sort column ascending" style="text-align:center;"><div class="col-sm-12 no-padding table-title">Access</div></th>
...
<?php foreach ($groups as $group): ?>
	...
	<thead><tr class="camp<?php echo $i;?>">
	    ...
	    <td class="field-title" style="text-align:center!important;text-transform: capitalize;"><?php echo $group->id;?></td>

	    <td class="field-title" style="color: #949494;text-transform: capitalize;"><a href="<?php echo base_url(); ?>admin/aclp/create/<?php echo $group->id?>/"><?php echo $group->title?></a></td>

        <td>&nbsp;</td>

        <td>&nbsp;</td>

        <td align="center"><a class="col-sm-4" href="<?php echo base_url(); ?>admin/create/user-permissions/<?php echo $group ->id?>"><div class='sprite 1addnew' style="background-position: 0 0;" title="Add New"></div></a>
    ...
    <?php
        ...
        <a title="Publish Item" href="<?php echo base_url(); ?>admin/aclp/unpublish/<?php echo $groupmod ->id; ?>/"><div class='sprite 9999published center' style="background-position: -340px 0;"></div></a>

        <?php

        }else{ ?>

        <a title="Unpublish Item" href="<?php echo base_url(); ?>admin/aclp/publish/<?php echo $groupmod ->id;?>/"><div class='sprite 999publish center' style=" background-position: -308px 0;"></div></a>
        ...
        <a class="col-sm-4" href="<?php echo base_url(); ?>admin/edit/user-permissions/<?php echo $groupmod ->id; ?>"><div class='sprite 2edit' style="background-position: -32px 0;" title="Course Content"></div></a>
