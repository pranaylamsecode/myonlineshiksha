...
<div id="toolbar-box">
	<div class="m top_main_content">
		...
		<div class="col-sm-12 pagetitle icon-48-generic" style="padding:0;"><h2><?php echo ($updType == 'create') ? 'Add Plans' : 'Edit Plans'?></h2></div>
	</div>
</div>
					...
					<div class="form-group" style="padding-top:1.5%!important;">
						<div class="col-sm-12">
						  <div class="grey-background" style="display: -webkit-box;">
							<div class="checkbox">
								<input id="published" type="checkbox" name="published" value='1' <?php echo preset_checkbox('published', '1', (isset($subplans->published)) ? $subplans->published : ''  )?> /><label class='labelforminline' for='published'> <?php echo lang('web_is_active')?> </label>
