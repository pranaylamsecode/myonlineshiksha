...
<script type="text/javascript">
    window.onload = function() {
    	var avatar = $("#imgname",parent.document).attr('src');
        var options =
        {
            imageBox: '.imageBox',
            thumbBox: '.thumbBox',
...
function addcrop(img)//for add to favorites
    ...
    $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>admin/pcategories/uploadcourseimgpop",
            data: {img:img}, 
            ...
            success: function(data)
            {
              ...
              // parent.jQuery.fancybox.close(); 
                $("#setsrc",parent.document).val(img);
                $("#setimg",parent.document).val(data); 
              window.location.href="<?php echo base_url(); ?>admin/pcategories/createcategory";            
