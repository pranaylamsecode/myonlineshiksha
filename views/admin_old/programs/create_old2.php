...
echo ($updType == 'create') ? form_open_multipart('admin/programs/create', $attributes) : form_open_multipart('admin/programs/edit/'.$id, $attributes);
...
<dt class="selected">Course Detail</dt>
        ...
        <table class="adminform">
            ...
            <tr>
                ...
                <td>
						...
						<input id="name" type="text" name="name" maxlength="256" value="<?php echo set_value('name', (isset($program->name)) ? $program->name : ''); ?>"  title="Enter Course Name" />	
...
<!-- tooltip area finish -->						
            ...
            <tr>
                ...
                <td>
						...
						<input id="alias" type="text" name="alias" maxlength="256" value="<?php echo set_value('alias', (isset($program->alias)) ? $program->alias : ''); ?>" title="Enter Course alias name which is used as variable for course" />
...
<!-- tooltip area finish -->
            ...
            <tr>
                ...
                <td>
						...
						<select name='category_id' id='category_id' title="Select Course Category,category under which course comes">
...
<!-- tooltip area finish -->
            ...
            <tr>
                ...
                <td>
					...
					<select name='teacher_id' id='teacher_id' title="Select Trainer for current course">
...
<!-- tooltip area finish -->
            ...
            <tr>
                ...
                <td>
                    ...
                    <select name="level" id="level" title="Select Course Level">
...
<!-- tooltip area finish -->
            ...
            <tr>
                ...
                <td width="15%">Skip Section pages:</td>
                ...
                ?>
                   ...
                   <div>
                    ...
                    <div style="float:left;" title="Hide Section Page(Section Summary) of Lecture"><input value="1" <?php echo ($skip_module == '1') ? 'checked="checked"' : $skipmodule1 ?> name="skip_module" type="radio">&nbsp;Yes&nbsp;</div>

                    <div style="float:left;" title="Show Section Page(Section Summary) of Lecture"><input value="0" <?php echo ($skip_module == '0') ? 'checked="checked"' : $skipmodule2 ?> name="skip_module" type="radio">&nbsp;No</div>
                    ...
                    <table width="100%">
                        ...
                        <tbody><tr>
                            ...
                            <td>
                                   ...
                                   <textarea name="description" id="description" class="stinput" rows="6"><?php echo ($this->input->post('description')) ? $this->input->post('description') : ((isset($program->description)) ? $program->description : '');?></textarea>
...
<!-- tooltip area -->
						...
						<?php echo lang('course_fld_add-image');?>
...
<!-- tooltip area -->
						...
						<span type="text" id="exercise_files-target" class="tooltipicon" title="Click Here"></span>
						...
						<?php echo lang('course_fld_add-exercise-file');?>
...
<!-- tooltip area finish -->
            ...
            <tr>
				...
				<td>
					...
					<table style="border:1px solid #f2f2f2;" cellpadding="0" cellspacing="0" width="100%">
...
<!-- tooltip area -->
						...
						<span type="text" id="subscriptions-target" class="tooltipicon" title="Click Here"></span>

						<span class="subscriptions-target  tooltargetdiv" style="display: none;" >

						<span class="closetooltip"></span>

						<!--tip containt-->

						<?php echo lang('course_fld_subscriptions-plans');?>
                       ...
                       <tr style="background:#999">
                        ...
                        <tr>
                           ...
                           ?>
                            ...
                            <span class="error"><?php echo form_error("subscription_price[$plinid]"); ?></span>
...
<!-- tooltip area -->
						...
						<span type="text" id="renewal-target" class="tooltipicon" title="Click Here"></span>

						<span class="renewal-target  tooltargetdiv" style="display: none;" >

						<span class="closetooltip"></span>

						<!--tip containt-->

						<?php echo lang('course_fld_renewal-plans');?>
...
<!-- tooltip area finish -->
                ...
                ?>
                 ...
                 <table id="table_courses_id" width="100%" style="display:<?php echo $table_display; ?>;">
            ...
            <tr>
                ...
                <td width="82%">
                   ...
                   <textarea name="pre_req" id="pre_req" class="stinput" rows="6">
...
<!--</textarea>-->
                    ...
                    <textarea name="reqmts" id="reqmts" class="stinput" rows="6"></textarea>
...
<!-- tooltip area finish -->
						...
						<tr>
							...
							<td>
							   ...
							   <textarea rows="6" class="webnardescription" id="webnardescription" name="webnardescription"><?php echo ($this->input->post('webnardescription')) ? $this->input->post('webnardescription') : ((isset($program->webnardescription)) ? $program->webnardescription : '');?> </textarea>
