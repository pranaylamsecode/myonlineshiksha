...
<div class="col-md-6 field_content" style="width: 100%;">
	<div class="pmaintitle main_subtitle">
  	...
  	<div class="col-sm-12 progress-container">
  		...
  		<div class="col-sm-3" style="padding-left:0" title="Publish the course">
  			<div class="col-sm-2 white-circle" id="four"><span>4</span></div>
  			<div class="col-sm-10 progress-title" id="pubC" style="padding-right:0"><span >PUBLISH THE COURSE</span></div>
  		</div>
  		<div class="col-sm-3" style="padding:0 " title="Course advanced settings">
  			<div class="col-sm-2 white-circle" id="five"><span>5</span></div>
  			<div class="col-sm-10 progress-title" id="advS" style="padding-right:0"><span >COURSE ADVANCED SETTINGS</span></div>
  		</div>
  	</div>
  <ul class="nav nav-tabs bordered grey-border blue-border">
    ...
    <li> <a href="#exe_f" data-toggle="tab" class="li-border" id="exe_file"> <span class="visible-xs"><i class="entypo-cog"></i></span> <span class="hidden-xs">Exercise Files</span> </a> </li>
  ...
  <div class="tab-content tab-box">
    <div class="tab-pane active" id="course_detail">
      <fieldset class="adminform form-horizontal form-groups-bordered">
        ...
        <!-- image upload section start here -->
         ...
         <div class="form-group" >						
			...
			<div class="col-sm-5" style="width: 40.5%">
                ...
                <textarea id="todolist"  name="learn_pnt" class="form-control todolist" rows="6"><?php echo ($this->input->post('learn_points')) ? $this->input->post('learn_points') : ((isset($program->learn_points)) ? $program->learn_points : '* ');?></textarea>
        ...
        <div class="form-group"> 
						<label for="field-1" class="col-sm-3 control-label"><b>Add course preview link:</b></label> 
						...
						else
						{
                         ...
                         ?>
							...
							<input type="text" style="width: 80%" value="<?php echo ($this->input->post('preview')) ? $this->input->post('preview') : $imgname; ?>" name="preview" id="preview">
						   </div>
          ...
          <fieldset class="adminform form-horizontal form-groups-bordered">
            ...
            <div class="form-group form-border"> 
						<div class="col-sm-offset-3 col-sm-5" id="nexttab1"> 
							<a href="#ps" class="btn btn-info li-border" data-toggle="tab" id="pr_sub">
						...
						<div class="col-sm-5" id="nexttab1"> 
							<button type="button" class="btn btn-success btn-green tab-btn"> Next </button>
          ...
          <fieldset class="adminform" id="price_subs" style="<?php if(@$program->fixedrate > 0.00 || isset($countplans)) { echo 'display:block'; } else { echo 'display:none'; } ?>">
            ...
            <div class="form-group form-border"> 
						<div class="col-sm-offset-3 col-sm-5" id="nexttab4"> 
							<a href="#exe_f" class="btn btn-info li-border" data-toggle="tab" id="exe_file">
								<span class="visible-xs"><i class="entypo-user"></i></span>
								<span class="hidden-xs">Next Tab</span>
							</a>
						</div> 
					...
					<!-- <div class="col-sm-5" id="nexttab4" style="padding-left:0;">
						<a type="button" class="btn btn-success btn-green tab-btn" href="#exe_f"> Next </a>
	 				 </div> -->
      ...
      <dd class="" sno="06" id="dd_06">
        <div class="tab-content">
          ...
          <legend class="field-title tile_fld legend-gap"> Exercise Files</legend>   
             ...
             <a href = "<?php echo base_url(); ?>admin/medias/addmedia/<?php //echo $program->id; ?>" class='btn btn-info exifiles_pop btn-border-blue' id="exifiles">Select from existing files</a> 
            <a href = "<?php echo base_url(); ?>admin/medias/createexercisefile/<?php //echo $program->id; ?>" class='btn btn-success newexe_pop btn-border-green' id="newexefile">Add new exercise file </a> 
           ...
           <!-- <span class="tooltipcontainer"> 
            ...
            <div class="form-group form-border"> 
						<div class="col-sm-offset-3 col-sm-5" id="nexttab6"> 
							<a href="#publishing" class="btn btn-info li-border" data-toggle="tab" id="pub_course">
								<span class="visible-xs"><i class="entypo-user"></i></span>
								<span class="hidden-xs">Next Tab</span>
							</a>
						</div> 
      ...
      <dd class="" sno="6" id="dd_6">
        ...
        $legend = ' ';
          ...
          <!-- <div class="form-group">
            ...
            <legend style="border:none;margin-bottom:0px;"><?php echo $legend; ?></legend>
            <div class="form-group form-border">
          ...
          <div class="form-group form-border"> 
            ...
            <div class="form-group form-border"> 
						<div class="col-sm-offset-3 col-sm-5" id="nexttab5"> 
							<a href="#requirements" class="btn btn-info li-border" data-toggle="tab" id="adv_set">
								<span class="visible-xs"><i class="entypo-user"></i></span>
								<span class="hidden-xs">Next Tab</span>
							</a>
						</div> 
 ...
 <script>
	...
	jQuery(document).ready(function()
	{
  		jQuery('.li-border').click(function()
  		{
     	   ...
     	   else if(activecircle == "pub_course")
     	   {     	   	
	     	$('#four').addClass('activecircle');
     	   }
     	   else if(activecircle == "adv_set")
     	   {     	   	
	     	$('#five').addClass('activecircle');
     	   }
...
jQuery('#pubC,#four').click(function(){
    jQuery("#pub_course").click();
});

jQuery('#advS,#five').click(function(){
    jQuery("#adv_set").click();
});
