...
?>
			...
			<ul id="sticky" style="list-style: none; float: right;">
				...
				<a href="<?php echo base_url(); ?>admin/programs/trashdata" onclick="Joomla.submitbutton('edit')"  class="btn btn-default">
				...
				<li id="toolbar-new" class="listbutton" style="float: left; margin-right: 10px;">
				<a href="<?php echo base_url(); ?>admin/programs/create" onclick="Joomla.submitbutton('edit')"  class="btn btn-success">
				...
				<li id="toolbar-new" class="listbutton" style="float: left; margin-right: 10px;">
				<a href="<?php echo base_url(); ?>admin/programs/copy" class="btn btn-blue">
...
<div class="row">
    ...
    <div id="table-3_length" class="dataTables_length">
		...
		<!-- <button type="submit" value="Search" name="submit_search" class="btn btn-blue" style="padding: 6px 7px 6px 2px;"><i class="entypo entypo-search"></i> Search</button>
...
<table class="table table-bordered table-striped datatable dataTable" id="table-2" aria-describedby="table-2_info">
	<thead>
   		<tr role="row">
            ...
            <th class="sorting col-sm-4" role="columnheader" tabindex="0" aria-controls="table-2" rowspan="1" colspan="1" aria-label="Student Name: activate to sort column ascending" style="width: 239px;">Course </th>
            ...
            <th class="sorting col-sm-3" role="columnheader" tabindex="0" aria-controls="table-2" rowspan="1" colspan="1" aria-label="Curriculum / Occupation: activate to sort column ascending" style="width: 125px;">Category</th>
            ...
            <th class="sorting col-sm-2" role="columnheader" tabindex="0" aria-controls="table-2" rowspan="1" colspan="1" aria-label="Average Grade: activate to sort column ascending" style="width: 125px;">Status</th>
            
            <th class="sorting col-sm-3" role="columnheader" tabindex="0" aria-controls="table-2" rowspan="1" colspan="1" aria-label="Actions: activate to sort column ascending" style="width: 321px;">Options</th>
...
<!--<td class=" sorting_1">
			...
			<td class="">
				...
				?>
		  		...
		  		<a href="<?php echo base_url(); ?>admin/days/<?php echo $program ->id?>" class="a_mlms">
...
?>
		...
		<?php if($program->published){?>
    		...
    		<a title="Unpublish Item" href="<?php echo base_url(); ?>admin/programs/unpublish/<?php echo $program ->id?>"><!-- <img alt="Published" src="<?php echo base_url(); ?>public/images/admin/tick.png"> --><div class='sprite 9999published' style="background-position: -340px 0;"></div></a>
    		
    	<?php }else{?>

    		<a title="Publish Item" href="<?php echo base_url(); ?>admin/programs/publish/<?php echo $program ->id?>"><!-- <img alt="Unpublished" src="<?php echo base_url(); ?>public/images/admin/publish_x.png"> --><div class='sprite 999publish' style=" background-position: -308px 0;"></div></a>
...
?>
            ...
            <td class="editdelete col-sm-3">
            <div class="col-sm-12">
               <a onclick="viewsite2(<?php echo $program->id ?>,<?php echo @$days[0]->id ?>,<?php echo @$lessons[0]->id; ?>)" class="col-sm-2">
...
?>
			...
			<a  class='col-sm-2' href='<?php echo base_url(); ?>admin/programs/edit/<?php echo $program ->id?>'><div class='sprite 2edit' style="background-position: -32px 0;" title="Edit"></div></a>
...
?>
<a class="col-sm-2">
<div class='sprite 7settings' style="background-position: -184px 0" title="Settings"></div></a>
<a class="col-sm-2">
<div class='sprite 3copy' style="background-position: -64px 0; width: 18px;" title="Copy"></div></a>
<?php
if(($u_data['groupid']=='4') || ($maccessarr['courses']=='own'))
...
<!-- <a class="btn btn-danger btn-sm btn-icon icon-left" onClick="deleteconfirm(<?php echo $program->id?>)">
			<i class="entypo-cancel"></i><?php echo lang('web_delete')?></a> -->
			<a class="icon-left col-sm-2" onClick="deleteconfirm(<?php echo $program->id?>)">
...
?>
    ...
    <tr> 
      <td class="">
          <a href="<?php echo base_url(); ?>admin/days/<?php echo $program ->id?>"> COURSE CONTENT </a>
          <a  class='' href='<?php echo base_url(); ?>admin/programs/edit/<?php echo $program ->id?>'>COURSE SETTINGS</a>
      </td>
      <td class="enrol">
          <a href="<?php echo base_url(); ?>admin/programs/enrolled/<?php echo $program ->id?>"><?php echo 'STUDENTS ENROLLED ('.count($counts_students).')';?>
          </a>
      </td>
      <td class="enrol">
      <a href="<?php echo base_url(); ?>admin/programs/reviews/<?php echo $program ->id?>"><?php echo 'REVIEWS ('.count($reviews).')'; ?></a>
      </td>
      <td></td>
    </tr>
