...
class Programs extends MLMS_Controller {
	...
	//@@@@@@@@@@@@@@@@@@@@@@@new code for Prerequisites file start here
        ...
        // echo $free_coursesforcond."<br>";
        // echo $access_coursesforcond."<br>";
        // echo $planforcond."plan<br>";

		if(($free_coursesforcond == 1 && $access_coursesforcond == 0 && $planforcond =='fixed') || ($free_coursesforcond == 0 && $planforcond =='fixed'))
		{
			
			$fixedrate = $this->input->post('fixedrate');
			//echo $fixedrate."fixedrate";
		}
   //     	if(($free_coursesforcond == 1 && $access_coursesforcond == 0 && $planforcond =='subscription') || ($free_coursesforcond == 0 && $planforcond =='subscription'))
	 	// {
	 	// 	//echo "subscription";
	 	// }
		...
		$data = array(
				...
				'selected_course' => $this->input->post('selected_course'), // $selected_course_string
 ...
 //       $plans = $this->input->post('plan'); 
	...
	{	   
       ...
       // }
                      ...
                      if(isset($selected_course1)){
                          foreach($selected_course1 as $key=>$value) {
                  		   		if($value == "-1") {
                  					...
                  					$selected_course_string .= $value;  // $value."|"
                                 }
              		   }
                     }else{
                           $selected_course_string = NULL;
        ...
        if(($free_coursesforcond == 1 && $access_coursesforcond == 0 && $planforcond =='subscriptions') || ($free_coursesforcond == 0 && $planforcond =='subscriptions'))
			{
