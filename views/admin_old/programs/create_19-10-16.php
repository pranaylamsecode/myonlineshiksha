...
<div id="toolbar-box">
  <div class="m top_main_content">
	...
	?>
	  <div class="pagetitle c_main_title">
	      <h2><?php echo $pagetitle;?></h2>
	  </div>
	  <div id="sticky" class="main-content-btn" style="float:right;"> <?php echo form_submit( 'submit', ($updType == 'edit') ? "Save Changes" : "Save Changes", (($updType == 'create') ? "id='submit' class='btn btn-success btn-green'" : "id='submit' class='btn btn-success btn-green'")); ?>
	    <?php if ($updType == 'create'): ?>
	    <?php if ($parent_id != "0"): ?>
	    	<input type="submit" value="Save & Exit" name="save2" class='btn btn-success btn-blue'>
	    ...
	    <?php else: ?>
	    <?php if ($parent_id != "0"): ?>
	    	<input type="submit" value="Save & Exit" name="edit2" class='btn btn-success btn-blue'>
	    <a href='<?php echo base_url(); ?>admin/programs/' class='btn btn-default btn-dark-grey'>Cancel</a>
	    <?php else: ?>
...
<div class="col-md-6 col-sm-6 col-xs-6 field_content" style="width: 100%;">
  ...
  <ul class="nav nav-tabs bordered grey-border blue-border">
    ...
    <li style="margin-right:0!important"> <a href="#requirements" data-toggle="tab" class="li-border"> <span class="visible-xs"><i class="entypo-cog"></i></span> <span class="hidden-xs">Advanced Settings</span> </a> </li>
	<?php  
  ...
  <div class="tab-content tab-box">
    ...
    <div class="tab-pane" id="ps">
      <dd class="" sno="5">
        <div class="tab-content">
          <fieldset class="adminform form-horizontal form-groups-bordered" >
           <p class="psubtitle field-subtitle"> Through this option you can choose to make the course free for all students/free for some students and Paid for other /paid for all.</p>
            <!--@@@@@@@@@@@@@ new code start here @@@@@@@@@@@@@-->
            <!--<div class="form-group" >
        ...
        //($this->input->post('chb_free_courses')? $this->input->post('chb_free_courses') : isset($program->chb_free_courses) && $program->chb_free_courses == '1' ? "checked" : ''); ?>
         ...
         //if(!isset($program->step_access_courses) || isset($program->step_access_courses) && $program->step_access_courses == '1'){
          ...
          if(isset($courses)){ ?>
            <div class="form-group form-border">
              <div id="free_courses">
                <label class="col-sm-12 control-label of-center-align">Of
	...
	<label class="field-title">Payment Mode for the Students :</label>
	<div class="col-sm-12" style="padding:0;">
	   <div class="grey-background">
	<input class="radio-btn" type="radio" onclick="javascript:getPlan(this.value)" name="plan" id="plan" <?php if(@$program->fixedrate > 0.00) echo 'checked';  ?> value="fixed"/>Fixed Price   
	<p class="p3 paymnt-mode-para">This option allow students to make a one time payment for the course. </p>
	  </div>
	</div>
	<br>
	<div class="col-sm-12" style="padding:0;"> 
	 <div class="grey-background"> 
	  <input class="radio-btn" type="radio" onclick="javascript:getPlan(this.value)" name="plan" id="plan" <?php if(@$countplans) echo 'checked';  ?> value="subscription" />Subscription   
	  <p class="p3 paymnt-mode-para">This option will allow students to access the course for pre-defined time period, suitable for courses that may get updated with new lectures and live classes regularly.</p>
	  	 </div>
	  	</div>
	  </div>
	...
	<div class="form-group form-border" id="fixed_rate" style="<?php if(@$program->fixedrate > 0.00) { echo 'display:block'; } else{ echo 'display:none'; }  ?>">
                <label for="field-1" style="padding:0;" class="col-sm-12 control-label field-title">For Fixed Rate :</label>
                <p style="font-family: arial;color: #686c70;">(Amount to be set for the course fees.Enter only numerics and the fees will be display in the currency you have set.)</p>
                <div class="col-sm-12" style="padding:0;">
      ...
      <dd class="" sno="6" id="dd_6">
        ...
        $legend = ' ';
            ...
            <div class="form-group form-border">
            	<div class="col-sm-12">
            	  <div class="grey-background">
              	<label class='control-label'>Activate<?php //echo lang('web_active')?></label>
          ...
          <!-- <div class="form-group">
            ...
            <legend><?php echo $legend; ?></legend>
            <div class="form-group form-border">
              <label for="field-1" class="col-sm-12 control-label field-title">Title:
...
?>
          ...
          <legend class="field-title tile_fld legend-gap"> Webinar Settings</legend>
           ...
           <!--  <legend><?php echo $legend; ?></legend> -->
            <legend class="field-title tile_fld legend-gap">Exercise Files</legend>   
             <h3 class="field-title"> Select from existing exercise files from academy library or add new exercise files:
         	</p>       
	...
	<?php 
            ...
            <div class="form-group form-border" style="padding-top:0!important">
              ...
              <label for="field-1" class="col-sm-12 control-label field-title" style="padding-top:1.8%">Prerequisites Course(s):
	...
	<a href="#webinar" class="btn btn-info btn-green" data-toggle="tab">
	<span class="visible-xs"><i class="entypo-user"></i></span>
	<span class="hidden-xs">Save Changes</span>
	</a>
	<a href="#" class="btn btn-info btn-dark-grey" data-toggle="tab">
