...
function ChangeLayoutC(file){
   ...
   var img12 =  document.getElementById("localimage_i").innerHTML="<img id='imgname' width='150' src='<?php echo base_url()."public/uploads/settings/img/thumbs/";?>"+file+"' alt=''/>";
...
?>
   ...
   <dl class="tabs">
     ...
     <dt class="selected certificate-design open">Design</dt>
	  ...
	  <!--	<legend>Design</legend>     -->
        ...
        <table style="padding-left:70px;">
        	...
        	<tbody><tr>
        		...
        		<td>
					...
					<input type="submit" value="Preview Certificate" name="previewcertificate" id="previewcertificate" onclick="windowopen();" class="mlms_buynow">
       ...
       <tr>
        ...
        <td colspan="5" style="padding:6px;">
       	...
       	See your changes instantly; they're not saved until you click Save &amp; Close or Save<br>



        Note: Make sure that the title of uploaded images doesn't have spaces.		</td>
       ...
       <div id="background_image">
          ...
          <img src="<?php echo base_url();?>public/uploads/settings/img/thumbs/<?php echo $design_background ?>" width="150" id="imgname">
...
<ul class="qq-upload-list"></ul></div></div>
       ...
       <tr>
       	...
       	<td colspan="5">
        	...
        	<span style="padding-left:140px; color:#CC0000">Background size should be 800x600 px</span>
    ...
    float: left; height: 30px; margin-right: 10px; width: 110px; background-color:#ACE0F6" id="pick_zdonecolor" onclick="document.getElementById('show_hide_box').style.display='none';" href="javascript:pickColor('pick_zdonecolor');">
       ...
       <div style="float:left;">
         ...
         <a style="border-radius: 4px 4px 4px 4px; float: left; height: 30px; margin-right: 10px; width: 110px; background: none repeat scroll 0% 0% rgb(51, 51, 51); color: rgb(51, 51, 51);" id="pick_ydonecolor" onclick="document.getElementById('show_hide_box').style.display='none';" href="javascript:pickColor('pick_ydonecolor');">
     ...
     <dt class="certificate-templates closed">Templates</dt>
        ...
        <tbody><tr>
         ...
         <tr>
           ...
           <td width="73px;">Email Subject</td>
        	...
        	<td><input type="text" value="Certificate for [STUDENT_FIRST_NAME] [STUDENT_LAST_NAME] from [SITENAME]" name="subjectt3" id="subjectt3" size="100"></td>
...
<div class="button2-left"><div class="blank"><a title="Toggle editor" onclick="tinyMCE.execCommand('mceToggleEditor', false, 'email_template');return false;" href="#">Toggle editor</a></div></div></div>
        ...
        <tr>
        	...
        	<td><input type="text" value="Certificate for [STUDENT_FIRST_NAME] [STUDENT_LAST_NAME] from [SITENAME]" name="subjectt4" id="subjectt4" size="100"></td>
