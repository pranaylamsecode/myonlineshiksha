...
//print_r($settings[0]['layouttheme']);
?>
...
$(function() {
	...
	<tr>
		...
		<td class="layout_table_column2">		
			...
			<select name="layouttheme" id="layouttheme">
				<option value="style.css" <?php echo ( $settings[0]['layouttheme'] == 'style.css' )? 'selected="selected"' : ''?>>Style </option>
				<option value="style_brown.css" <?php echo ( $settings[0]['layouttheme'] == 'style_brown.css' )? 'selected="selected"' : ''?>>Style Brown</option>
				<option value="style_dark.css" <?php echo ( $settings[0]['layouttheme'] == 'style_dark.css' )? 'selected="selected"' : ''?>>Style Dark</option>
				<option value="style_darkorange.css" <?php echo ( $settings[0]['layouttheme'] == 'style_darkorange.css' )? 'selected="selected"' : ''?>>Style Dark Orange</option>
				<option value="style_eastblue.css" <?php echo ( $settings[0]['layouttheme'] == 'style_eastblue.css' )? 'selected="selected"' : ''?>>Style East Blue</option>
				<option value="style_green.css" <?php echo ( $settings[0]['layouttheme'] == 'style_green.css' )? 'selected="selected"' : ''?>>Style Green</option>
			</select>
		</td>
