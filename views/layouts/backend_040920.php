...
<div class="page-container">
    ...
    if(($u_data['groupid']==='4' || $u_data['groupid']==='2') || (in_array('courses',$this->session->userdata('mparr'))) || (in_array('media',$this->session->userdata('mparr'))) || (in_array('quizzes',$this->session->userdata('mparr'))) )
    {  
       $varmenu1 = $active_menu == 'tab1' || ($active_submenu =='programs' || $active_submenu =='medias' || $active_submenu =='pcategories' || $active_submenu =='mcategories' || $active_submenu =='course-manager' || $active_submenu =='quizzes' )  ? 'opened':''; 
    ?>
    ...
    if($u_data['groupid']==='4'){ ?>
     ...
     <?php $submenu19 = $active_submenu =='pagecreator' ? 'active':''; ?>
          ...
          <?php } ?>
              <li class="root-level has-sub <?php echo @$varmenu2; if($u_data['groupid']==='5' || $u_data['groupid']==='2'){echo 'opened';}?>"  onclick="tabMenu('tab3');" > <a href="#"><span class="lnr lnr-chart-bars"></span><span class="list_text">MARKET & SELL</span></a>
...
<script type="text/javascript">
 ...
 <script>
     $(window).on('load resize', function () {
      ...
      var header_height = $("#sidemenu header").innerHeight();
      var menus_height = height - header_height - 75 ;
       $("#sidemenu .main-menu").css({"min-height" : menus_height, "height": "auto"});
         $("#sidemenu .fix_logo_btm").show();
    });
