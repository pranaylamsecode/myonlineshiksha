...
table.table.table-bordered.quiz-table.responsive {
  padding: 15px;
}
table.scroll {
    /* width: 100%; */ /* Optional */
...
echo form_open('quizzes/quizesaddtotask', $attributes);
?>
<table cellspacing="5" cellpadding="5" bgcolor="#FFFFFF">
		<tbody><tr>
			<td style="padding-left:15px">
				<input placeholder="Exam Name" type="text" value="" name="search_text">
...
echo ($updType == 'create') ? form_open('quizzes/quizesaddtotask', $attributes) : form_open('quizzes/editque/'.$question->id.'/'.$qid, $attributes);
?>
<table class="table table-bordered quiz-table scroll responsive" style="width: 100%;">
	<thead>
		<tr>
			<th style="color:#000;font-weight:bold;" width="20">ID</th>
			<th style="width:75.8%;color:#000;font-weight:bold;">Exam Name</th>
			<th style="width:17%;color:#000;font-weight:bold;">Questions</th>
...
//if ($quiz != NULL && is_object($quiz)) {
   ...
   // }                              ?>
	<tr class="camp<?php echo $i;?>"> 	    
	   ...
	   <?php  
	    	$quiz_ids =  $this->quizzes_model->get_count_questions($quiz->id,$user_id);
	    ...
	    ?>
	    <td style="width:15%"><?php echo (isset($quiz_ids)) ? count($quizid_arr) : '0'; ?></td>
