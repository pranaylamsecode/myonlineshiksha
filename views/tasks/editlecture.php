...
/*---------------------Sprite Classes-----------------------------*/
/*.addnew { background-position: 0 0 !important; } 
.edit { background-position: -32px 0 !important; } 
.copy { background-position: -64px 0; width: 18px !important; } 
.delete { background-position: -92px 0; width: 18px !important; } 
.preview { background-position: -120px 0; height: 14px !important; } 
.search { background-position: -152px 0 !important; } 
.settings { background-position: -184px 0 !important; } 
.menu { background-position: -216px 0; height: 18px !important; } 
.move { background-position: -248px 0 !important; } 
.close { background-position: -280px 0; width: 18px; height: 18px !important; } 
.publish { background-position: -308px 0 !important; } 
.published { background-position: -340px 0 !important; } 
.sprite { 
...
#cart2 .htmlpage .drag-layout-btn {
  left: 2.5%!important;
  ...
  <div class="row">
    <div> <span style="float:left;">
      ...
      <?php 
        ...
        {
      ?>
        <a id="inform_btn" style="cursor: pointer;margin-right: 22px;color:black;" class="" title="Inform about this change made in lecture to all the enrolled students of this course." >Save and Inform</a>
      ...
      <?php
        ...
        ?>
      		...
      		<a><input type="button" id='lecture_save' name="lecture_save" class='btn btn-success' value="Save" onclick="edit_lecture();" ></a> 
...
<div class="page-container">
	<div class="main-content">	
				...
				<div class="panel-body form-horizontal form-groups-bordered" style="padding: 20px 0 0 0;">
					<div class="form-group" id="inform_txt" style="display: none;"> 
						...
						<div class="col-sm-5" style="float: right;">  
							...
							<a class="btn btn-orange" title="Inform about this change made in lecture to all the enrolled students of this course." style="margin-left: 113px;" onclick="saveAndInform();">Save and Inform</a>
						</div> 
					</div>
        ...
        <?php  if($dripstatus->is_drip_course == '1'){ 
                  ?> <input name="release_type" value="<?php echo $dripstatus->release_type; ?>" type="hidden"><?php
                  if($dripstatus->release_type == '1'){  ?>
                 
                <div class="form-group"  id="drip_date"> 
                    <label class="col-sm-3 control-label"><?php echo 'Release Date:'//echo lang('web_name')?> <span class="required">*</span></label> 

                    <div class="col-sm-5"> 
                    <input class="form-control" id="r_date" type="date" name="release_date" maxlength="256" value="<?php echo set_value('release_date', (isset($task->release_date)) ? $task->release_date : ''); ?>"  />
                ...
                <div class="form-group"  id="drip_days" > 
                    <label class="col-sm-3 control-label"><?php echo 'Release Day:'//echo lang('web_name')?> <span class="required">*</span></label> 

                    <div class="col-sm-5"> 
                      <!-- <?php echo set_value('release_date', (isset($task->release_date)) ? $task->release_date : ''); ?> -->
                    <input class="form-control" id="r_date" type="number" name="release_day" maxlength="256" value="<?php echo set_value('release_date', (isset($task->release_date)) ? $task->release_date : ''); ?>" />
                          ...
                          <?php echo "Lecture Start After Some Time Of Entroll";?> 
...
<?php  if($dripstatus->is_drip_course == '1') { ?>
                <div class="form-group"> 
            <label class="col-sm-3 control-label">Send e-mail notification?</label> 

            <div class="col-sm-5">
            <div class="checkbox"> 
                <label> <input id="notification" type="checkbox" name="email_notify" onchange="javascript:getNotify(this)"
                 <?php echo $updType == 'create' ? '': @$task->email_body == '' ? '' : 'checked'; ?> /></label>         
                      <span class="tooltipcontainer"> <span type="text" id="notify-target" class="tooltipicon"></span> <span class="notify-target  tooltargetdiv" style="display: none;" > <span class="closetooltip"></span> 
                      
                      <!--tip containt--> 
                      
                      <?php echo "Notify by e-mail"; ?> 
        ...
        <div class="form-group" id="emailbox"  style="<?php echo $updType == 'create' ? 'display:none' : @$task->email_body == '' ? 'display:none' : 'display:block'; ?>" >           
            <label class="col-sm-3 control-label" for="email">Email : <span class="required">*</span></label>           
        
        <div class="col-sm-5 mailbox" style="width: 40.5%">
                          <textarea name="body" class="form-control" id="message1"><?php  echo @$task->email_body; ?></textarea>
          <!-- tooltip area -->
          <span class="tooltipcontainer">
          <span type="text" id="message-target" class="tooltipicon" title="Click Here"></span>
          <span class="message-target  tooltargetdiv" style="display: none;" >
          <span class="closetooltip"></span>
          <!--tip containt-->
          <?php echo "Set Email Message For Attendees";?>
          <!--/tip containt-->
          </span>
          </span>
          <!-- tooltip area finish -->
                  <span id="descriptionerror" class="error" style="color: red"><br/><?php echo form_error('message'); ?></span>
        </div>
      </div>
        <?php } else { ?>
		<div class="form-group"> 
...
<div class="" style="margin-bottom:40px"> 
  <div class="row">
                ...
                <div class="layout-blue-bg layout-orange-bg">
            ...
            <div class="lyrow ui-draggable">
            <div class="layout-main-table">
                  <div class="layout-purple-bg layout-orange-bg">
              <a href="javascript:void(0)" class="close-layout-btn remove btn btn-xs" onclick="removeele(this.id);"><div class="sprite 99close" style="background-position: -280px 0; width: 18px; height: 18px;" title="Close"></div></a> 
            ...
            <div class="layout-main-table">
                  <div class="layout-purple-bg layout-orange-bg">
						<a href="javascript:void(0)" class="close-layout-btn remove btn btn-danger btn-xs" onclick="removeele(this.id);"><div class="sprite 99close" style="background-position: -280px 0; width: 18px; height: 18px;" title="Close"></div></a> 
						<a class="drag-layout-btn drag btn btn-default btn-xs">
          ...
          <div class="box box-element ui-draggable" data-type="paragraph" style="display:flex;">
              ...
              <a href="javascript:void(0)" class="element-copy-btn btn btn-xs clone" onclick="innerclonele(this.id);"><div class="sprite 3copy" style="background-position: -64px 0; width: 18px;" title="Copy"></div></a> 
						   <span class="element-warning-btn configuration"> 
						    <!--  <a class="btn btn-xs btn-warning settings" data-toggle="modal" href="#myModal" onclick="openMymodal();"> -->
						     <a class="btn btn-xs element-setting-btn settings" data-toggle="modal" onclick="openMymodal(this.id);">
            ...
            <div class="element-green-bg">
					   		...
					   		<a href="javascript:void(0)" class="element-copy-btn btn btn-xs clone" onclick="innerclonele(this.id);"><div class="sprite 3copy" style="background-position: -64px 0; width: 18px;" title="Copy"></div></a> 
					   		<span class="element-warning-btn configuration">
					    	<a class="btn btn-xs element-setting-btn settings" data-toggle="modal" href="#" onclick="openmyModalImage(this.id);">
              ...
              <a href="javascript:void(0)" class="element-copy-btn btn btn-xs clone" onclick="innerclonele(this.id);"><div class="sprite 3copy" style="background-position: -64px 0; width: 18px;" title="Copy"></div></a> 
              <span class="element-warning-btn configuration"> 
                <a class="btn btn-xs element-setting-btn settings" data-toggle="modal" href="#" onclick="openmyModalyoutube(this.id);">
                  <div class="sprite 7settings" style="background-position: -184px 0" title="Edit Module Settings"></div>
                </a>
              </span>
            ...
            <a href="javascript:void(0)" class="element-copy-btn btn btn-xs clone" onclick="innerclonele(this.id);"><div class="sprite 3copy" style="background-position: -64px 0; width: 18px;" title="Copy"></div></a> 
            <span class="element-warning-btn configuration"> 
              <a class="btn btn-xs element-setting-btn settings" href="#" data-toggle="modal"  onclick="openmyModalaudio(this.id);" ><div class="sprite 7settings" style="background-position: -184px 0" title="Edit Module Settings"></div></a> 
            </span>
            <select class="form-control" name="Alignment" onchange="setAlign(this)">                 
                 <option value="Left">Left</option>
                 <option value="Center">Center</option> 
			...
			<a href="javascript:void(0)" class="element-copy-btn btn btn-xs clone" onclick="innerclonele(this.id);"><div class="sprite 3copy" style="background-position: -64px 0; width: 18px;" title="Copy"></div></a> 
			<span class="element-warning-btn configuration"> 
				<a class="btn btn-xs element-setting-btn settings" data-toggle="modal" href="#" onclick="openmyModalGallery(this.id);"><div class="sprite 7settings" style="background-position: -184px 0" title="Edit Module Settings"></div></a> 
			</span> 
            ...
            <div class="element-main-table">
                ...
                <div class="element-green-bg pdf_view">
							...
							<a href="javascript:void(0)" class="element-copy-btn btn btn-xs clone" onclick="innerclonele(this.id);"><div class="sprite 3copy" style="background-position: -64px 0; width: 18px;" title="Copy"></div></a> 
							<span class="element-warning-btn configuration"> 
								<a class="btn btn-xs element-setting-btn settings" data-toggle="modal" href="#" onclick="openmyModalpdf(this.id);"><div class="sprite 7settings" style="background-position: -184px 0" title="Edit Module Settings"></div></a> 
							</span> 
            ...
            <div class="box box-element ui-draggable" data-type="code" style="display:flex;"> 
              ...
              <a href="javascript:void(0)" class="element-copy-btn btn btn-xs clone" onclick="innerclonele(this.id);"><div class="sprite 3copy" style="background-position: -64px 0; width: 18px;" title="Copy"></div></a> 
              <span class="element-warning-btn configuration"> 
                <a class="btn btn-xs element-setting-btn settings" data-toggle="modal" href="#" onclick="openmyModalCode(this.id);"><div class="sprite 7settings" style="background-position: -184px 0" title="Edit Module Settings"></div></a> 
              </span> 
              <select class="form-control" name="Alignment" onchange="setAlign(this)">                 
                 <option value="Left">Left</option>
                 <option value="Center">Center</option> 
            ...
            <!-- flash -->
             ...
             <div class="box box-element ui-draggable" data-type="button" style="display:flex;">
              ...
              <a href="javascript:void(0)" class="element-copy-btn btn btn-xs clone" onclick="innerclonele(this.id);"><div class="sprite 3copy" style="background-position: -64px 0; width: 18px;" title="Copy"></div></a> 
              <span class="element-warning-btn configuration"> 
                <a class="btn btn-xs element-setting-btn settings" data-toggle="modal" href="#" onclick="openmyModalflash(this.id);"><div class="sprite 7settings" style="background-position: -184px 0" title="Edit Module Settings"></div></a> 
              </span>
              ...
              <a href="javascript:void(0)" class="element-copy-btn btn btn-xs clone" onclick="innerclonele(this.id);"><div class="sprite 3copy" style="background-position: -64px 0; width: 18px;" title="Copy"></div></a> 
							<span class="element-warning-btn configuration"> 
								<a class="btn btn-xs element-setting-btn settings" data-toggle="modal" href="#" onclick="openmyModalbutton(this.id);"><div class="sprite 7settings" style="background-position: -184px 0" title="Edit Module Settings"></div></a> 
							</span>
              <select class="form-control" name="Alignment" onchange="setAlign(this)">                 
                 <option value="Left">Left</option>
                 <option value="Center">Center</option> 
...
<div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body" style="display:-webkit-box;padding-bottom:0px;">
          <div class="form-body"> 
          	<div class="col-md-12" style="padding-top:4%;"> 
				  ...
				  <label for="Paragraph" id="label" class="field-title" style="width: 100% !important;">Enter Your Text:</label>
        ...
        <div class="modal-footer" style="border:0px;margin-top: 0;background-color:transparent;">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body" style="overflow-y: hidden;max-height: 100%;">
            ...
            <div class="col-md-12"> 
                ...
                <label class="col-sm-12 field-title no-padding control-label">Title of Button</label>       
                 <div class="col-sm-12 no-padding">
                  <input type="hidden" name="btn_div_id" id="btn_div_id" value="">  
                   <input type="hidden" name="courseg" id="courseg" value="<?php echo $this->uri->segment(5); ?>">        
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
		...
		<div class="panel-body" style="padding: 15px;"> 
			...
			<div> 
				<ul class="nav nav-tabs bordered blue-border" style="padding-left:0px;">
					<li class="active" id="video_file" style="border-left:none!important;margin-right:0px;"> 
						<a href="#video-upfil" data-toggle="tab"> 
						<span class="visible-xs"><i class="entypo-home"></i></span> 
						<span class="hidden-xs">Upload File</span> 
						</a> 
					</li> 
					<li id="video_library" style="margin-right:0px;"> 
						<a href="#video-medlib" data-toggle="tab"> 
						<span class="visible-xs"><i class="entypo-user"></i></span> 
						<span class="hidden-xs">Media Library</span> 
						</a> 
					</li>
					<li id="video_url" style="margin-right:0px;"> 
				...
				<div class="tab-content tab-box">
					<div class="tab-pane active" id="video-upfil" style="width:100%;border-right:none;"> 
					<form id="videoForm" action="<?php echo base_url(); ?>tasks/upload_media" method="post" enctype="multipart/form-data">
						<div class="form-group form-border"> 
							<label class="col-sm-12 field-title control-label txt_cntr_algn no-padding" style="width: 100%!important;">Upload File</label> 
							...
							<div class="col-sm-12 txt_cntr_algn no-padding"> 
								<div class="fileinput fileinput-new" data-provides="fileinput" style="width:100%;margin-bottom:0px;">
									...
									<span class="btn btn-info btn-file btn-border-blue"> 
										...
										<span class="fileinput-exists">Change</span> 
										<input type="file" accept="video/*" name="file_i" id="file_i"> 
									</span>

									<div id="progress_video" class="progressBar txt_cntr_algn center_progressbar">
						...
						<label class="control-label"></label> 
							...
							<div class="col-sm-12 txt_cntr_algn no-padding"> 
								...
								<input type="submit" id="submitvideo" class="btn btn-blue" style="color:#fff;" value="Save"/>
							</div>

						</div>
					 </form>
					</div> 
					<div class="tab-pane" id="video-medlib" style="width:100%;border-right:none;"> 
					...
					<div class="tab-pane" id="videoins" style="width:100%;border-right:none;"> 

						<div class="col-sm-12 no-padding" style="display:block;">

							<div class="form-group form-border">
							<label class="col-sm-12 field-title control-label no-padding image-label-width">Insert Videos URL</label> 
								<div class="col-sm-12 no-padding"> 
							...
							<div class="form-group form-border">
								...
								<div class="col-sm-12 no-padding"> 
									<input type="button" id="videourl" class="btn btn-blue" style="color:#fff;" value="Save" onclick="addVideoUrlNEmbed(this.id)"/>
								</div>
					...
					<div class="tab-pane" id="videoiframe" style="width:100%;border-right:none;"> 
						...
						<div class="col-sm-12 no-padding" style="display:block;">
							...
							<div class="form-group form-border">
								...
								<div class="col-sm-12 no-padding"> 
									<input type="button" id="videoembed" class="btn btn-blue" style="color:#fff;" value="Save" onclick="addVideoUrlNEmbed(this.id)"/>
								</div>
		...
		<div class="panel-body" style="padding: 15px;"> 
			...
			<div> 
				<ul class="nav nav-tabs bordered blue-border" style="padding-left:0px;">
					...
					<li> 
						<a href="#pdfins" data-toggle="tab" style="margin-right:0px;"> 
						<span class="visible-xs"><i class="entypo-user"></i></span> 
				...
				<div class="tab-content tab-box">
					...
					<form id="pdfForm" action="<?php echo base_url(); ?>tasks/upload_media" method="post" enctype="multipart/form-data">
						<div class="form-group form-border"> 
							<label class="col-sm-12 field-title txt_cntr_algn no-padding control-label" style="width:100%!important;">Upload File</label> 
							...
							<div class="col-sm-12 txt_cntr_algn no-padding"> 
								<div class="fileinput fileinput-new" data-provides="fileinput">
									...
									<span class="btn btn-info btn-file btn-border-blue"> 
										<span class="fileinput-new">Select file</span> 
										<span class="fileinput-exists">Change</span> 
										<input type="file" accept="Documents/*" name="file_i" id="file_i"> 
									</span> 

									<div id="progress_pdf" class="progressBar txt_cntr_algn center_progressbar">
					...
					<div class="tab-pane" id="pdfins" style="width:100%;border-right:none;"> 
						...
						<div class="col-sm-12 no-padding" style="display:block;">
							...
							<div class="form-group form-border">
							<label class="col-sm-12 field-title no-padding control-label">Insert Image URL</label> 
								<div class="col-sm-12 no-padding"> 
...
<div class="modal fade" id="loadtemplate" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header renew-top-head">
          <button type="button" class="close renew-top-close-btn" data-dismiss="modal">&times;</button>
          <h4 class="modal-title renew-head" style="margin-top:0px!important;">Load Template</h4>
        </div>
        <div class="modal-body">
          <div class="form-body" style="display: -webkit-box;padding-top:4%;"> 
          	<div class="col-md-12"> 
              ...
              <span class="layout_buttons">
                  <a href="javascript:void(0)" class="btn btn-green" style="color:#fff!important;margin-bottom:2%;" onclick="loadTemplates(<?php echo $templatedetails->id; ?>);">Load</a>
                  <a href="javascript:void(0)" class="btn btn-blue" style="color:#fff!important;margin-bottom:2%;" onclick="deleteTemplates(<?php echo $templatedetails->id; ?>);">Delete</a>
                </span>
							...
							<div class="col-sm-12 txt_cntr_algn no-padding"> 
								<div class="fileinput fileinput-new" data-provides="fileinput" style="width:100%;margin-bottom:0px;">
									...
									<span class="btn btn-info btn-file btn-border-blue"> 
										<span class="fileinput-new">Select file</span> 
										<span class="fileinput-exists">Change</span> 
										<input type="file" accept="audio/*" name="file_i" id="file_i"> 
									</span>

									<div id="progress_audio" class="progressBar txt_cntr_algn center_progressbar">
                        ...
                        <div class="form-group form-border"> 
                            ...
                            <div class="col-sm-12 txt_cntr_algn no-padding"> 
                                <div class="fileinput fileinput-new" data-provides="fileinput" style="width:100%;margin-bottom:0px;">
                                    ...
                                    <div id="progress_flash" class="progressBar txt_cntr_algn center_progressbar">
                ...
                <div class="tab-content">
                            ...
                            <div class="col-sm-5"> 
                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                    ...
                                    <span class="btn btn-info btn-file"> 
                                        <span class="fileinput-new">Select file</span> 
                                        <span class="fileinput-exists">Change</span> 
                                        <input type="file" accept="images/*" name="file_i[]" id="file_i" multiple=""> 
                                    </span>

                                    <div id="progress_gallery" class="progressBar txt_cntr_algn center_progressbar">
                    ...
                    <div class="tab-pane" id="gallery-medlib"> 
                        ...
                        <form id="save_gallery_data" name="save_gallery_data" action="<?php echo base_url(); ?>tasks/update_gallery_data" method="post" enctype="multipart/form-data">
                           ...
                           <!--  <div class="form-group">
                                <label class="col-sm-1 control-label"><input type="checkbox" value="1" id="gridchk" onclick="this.checked=true;" name="gallerychk[]" checked></label> 
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5"> 
                                    <input type="button" onclick="updateGallery();" class="btn btn-success" value="Add Gallery" />
                                </div>
          ...
          stop: function( event, ui )
         {
              ...
              if( typeof(elementId) == "undefined")
            {
              elementId = $(ui.item[0].children[5]).attr('id');
                ...
                //parentelemrnt.find(".view").find('image').css('width','100%');
...
{
  var cname ="<?php echo $this->uri->segment(1) ?>";
  ...
  $("#content_lecture").val(contenthtml);
    var body = $(".mailbox").find(".redactor-editor").text();
    // alert(body);
     var nm = $("#name").val();           
    ...
    jQuery.ajax({
       ...
       console.log(msg);   
            ...
            {
              $j.alert({
             title: 'Lecture Successfully Edited',
               content: '  ',
                confirm: function()
                          {
                            console.log(msg);
                            // $("#inform_msg").val('');
                            // $('.error').remove();
                            // window.location ="<?php echo base_url();?>sections-manage/"+seg5+"/"+seg5;
                           }
                       });
            } 
...
jQuery("#myModalLectpreview1 .close").click(function(){
  
  jQuery("#sticky").css("display","block");
});
</script>
<script type="text/javascript">
function getNotify(i){
