	...
	<div class="main-content">
		...
		<div class="row">
         ...
         <div class="tab-pane active" id="lecture">
         	...
         	<div class="panel-heading">
				<div class="panel-title" style="padding-bottom: 0px;">	
					<h4 style="margin-top: 0; color: #09c; font-size: 14px;  font-weight: bold; text-transform: uppercase;">New Exam</h4>
...
<div class="panel panel-primary" data-collapsed="0"> 
	...
	<div class="panel-heading">
		<div class="panel-title" style="padding-bottom: 0px;">	
			<h4 style="color: #09c; font-size: 14px; font-weight: bold; text-transform: uppercase;">Exam Content </h4>
	...
	<!-- <div>
		...
		<div class="form-group"> 
			...
			<div class="col-sm-5"> 
				<textarea name="lec_content" class="form-control" id="lec_content"><?php  echo @$task->content; ?></textarea>
                          ...
                          <td><table align="center" style="width:200px; border:1px solid #eeeeee;">
                              <tbody>
                                <tr bgcolor="#FFFFCC">
                                    ...
                                    <a href='<?php echo base_url(); ?>quizzes/quizesaddtotask/15' class="fancybox fancybox.iframe btn btn-warning">Select Exam</a>                                     
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                   ...
                                   <?php if($updType == 'edit')
                                    ...
                                    <div id="after_menu_med_15" style="display:none">
                                      <table>
                                        <tbody>
                                          <tr>
                                            <td width="33%" style="text-align:center"><a href='<?php echo base_url(); ?>quizzes/quizesaddtotask/15' class="fancybox fancybox.iframe">Replace Exam</a></td>                                                                         
