...
function addmedia1(mediaid,medtype,medname,mediagroup){
...
<div id="toolbar-box">
	<div class="m">
		<div class="pagetitle icon-48-generic"><h2 class="list-media-style"><?php echo 'List Media';?></h2><p class="list_media">Click on the Name of the Media to select</p></div>
	</div>
</div>
<div>
  <!--  <a href='<?php echo base_url(); ?>/admin/medias/create/<?php //echo ($category_id != "")  ? $category_id : "0"?>/<?php //echo $page?>' class='bcreate'>Create Media</a> -->
    <?php if (isset($control)): ?>
    	<a href='<?php echo base_url(); ?>/mcategories/<?=$parent_category?>' class='bforward bforwardmargin'><?=lang('web_category_back')?></a>
    <?php endif ?>
</div>
<div class='clear'></div>
<?php
$attributes = array('class' => 'tform', 'name' => 'topform1');
echo form_open_multipart(base_url().'medias/ajaxaddmodulemedia/'.$medfldgroup."/".$medfldid,$attributes);
?>
<hr /> 
<div class="col-bcl-6 col-left">
<div id="table-3_length" class="dataTables_length">
				<input placeholder="Media Name" type="text" value="<?php echo set_value('name', (isset($search_string)) ? $search_string : ''); ?>" name="search_text" class="form-control" style="width:auto;">
...
<table class="table table-bordered responsive scroll" style="width: 100%;overflow-x:scroll;font-size:15px">
<thead>
	<tr>
        <!--<th width="5"><input type="checkbox" value="" name="toggle" onclick="checkAll(5)"></th>-->
		<th style="width:2%;color:#000;font-weight:bold;">ID</th>
		<th style="width:53%;color:#000;font-weight:bold;">Media Storage</th>
        <th style="width:7%;color:#000;font-weight:bold;">Type </th>
		<th style="width:10%;color:#000;font-weight:bold;">Category</th>
		<!---<th>Publish</th>-->
   </tr>
</thead>
<?php if ($medias): ?>
...
<?php foreach ($medias as $media): ?>
	<tr class="camp<?php echo $i;?>">
	    ...
	    <td style="width:68.8%">
			<a href="javascript:addmedia1('<?php echo $media->id?>','<?php echo $media->type?>','<?php echo $media->alt_title?>','<?php echo $medfldgroup?>')" class="a_lms">
