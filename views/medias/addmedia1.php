...
<thead>
	 <tr>
    	...
    	<th style="width: 6.6%;color:#000;">ID </th>
...
<tbody>
	...
	<tr class="camp<?php echo $i;?>">
		...
		<td style="width:10.8%"><a href="javascript:addmedia(<?php echo $media->id?>,'<?php echo $media->type?>','<?php echo $media->alt_title?>',<?php echo $media->publish?>,'<?php echo $medfldgroup?>')">
      <img title="Select Media" style="width: 23px!important;display: block;margin: 0px auto;" alt="Published" src="http://create-online-academy.com/public/images/admin/Vote-512.png">
    <td style="width:8.8%">
