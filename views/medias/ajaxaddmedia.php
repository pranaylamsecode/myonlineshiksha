...
//alert(mediagroup);
    ...
    var medfldid = <?php echo $medfldid;  ?>;
	...
	switch(medfldid)
	{
			...
			case 7:
					if(mediagroup == 'firstmedia')
					{	parent.jQuery('#media_7').html('<img style="width="50" height="50"" src="<?php echo base_url(); ?>public/images/loading.gif" />');	
...
echo form_open_multipart(base_url().'medias/ajaxaddmedia/'.$medfldgroup."/".$medfldid,$attributes);
?>
...
<?php foreach ($medias as $media): ?>
	<tr class="camp<?php echo $i;?>"> 	    
	    ...
	    <td>
			<a href="javascript:addmedia('<?php echo $media->id?>','<?php echo $media->type?>','<?php echo $media->name?>','<?php echo $medfldgroup?>')" class="a_lms">
