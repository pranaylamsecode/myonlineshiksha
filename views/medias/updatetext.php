...
echo ($updType == 'create') ? form_open_multipart(base_url().'medias/updatelecturetext', $attributes) : form_open_multipart(base_url().'medias/updatelecturetext/'.$id, $attributes);
...
<div class="main-content" style="min-height: 820px;">
  ...
  padding-top: 20px;">
                ...
                <div class="tab-pane active" id="textcode"> 
                  ...
                  <?php echo ($this->input->post('description')) ? $this->input->post('description') : ((isset($media->code)) ? $media->code : ''); ?>
                  </textarea>
                            </div>
                          </div>
            ...
            <a style="display:none" href="#" id="disOpt" >Advanced Options </a> 
              <br/>
