...
echo ($updType == 'create') ? form_open_multipart(base_url().'medias/createlecturetext', $attributes) : form_open_multipart(base_url().'medias/createlecturetext/'.$id, $attributes);
...
<div class="main-content" style="min-height: 820px;">
    ...
    <?php
     ...
     ?>    
    <div>
      <legend>Add New Lecture Document</legend>
    </div>
    ...
    ?>
     <div>
      <legend>Add New Lecture Text</legend>
    </div>
    <?php
      }   
          ...
          <div class="panel-body">
            <form role="form">
              ...
              <ul class="nav nav-tabs bordered">
                ...
                <li class="active"> 
                  <a href="#doc_url" data-toggle="tab"> 
                    <span class="visible-xs"><i class="entypo-user"></i></span> 
                    <span class="hidden-xs">Document URL</span> 
                  </a> 

                </li> 

                <li> 
                  <a href="#doc_upload" data-toggle="tab"> 
                    <span class="visible-xs"><i class="entypo-mail"></i></span> 
                    <span class="hidden-xs">Upload Document</span> 
                  </a> 
                </li> 
  ...
  padding-top: 20px;">
                <label class='col-sm-3 control-label' style="margin-bottom:0; padding:0;" for="name"><?php echo lang('web_name')?></label>
                <div class="col-sm-5">
                ...
                <div class="tab-pane active" id="doc_url"> 
                  <div id="url_v" >
                            <div >
                              <input type="text" onchange="javascript:changeSource('url_d');" name="url_d" value="<?php echo ($this->input->post('url_v')) ? $this->input->post('url_v') : ((isset($media->url)) ? $media->url : ''); ?>" size="40" onpaste="javascript:changeSource('url_d')" onkeypress="javascript:changeSource('url_d')" id='url_d'>
                ...
                <div class="tab-pane" id="doc_upload"> 
                  <div id="audioUploader">
                                              <div class="qq-uploader">
                                                ...
                                                <div class="qq-upload-button" style="position: relative; overflow: hidden; direction: ltr;">Choose file
                                                  <input type="file" onclick="changeSource('file_d')" name="file_d" id="file_d" class="upload_btn">
                                                </div>
              ...
              <input type="hidden"  name="source_d"  value=""  id="source_d">
          ...
          ?>
            <ul class="nav nav-tabs bordered">
                <!-- available classes "bordered", "right-aligned" --> 
                <li class="active"> 
                  <a href="#text_code" data-toggle="tab"> 
                    <span class="visible-xs"><i class="entypo-home"></i>
                    </span> <span class="hidden-xs">Text</span> </a> 
                </li> 
  ...
  padding-top: 20px;">
                ...
                <div class="tab-pane active" id="textcode"> 
          ...
          ?>
                ...
                <div class="col-sm-5">
                  <select onchange="changeType(this.value)" size="1" name="type" id="type">
                    ...
                    <?php foreach($mediatype as $type){?>
			              <?php if($type->name == 'file' || $type->name == 'docs' || $type->name == 'text') { ?> 
                    <option value="<?php echo $type->name;?>" <?php echo  preset_select('type', $type->name, (isset($media->type)) ? $media->type : ''  ) ?>  <?php if($t_type == $type->name) { echo 'selected="selected"'; } ?>> <?php echo $type->title;?> </option>
                    <?php } } ?>
                  </select>
            ...
            <a href="#" id="disOpt" >Advanced Options </a> 
             ...
             <div id="advancedOptions" style="display:none"> 
              ...
              <div class="form-group">
                <label class='col-sm-3 control-label' style="margin-bottom:0; padding:0;" for="instructions">Sub Title / Instruction:
                ...
                <div class="col-sm-5"> 
                  ...
                  <textarea id="instructions" placeholder="TextSub Title / Instructionarea" name="instructions"  >
                                      ...
                                      <tr>
                                        <td><div>
                                            <div style="display: inline;"> 
                                              ...
                                              <!--<input type="radio" checked="checked" value="0" name="option_video_size">-->
                                              
                                              <input type="radio" value="0" <?php echo ($this->input->post('option_video_size') == '0') ? "checked" : (isset($media->option_video_size) && $media->option_video_size == 0) ? "checked" : '' ?> name="option_video_size">
                                            </div>
                                            <div style="display: inline;"> Use Global (720 px x 405 px) </div>
                                          </div></td>
                                      </tr>
                                      <tr>
                                        <td><div>
                                            <div style="display: inline;">
                                              <input type="radio" value="1" <?php echo ($this->input->post('option_video_size') == '1') ? "checked" : (isset($media->option_video_size) && $media->option_video_size == 1) ? "checked" : '' ?> name="option_video_size">
                                            </div>
                                            <div style="display: inline;">
                                              <input type="text" name="width_v" value="<?php echo ($this->input->post('width_v')) ? $this->input->post('width_v') : ((isset($media->width)) ? $media->width : ''); ?>" size="5" id="width_v">
                                              px &nbsp; <span class="error" id="error_56"><?php echo form_error('width_v'); ?></span> 
                                              
                                              <!--<input type="text" name="width_v" value="    -->
                                              
                                              <?php //echo set_value('width_v', (isset($media->width)) ? $media->width : ''); ?>
                                              
                                              <!--" size="5" id="width_v">    --> 
                                              
                                            </div>
                                            <div style="display: inline;">
                                              <input type="text" name="height_v" value="<?php echo ($this->input->post('height_v')) ? $this->input->post('height_v') :  ((isset($media->height)) ? $media->height : ''); ?>" size="5" id="height_v">
                                              px &nbsp; <span class="error" id="error_56"><?php echo form_error('height_v'); ?></span> </div>
                                            <div style="display: inline;"> (Width x Height)
                                              <input type="hidden" value="" name="video_size" id="video_size">
                                            </div>
                                          </div></td>
                                      </tr>
                                    </tbody>
      ...
      <div id="fileblock" style="display:<?php echo ($this->input->post('type')== 'file') ? 'block' : $filemedia ?>">
        <fieldset class="adminform">
          ...
          <div "zone_description">only .zip files are accepted</div>
          <table class="adminform">
            <tbody>
              <tr>
                <td><table width="100%" cellspacing="0" cellpadding="0" border="0">
                    <tbody>
                      <tr>
                        ...
                        <td> Select file source, only .zip files are accepted<br>
                          <table width="100%" cellspacing="0" cellpadding="5" border="0">
                            <tbody>
                              <tr>
              ...
              <div>
                <div class="col-sm-offset-3 col-sm-5" style="margin-left:25%; margin-top:20px;"> 
                ...
                <a onclick="javascript:  parent.jQuery.fancybox.close();  " class='btn btn-danger'>Cancel</a> 
                </div>
              </div>
            </form>
          </div>
...
var type  = '<?php echo lcfirst($t_type); ?>';
 ...
 function changeSource(id)
{
  ...
  if(id == 'file_d')
  {
    document.getElementById('source_d').value = 'local';
  }
