...
function addcrop(img)//for add to favorites
    {
    	...
    	var croptype ="<?php echo $this->uri->segment(2);?>";
    	
    $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>medias/uploadmadiaimg/<?php echo $this->uri->segment(3);?>/<?php echo $this->uri->segment(4);?>",
            data: {img:img}, 
            ...
            success: function(data)
            {
              ...
              window.location ="<?php echo base_url();?>medias/createlecturemedia/firstmedia/7";
