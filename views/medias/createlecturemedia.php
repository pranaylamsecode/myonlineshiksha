...
echo ($updType == 'create') ? form_open_multipart(base_url().'medias/createlecturemedia', $attributes) : form_open_multipart(base_url().'medias/createlecturemedia/'.$id, $attributes);
...
<div class="main-content" style="min-height: 820px;">
  ...
  padding-top: 20px;">
                <label class='col-sm-3 control-label' style="margin-bottom:0; padding:0;" for="name">Name*</label>
                <div class="col-sm-5">
                ...
                <div class="tab-pane" id="v_upload"> 
                  <div id="videoUploader">
                                      ...
                                      <div>
                               <font color="#FF0000"><?php if(@$upload_error) { echo @$upload_error; } ?></font>
                                </div>
                </div> 
  ...
  padding-top: 20px;">
                <label class='col-sm-3 control-label' style="margin-bottom:0; padding:0;" for="name">Name*</label>
                <div class="col-sm-5">
                  <input id="name" type="text" required placeholder="Name" required name="name" maxlength="256" value="<?php echo set_value('name', (isset($media->name)) ? $media->name : ''); ?>"  />
          ...
          ?>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5"> 
                  ...
                  <textarea id="instructions" placeholder="Sub Heading" name="instructions"  ><?php echo ($this->input->post('instructions')) ? $this->input->post('instructions') : ((isset($media->instructions)) ? $media->instructions : ''); ?></textarea>
