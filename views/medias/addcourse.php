...
<table class="table table-bordered responsive scroll" style="font-size:15px">
...
<thead>
	...
	<tr>
	   ...
	   <th style="width:7.5%;color:#000;">ID</th>

	   <th style="width:50%;color:#000;">Course Tree (#modules)</th>

       <th style="width:5%;color:#000;">Published</th>
