...
function addmedia(mediaid,medtype,medname,mediagroup){
	...
	parent.jQuery('#text_11').html('<img src="<?php echo base_url(); ?>public/images/loading.gif" />');	
...
<div id="toolbar-box">
	<div class="m">
		<div class="pagetitle icon-48-generic"><h2><?php echo 'List Media';?></h2></div>
	</div>
</div>
<div class='clear'></div>
<?php
$attributes = array('class' => 'tform', 'name' => 'topform1');
echo form_open_multipart(base_url().'medias/ajaxaddmodulemediatext/'.$medfldgroup."/".$medfldid,$attributes);
?>
<hr /> 
