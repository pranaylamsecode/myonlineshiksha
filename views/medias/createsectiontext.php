...
echo ($updType == 'create') ? form_open_multipart(base_url().'medias/createsectiontext', $attributes) : form_open_multipart(base_url().'medias/createsectiontext/'.$id, $attributes);
            ...
            <form role="form">
              <div>
                ...
                <div class="col-sm-5">
                  ...
                  <span class="error"><?php echo form_error('type'); ?></span> </div>
              </div>
              <br />
              <br />
              <br />
              ...
              <div>
                ...
                <div class="col-sm-5">
                  ...
                  <span class="error"><?php echo form_error('name'); ?></span> </div>
              </div>
              <br />
              <br />
              <br />
          ...
          <table class="adminform">
            <tbody>
              ...
              <div>
                ...
                <a href='<?php echo base_url(); ?>medias<?php //echo $parent_id?>/<?php //echo $page?>' class='btn btn-danger'>Cancel</a> 
                </div>
              </div>
            </form>
          </div>
