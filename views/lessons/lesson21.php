...
<script>
  var video;
  var sptime = '0';
  function play_video(place,vid = null)
  {   
    ...
    // else{
      ...
      sptime = '0';
    if(place == 1) video = "<?php echo $lecture_video; ?>";
    else video = vid;
    var options = {
            ...
            <?php } ?>
              ...
              <div class="panel-footer">
                ...
                if($remainAttempts > 0)
                {
                  ...
                  <div class="btn btn-sm btn-success btn-update" id="buy_loader" style="display: none;">
                      <img src="https://myonlineshiksha.com/public/images/loader_white.gif" width="28px" height="28px"> Wait
                    </div>
                  <button type='button' class="btn btn-sm btn-success btn-update" onClick="start_exam('<?php echo $att ?>','<?php echo $quizz->exam_title;?>',<?php echo $lesson->is_exam;//$db_media[14]->media_id;?>,<?php echo $pro_id;?>,'<?php echo $layoutid;?>','1','0');" value='Start Quiz' name='btnStartexam' id='btnStartexam' disabled="disabled">Start Quiz</button>
                        <?php
                      }
