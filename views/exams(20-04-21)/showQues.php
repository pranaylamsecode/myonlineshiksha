...
<link rel="stylesheet" href="<?php echo base_url() ?>public/css/courses_css/lecture_preview.css">
<!-- <style>
...
<input type='text' name='given_ans' value=""  id='given_ans' style="display: none;">
<?php
// print_r(@$submitedQue);
...
$arr2 = $arr2 + $a;
	...
	// var_export($new_a);
			...
			{ 
				...
				<input type="<?php echo ($Ques->que_type == 'mcq' ? 'checkbox' : 'radio'); ?>" name="opt" class="chkOpt" id='<?php echo $Ques->que_type; ?>_<?php echo $key; ?>' value="<?php echo $key; ?>" ><?php echo htmlentities($value); ?><hr>
	<?php		} 
			}
			else {
	foreach ($new_a as $key => $value) {
...
{	?>
	<div class="col-sm-12 no-padding">							
  		...
  		<textarea id="subtxt" class="form-control" rows="8" name="subans" >
  			<?php //echo @$submitedQue->stud_given_ans ? @$submitedQue->stud_given_ans : '' ?></textarea>
	</div>
<?php
}
