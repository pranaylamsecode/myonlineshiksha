						...
						else if($('#exam_category').val() == '1')
						{
							...
							$.ajax({
								 type: 'POST',
							        ...
							        url: base_url+'/exams/getfilterQues/'+j+'/'+seclen+'/'+newfnm,
							        async: false,
							        beforeSend : function(data){ jQuery("#exam_info").html('<img style="position: absolute;top: 39%;left: 42%;" src="http://www.create-online-academy.com/public/images/loading.gif" />'); }, 
