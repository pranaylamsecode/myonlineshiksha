...
<?php
$attributes = array('class' => 'tform', 'id' => 'testimonials', 'name' => 'testimonials','onclick' => 'return validateForm()');
echo form_open_multipart(base_url().'testimonials/create', $attributes);/*echo '<pre>';print_r($user);echo '</pre>';*/
?>
<div class="content">
...
<div class="table-scroll-resp">
	<fieldset class="adminform form-horizontal form-groups-bordered">
		<div class="admintable">
            <div width="350"> <h3>Create Testimonial</h3></div>
            <hr />
			<div>
				<label>Title<span style="color:#FF0000">*</span></label>
					<input type="text" name="name" id="name" size="30" value="<?php echo set_value('name'); ?>">
			...
			<div>
				...
				<textarea  name="prof_detail" id='prof_detail' rows="6"  ></textarea>
			</div>
