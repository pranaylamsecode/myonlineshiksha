			...
			<div class="row">
				<div class="col-sm-8">
					<div class="courseDetails">
						<h2>Industry Readiness Program: Intermediate <span>with TCS iON Remote Internship</span></h2>
						...
						<div class="overview">
							...
							<p>Self-paced courses on Interview Techniques & Public Speaking + Industry Readiness Program with TCS iON RIO-125 Internship, having an Industry mentor for the project work of 125 hours with supportive elements self-learning content, webinars, daily activity reports, knowledge sharing, tests and viva online to help the students complete the projects successfully leading to certification by TCS iON.</p>
    ...
    <div class="curriculumRow">
      ...
      <div class="row">
        <div class="col-sm-8 curriculumRowText">
          <ul>
            <li><i class="fa fa-sort-up"></i> <span class="txtcnt">No. of Days : </span> 30<p></p>
            </li>
            <li><i class="fa fa-sort-up"></i> <span class="txtcnt">No. of Hours : </span> 125<p></p>
            </li>
            <li><i class="fa fa-sort-up"></i> <span class="txtcnt">Credits Earned : </span> 3<p></p>
            </li>
            <li><i class="fa fa-sort-up"></i> <span class="txtcnt">Learning References : </span> Yes<p></p>
            </li>
            <li><i class="fa fa-sort-up"></i> <span class="txtcnt">No. of Hours in Industry Projects : </span> 15 (<a href="<?php echo base_url();?>public/uploads/IRP-Intermediate-Projects.xls" target="_blank" download="" style="color: #14b04d;text-decoration: underline;">Check the List of the Projects</a>)<p></p>
            </li>
...
<?php $this->load->view('new_template_design/footer');
	...
	$currency_code      = "INR";            
	$total              = intval(3500) * 100; // 100 = 1 indian rupees
	$amount             = 3500;
    ...
    $this->session->set_userdata('page','intermediate');
?>
...
$(document).on('click', '#payRazor', function (e) {
    ...
    var course_name = 'TCSiON Industry Readiness Program Intermediate'; 
