			...
			<div class="row">
				<div class="col-sm-8">
					<div class="courseDetails">
						<h2>Industry Readiness Program: Beginner <span>with TCS iON Remote Internship</span></h2>
						...
						<div class="overview">
							...
							<h3><span>Program </span>Overview</h3>
							<p>Self-paced course on Interview Techniques + Industry Readiness Program with TCS iON RIO-45 Internship, having an Industry mentor for the project work of 45 hours with supportive elements self-learning content, webinars, daily activity reports, knowledge sharing, tests and viva online to help the students complete the projects successfully leading to certification by TCS iON.</p>
            ...
            <div class="duration">
                ...
                <div class="value">
                    <p>45 Hours</p>
						...
						<div class="form-div">
							<input type="text" id="contact_no" class="form-inputs" placeholder="Contact No*" onkeypress="return only_number(event)" maxlength="10" class="contact_no">
      ...
      <!-- <div class="row">
          <div class="col-sm-8">
              <div class="overview">
                  ...
                  <ul>
                      <li>Offering you a globally respected Internship from the comforts of your home.</li>
                      <li>To provide end-to-end solution to help you prepare for a career.</li>
                      <li>To test your knowledge and kickstart a Career.</li>
                  </ul>
              </div>
          </div>
          <div class="col-sm-4">
...
<section class="benefitSection">
	<div class="container">
		<div class="benefitRow">
			...
			<ul>
				<li>
					<img src="<?php echo base_url();?>public/uploads/1_2.png">
				...
				<li>
					<img src="<?php echo base_url();?>public/uploads/1_1.png">
    ...
    <div class="curriculumRow">
      ...
      <div class="row">
        <div class="col-sm-8 curriculumRowText">
          <ul>
            <li><i class="fa fa-sort-up"></i> <span class="txtcnt">No. of Days : </span> 10<p></p>
            </li>
            <li><i class="fa fa-sort-up"></i> <span class="txtcnt">No. of Hours : </span> 45<p></p>
            </li>
            ...
            <li><i class="fa fa-sort-up"></i> <span class="txtcnt">No. of Hours in Industry Projects : </span> 15 (<a href="<?php echo base_url();?>public/uploads/IRP-Beginner-Projects.xls" target="_blank" download="" style="color: #14b04d;text-decoration: underline;">Check the List of the Projects</a>)<p></p>
            </li>
...
<?php $this->load->view('new_template_design/footer');
	...
	$currency_code      = "INR";            
	$total              = intval(2000) * 100; // 100 = 1 indian rupees
	$amount             = 2000;
	...
	$this->session->set_userdata('page','beginner');
?>
...
$(document).on('click', '#payRazor', function (e) {
    ...
    var course_name = 'TCSiON Industry Readiness Program Beginner';
