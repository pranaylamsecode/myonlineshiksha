...
<p><?php //highlight_file($_SERVER['DOCUMENT_ROOT'].'/views/paypal/get_balance.php'); ?></p>
...
<p><a href="<?php echo base_url();?>payments_pro/do_direct_payment_demo" target="_blank">Run the code above and see the output.</a></p>
</body>
</html>