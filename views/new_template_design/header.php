...
<?php 
  $getconf = $this->Crud_model->get_single('mlms_config',"","favicon");
      $data = array(
      ...
      <link rel="icon" href="<?php echo base_url().'public/uploads/settings/img/logo/'.$getconf->favicon;?>" type="image/gif">
...
<script>
gtag('event', 'conversion', {'send_to': 'AW-688914569/5f2FCOrlzu4BEImBwMgC'});
</script>
<? } ?>
...
s.parentNode.insertBefore(t,s)}(window, document,'script',
'https://connect.facebook.net/en_US/fbevents.js');
fbq('init', '243112974036297');
fbq('track', 'PageView');
</script>
<noscript><img height="1" width="1" style="display:none"
src="https://www.facebook.com/tr?id=243112974036297&ev=PageView&noscript=1"
/></noscript>
<?php } 
if(!empty($this->session->userdata('page'))){ ?>
<!-- Event snippet for TCS Success conversion page -->
<script>
  gtag('event', 'conversion', {'send_to': 'AW-688914569/1ZZLCJmX-PoCEImBwMgC'});
</script>
<?php } ?>
<!-- End Facebook Pixel Code -->
...
<!-- End Google Tag Manager (noscript) -->
    ...
    <div class="discount_bar highlight_discount" >
      <div class="container">
        <a class="dicount_text" href="<?php echo base_url(); ?>category/courses">Crack JEE/NEET 2021 with Online Course - 50% Discount </a>
      ...
      <div class="container-fluid first_nav">
        ...
        <div class=" text-right">
          <?php
            ...
            <?php
            if(@$userDetail[0]['is_instructor'] == '1' || @$userDetail[0]['group_id'] == '2' || @$userDetail[0]['group_id'] == 5 || @$userDetail[0]['group_id'] == 4 || @$userDetail[0]['group_id'] == 3 || @$userDetail[0]['group_id'] == 6)
            {
            ...
            ?>
            <li class="dropdown your_teaching_zone"><a href="#" title='Your Selling Zone'><i class="entypo-sound ent-vc" ></i><span class="ent-vc1">Manage</span><i class="entypo-down-open-mini" style="position: relative; top: 3px;"></i></a>
              <ul style="<?php if(@$userDetail[0]['group_id'] == 6){echo "width:210px;left:-100px;";}else{echo "width:196px";}?>">
            ...
            ?>
              <li class="dropdown menu_hover"><a href="#" title='Your Learning Zone'><i class="entypo-brush ent-vc"></i><span class="ent-vc1" >Learn</span><i class="entypo-down-open-mini"  style="position: relative;top: 2px;left: -2px;"></i></a>
                  <ul>
                  	<li><a href="<?php echo base_url(); ?>upcoming-lectures"><span>Upcoming Lectures</span></a></li>
                      ...
                      <li><a href="<?php echo base_url(); ?>tcs-ion-internship/"><span>TCS iON Internship</span></a></li>
                  </ul>
              </li>
              <?php        
                }
        ...
        <div id="mySidenav" class="sidenav">
          ...
          <li class="your_teaching_zone"><a href="#" onclick="openNav4()" title='Your Teaching Zone'>Manage<span style="float: right;margin-right: 0px;margin-top: -5px;width: 5px;"><i class="fa fa-angle-right"></i></span></a>
                <ul style="display: none;">
                    ...
                    <li><a href="<?php echo base_url();?>upcoming-events/"><span>Upcoming Events</span></a></li>
                    <li><a href="<?php echo base_url();?>partner/your-sales"><span>Sales</span></a></li>
                    <li><a href="<?php echo base_url();?>partner/settlements"><span>Your Settlements</span></a></li>
                    <li><a href="<?php echo base_url();?>partner/coupons"><span>Coupons</span></a></li>
                    <li><a href="<?php echo base_url();?>partner/settings"><span>Settings</span></a></li>
        ...
        <div id="signup-ct">
          ...
          <div class="main_panel_log_popup">
            ...
            <div class="form_app">
             ...
             <p class="agree_text"><input type="checkbox" name="iagreee" checked='checked'> By signing up, you agree to our <a href="<?php echo base_url(); ?>terms-of-use">Terms of Use</a> and <a href="<?php echo base_url(); ?>privacy-policy">Privacy Policy</a>.</p>
          </div>
