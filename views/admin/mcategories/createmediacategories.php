...
echo form_open_multipart(base_url().'admin/mcategories/savecategory', $attributes);
...
<!-- tooltip area finish -->
                    ...
                    <div class="form-group">
						...
						<div class="col-sm-5">
							<?php 
							$CI = & get_instance();
							$CI->load->model('admin/mcategories_model');
							$categories1 = $this->mcategories_model->get_formatted_combo();
							// echo"<pre>";
							// print_r($categories1);							
							// echo"</pre>";
							 ?>
...
<!-- tooltip area finish -->
    <span class="error"><?php echo form_error('category_id'); ?></span>
					...
					<div class="form-group">
                        	...
                        	<label class="labelforminline col-sm-3 control-label" for='active'> <?=lang('web_is_active')?> </label>
...
<!-- tooltip area finish -->
	<?php //echo form_error('published'); ?>
					...
					<div class="form-group">
						<div class="col-sm-5" style="width:100%;text-align:center;display:block;padding:0px;padding-top:8%;">
							
                            <a>
			<?php //echo form_submit( 'submit', 'Save',  "id='submit' class='btn btn-default'"); ?>
         					</a>
                          <input class="btn btn-success" type="button" name="save" id="save" value="Save" onclick="create_category();">  
...
{	
    ...
    jQuery.ajax({
        type: "POST",
        url: "<?php echo base_url('admin/mcategories/savecategory'); ?>",
