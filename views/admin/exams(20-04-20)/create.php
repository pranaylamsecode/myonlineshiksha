...
<div id="sticky-anchor"><div class='totshow'><h2><b>Total Marks : <span id="mkspan"> 0 </span></b>
						...
						<label>Quiz Type</label>
							...
							<div class="radio-set radioGraySet">
                                ...
                                <span class="radio radio-inline">
                                    <input type="radio" class="extype" id="term" name="exam_type" value="2">Regular Quiz</span>
                                    <br>
...
<!-- tooltip area finish -->
                  ...
                  <div class="form-group" style="margin: 0px -30px">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div>
                        <input required="" class="" name="pass_score" id="pass_score" type="number" min="0" max="100"  style="width: 100px;background-image: url('<?php echo base_url(); ?>public/images/images/percent3.jpg')!important;background-repeat: no-repeat!important;background-position: center right 55%!important"><br><span>(Give the passing score for your quiz.The passing score must be a positive number and cannot be greater than 100.)</span>
...
<!-- class for sidebar inputopenNav -->
	...
	<div class="page_block section sortable1" id="section_1" >		
		...
		<span id="section_1" class="openNav " ><img src="/public/images/section.9d6b855f.png" role="presentation" data-radium="true" style="display: block;"></span>
