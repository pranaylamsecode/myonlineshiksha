...
<thead>
  <tr role="row">
      ...
      <th class="sorting col-sm-2" role="columnheader" tabindex="0" aria-controls="table-2" rowspan="1" colspan="1" aria-label="Average Grade: activate to sort column ascending" style="text-align: center;"><div class="col-sm-12 no-padding table-title">Total Marks</div></th>
...
foreach ($quizzes as $quiz): ?>
      ...
      <!--<td class=" "></td>-->
     <td><?php echo ($quiz->exam_type == 1) ? 'Try and Learn' : 'Regular Quiz';?></td>
          ...
          <td class="field-title" style="text-transform: capitalize;color: #949494;text-align:center!important;"><a>Page : </a><?php  echo (!empty($quiz_pagearr)) ? $quiz_pagearr : '0' ?><br>
          ...
          <td class="field-title" style="text-transform: capitalize;color: #949494;text-align:center!important;"><a href="<?php echo base_url(); ?>admin/exams/student/<?php echo $quiz->exam_id;?>/"><?php echo $this->quizzes_model->get_count_students2($quiz->exam_id)?></a>
          </td>
