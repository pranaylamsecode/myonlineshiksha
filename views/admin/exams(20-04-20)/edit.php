...
<script src="<?php echo base_url(); ?>public/js/exam/exam.js?ver=0.0.1"></script>
<style type="text/css">
...
<div id="btn-sticky" style="float: right">
	<button class='deletebtn' type='button' id="" ><img src='/public/images/delete.3f3ed9f0.png' border='0' alt='Delete' title='Delete'></button>
	<button class='btn' id="Qupdate" type='button' >update</button>
	<button type='button' class="closebtn" title="Cancel">&times;</button>
...
<div id="sticky-anchor"><div class='totshow'><h2><b>Total Marks : <span id="mkspan"> <?php echo $quiz->total_marks ? $quiz->total_marks : '0'; ?> </span></b>
	<input value=" <?php echo $quiz->total_marks ? $quiz->total_marks : '0'; ?>" name="total_marks" class='totmk' type="hidden"> 
	<input value="<?php echo (isset($quiz->exam_id) ? $quiz->exam_id : '0'); ?>" id="exam_id" name="exam_id" type="hidden"> 
</div>
</div>
<div id="sticky" class="">
...
<!-- tooltip area finish -->
                    ...
                    <div class="form-group">
	                        ...
	                        <span class="note">(Give clear instructions for your quiz)</span>
	                        <div class="col-sm-9"> 
                  ...
                  <div class="form-group" style="margin: 0px -30px">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div>
                        <input required="" class="" name="pass_score" id="pass_score" type="number" min="0" max="100" value="<?php echo $quiz->passing_score ? $quiz->passing_score : ''; ?>" style="width: 100px;background-image: url('/public/images/images/percent3.jpg')!important;background-repeat: no-repeat!important;background-position: center right 55%!important"><br><span class="note">(Give the passing score for your quiz.The passing score must be a positive number and cannot be greater than 100.)</span>
...
<!-- class for sidebar inputopenNav -->
 ...
 <?php
  		...
  		<div class="page_block section sortable1" id="section_<?php echo $j; ?>" >
			...
			<span id="section_<?php echo $j; ?>" class="openNav " ><img src="/public/images/section.9d6b855f.png" role="presentation" data-radium="true" style="display: block;"></span>
...
<?php
			...
			<i class='select_icon handle unmoved Queset Qele' id='icon_<?php echo $k; ?>'></i>
				...
				<input type="hidden" class="Queset" id='qid_<?php echo $k; ?>' name="queid_<?php echo $k; ?>[]" value="<?php echo (isset($Qdata) ? $Qdata->que_id : ''); ?>" >
...
// [que_description] => [instruction] => [que_type] => mcq [options] => [{"1":"jnijmik"},{"2":"77897"},{"3":"959595"},{"4":"errrrrrr"},{"5":"98989"}] [que_option] => [correct_ans] => 2_3_5_ [que_attachment] => [que_level] => 0 [que_marks] => 0 [page_id] => 1 [section_id] => 1 [page_title] => [section_title] => [page_description] => [section_description] => [published] => 1 [created_by] => 1 [created_date] => 2018-05-02 [modified_date] => 2018-05-02 ) )
				...
				{	$array = json_decode($Qdata->options);
									// print_r($array); 
					$chkans = explode('_', rtrim($Qdata->correct_ans,'_'));
