...
<div class="pagetitle"><h2><?php echo ($updType == 'create') ? "Select Quiz" : "Edit Quiz";//echo lang(($updType == 'create') ? "web_add_category" : "web_edit_category")?></h2></div>
</div>
<div id="inform_txt">
...
<div class="col-md-6 col-sm-6 col-xs-6 field_content" style="width: 100%;">
  <ul class="nav nav-tabs bordered grey-border blue-border">
    ...
    <span class="hidden-xs">Quiz Detail</span> 
    </a> 
    </li>
    <li> 
      ...
      <dd class="" sno="1">
        <div class="tab-content">
          <fieldset class="adminform form-horizontal form-groups-bordered">
                        <legend  style="border:none;padding:0px;margin-bottom: 0px"></legend>
            
			
            <div class="form-group form-border top-padding">
              <label class='col-sm-12 control-label field-title' for="Lesson"><?php echo 'Quiz Name:'//echo lang('web_name')?> <span class="required">*</span></label>
              <div class="col-sm-12">
...
<!-- tooltip area finish -->
        ...
        <fieldset class="adminform exam_buttons" style="padding-top: 10px;">



		

	<table class="adminform hide_table" style="width:800px;">
      ...
      <tr>
									<td>
									<label style="font-size: 20px; margin-top: 0px;">Quiz Content :</label>
...
$layout_media15_flag = (isset($task->is_exam)) ? true : false;
	...
	?>
	<!--  -->
	 <a href='<?php echo base_url(); ?>admin/quizzes/quizesaddtotask/15' class="addexam btn btn-warning"><?php
	 if($sel_examid && $updType=='create'){ 
	echo "Replace Quiz"; }
	else if(@$task->is_exam && $updType=='edit'){ 
	echo "Replace Quiz"; }
	else{ echo "Select Quiz"; } ?>
	</a>

 	<a class='btn btn-danger' href="<?php echo base_url() ?>admin/exams/create/<?php echo $courseNo;?>/<?php echo $sectionNo;?>" 
   onclick="createExamToLecture(<?php echo $courseNo;?>,<?php echo $sectionNo;?>)">Add Quiz</a>
...
<?php if($updType=='create')
		...
		{	?>
			...
			<input id="db_media_15" type="hidden" value="<?php echo (isset($task->is_exam)) ? $task->is_exam : ''; ?>" name="Exid">
<?php	} ?>
					...
					<table align="center" style="width:200px; border:1px solid #eeeeee;">
						...
						<td style="text-align:center;" id="menu_med_15">
							<div id="before_menu_med_15" style="padding-bottom: 9%;">
								<a href='<?php echo base_url(); ?>admin/quizzes/quizesaddtotask/15' class="selexm_pop btn btn-primary btn-border-blue">Select Quiz</a>
								&nbsp;&nbsp;&nbsp;									
								<!-- <a href='<?php echo base_url(); ?>admin/quizzes/create/addExamToCourse/<?php echo $courseNo;?>/<?php echo $sectionNo;?>' class="btn btn-info">Add Exam</a> -->
									<?php if($updType == 'edit')
                                           ...
                                           ?>
                                     <a class='btn btn-danger btn-border-green' onclick="editExamToLecture(<?php echo $l_id;?>,<?php echo $s_id;?>,<?php echo $pro_id;?>)">Add Quiz</a> 
                                     
                                        <?php }else{?>
                                        <a class='btn btn-danger btn-border-green' onclick="addExamToLecture(<?php echo $courseNo;?>,<?php echo $sectionNo;?>)">Add Quiz</a> 
