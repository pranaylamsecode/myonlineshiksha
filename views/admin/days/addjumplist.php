...
document.getElementById(tid).style.backgroundColor = "#C8BBBE";
	...
	var url = "<?php echo base_url();?>admin/days/ajaxjumpbutton"
			...
			window.parent.document.getElementById("jump<?php echo $butsrno;?>L"+sno).style.color = "#000";
			}
			...
			?>
				...
				<tbody>
					...
					<tr>
						<td>&nbsp;</td>
						<td>
						<input name="savebutton" class="btn btn-default" id="savebutton" onclick="addJumpButton()" type="button" size="16" value="Save" >
						</td>
					</tr>
				</tbody>
			</table>
