...
<div id="toolbar-box">
<div class="m">
  <div class="pagetitle icon-48-generic"><h2><?php echo 'Quiz Manager';?></h2>
    <h6 class="pmaintitle main_subtitle">Create and manage quiz to be inserted into your course.</h6></div>
...
<div id="sticky-anchor"></div>
  <ul id="sticky" style="list-style: none; float: right;">
      <li id="toolbar-new" class="listbutton">
        <a href="<?php echo base_url(); ?>admin/exams/create" onclick="Joomla.submitbutton('edit')" class="btn">
...
<thead>
  <tr role="row">
      ...
      <th class="sorting col-sm-2" role="columnheader" tabindex="0" aria-controls="table-2" rowspan="1" colspan="1" aria-label="Student Name: activate to sort column ascending"><div class="col-sm-12 no-padding table-title">Quiz</div></th>
      ...
      <th class="sorting col-sm-2" role="columnheader" tabindex="0" aria-controls="table-2" rowspan="1" colspan="1" aria-label="Average Grade: activate to sort column ascending" ><div class="col-sm-12 no-padding table-title">Quiz Content</div></th>

      <th class="sorting col-sm-2" role="columnheader" tabindex="0" aria-controls="table-2" rowspan="1" colspan="1" aria-label="Average Grade: activate to sort column ascending" ><div class="col-sm-12 no-padding table-title">Total Marks</div></th>
      
       <th class="sorting col-sm-2" role="columnheader" tabindex="0" aria-controls="table-2" rowspan="1" colspan="1" aria-label="Average Grade: activate to sort column ascending" 
       ><div class="col-sm-12 no-padding table-title">Assigned to Course</div></th>
     ...
     <!--  <th class="sorting col-sm-1" role="columnheader" tabindex="0" aria-controls="table-2" rowspan="1" colspan="1" aria-label="Average Grade: activate to sort column ascending" style="text-align: center;"><div class="col-sm-12 no-padding table-title">Published</div></th> -->
      ...
      <th class="sorting col-sm-2" role="columnheader" tabindex="0" aria-controls="table-2" rowspan="1" colspan="1" aria-label="Actions: activate to sort column ascending" 
      ><div class="col-sm-12 no-padding table-title">Options</div></th>
...
foreach ($quizzes as $quiz){ ?>
	<tr id="tr_<?php echo $quiz->exam_id ?>" class="odd" >
     ...
     ?></td>
          ...
          <td class="field-title" ><?php  echo ($quiz->total_marks) ? $quiz->total_marks : '0' ?></td>
          <td class="field-title" >
