...
<p class=""><i>Choose the type of the Question you with to create from the below tabs</i></p>
 ...
 -->
   ...
   /></textarea>
						...
						<div class="form-group Optional_quiz">						
						...
						<div class="form-group Optional_quiz">						
							...
							<div class="col-sm-12 no-padding">		
												<!-- name="txtInstruction" -->
	                      		<textarea type='text' id="txtExplain_reg" name="txtExplain_reg"  class="form-control tempinput "></textarea>
	                      		<!-- @@@@@tooltip start@@@@@@@@ -->
					...
					<p class="pquestionsub">This would be a set of maximum five pairs of items which the examinees needs to match as per the relevance.</p>
						...
						<div class="form-group Optional_quiz">						
							...
							<div class="col-sm-12 no-padding">		
												<!-- name="txtInstruction" -->
	                      		<textarea type='text' id="txtExplain_mat" name="txtExplain_mat"  class="form-control tempinput "></textarea>
	                      		<!-- @@@@@tooltip start@@@@@@@@ -->
					...
					<div class="tab-pane" id="truefalse"> 
						...
						<div class="form-group Optional_quiz">						
							...
							<div class="col-sm-12 no-padding">		
												<!-- name="txtInstruction" -->
	                      		<textarea type='text' id="txtExplain_tf" name="txtExplain_tf"  class="form-control tempinput "></textarea>
	                      		<!-- @@@@@tooltip start@@@@@@@@ -->
					...
					<!-- 	<div class="form-group">						
						...
						<div class="form-group Optional_quiz">						
							...
							<div class="col-sm-12 no-padding">		
												<!-- name="txtInstruction" -->
	                      		<textarea type='text' id="txtExplain_sub" name="txtExplain_sub"  class="form-control tempinput "></textarea>
	                      		<!-- @@@@@tooltip start@@@@@@@@ -->
 ...
 -->
						...
						<div class="form-group">						
							...
							<div class="col-sm-12 no-padding">	
	                      		...
	                      		<!-- <textarea type='text' id="txtExplain_mul" name="txtExplain_mul"  class="form-control tempinput " /> -->
	                      		<!-- @@@@@tooltip start@@@@@@@@ -->
						...
						<div class="form-group Optional_quiz">						
							...
							<div class="col-sm-12 no-padding">		
												<!-- name="txtInstruction" -->
	                      		<textarea type='text' id="txtExplain_mul" name="txtExplain_mul"  class="form-control tempinput "></textarea>
	                      		<!-- @@@@@tooltip start@@@@@@@@ -->
						...
						<!-- @@@@@@@@@@@@ tooltip end @@@@@@@@ -->
										</th> <th class="Optional_quiz">Check corrected answer
											<!-- @@@@@tooltip start@@@@@@@@ -->
 ...
 -->
					...
					<!-- 	<?php echo lang('que_tag');?> -->
						...
						<div class="form-group Optional_quiz">						
							...
							<div class="col-sm-12 no-padding">		
												<!-- name="txtInstruction" -->
	                      		<textarea type='text' id="txtExplain_media" name="txtExplain_media"  class="form-control tempinput "></textarea>
	                      		<!-- @@@@@tooltip start@@@@@@@@ -->
...
// alert(ins_id);
	var res = $.parseJSON(ins_id);
		...
		$(document).find('#Quejson_'+tempvalarray[1]).attr("data", up_que2);
		$(document).find('#Quejson_'+tempvalarray[1]).attr("marks", res[2][0].que_marks);
