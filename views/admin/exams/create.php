...
<div id="btn-sticky" >
	...
	<div style="float: right;"><button class='btn' style="float: right" id="Qupdate" type='button' >Create Question</button></div>
	<div style="float: right;"><button class='btn' style="float: right" id="Exist_ques" type='button' >Add Existing Question</button></div>
</div>
			  
		
		<!-- <div id="variety" style="" class="two_btn">
		...
		<div id="Qupload" style="display: none!important; padding-top: 20px;" class="qexist-table-sec">
			<div id="message" style="font-size: 18px;"></div>
			<div class="form-group">
				<label class='col-sm-12 no-padding control-label' for="name">Select Class<span class="required">*</span></label>
				<div class="col-sm-12 no-padding">
					<select class="autoQue Quecat1" style="float:left !important;" name="Quecat" id="Quecat_que1">
				...
				<label class='col-sm-12 control-label no-padding' for="name">Select Subject<span class="required">*</span></label>
							<div class="col-sm-12 no-padding">
								 <select class="autoQue Quesubcat1" style="float:left !important;" name="Quesubcat" id="Quesubcat_que1">
	                	<option value="" selected="selected">SELECT CLASS</option>
		                <?php $CI = & get_instance(); //used to load model inside view page
						$CI->load->model('admin/exam_model');
			...
			<div class="inner_content">
	            <form method="post" action="" enctype="multipart/form-data">
    				...
    				<div class="col-sm-4 col-md-4">
                  		<button type="button" id="upd_btn" class="btn  btn-lg" onclick="return upload();" style="width: 75% !important;">Import
                  		</button>
					</div>
            </form>
...
var cat = $('#Quecat_que1').val();
	var subcat = $('#Quesubcat_que1').val();
	new_formdata.append("Quecat", cat);
	new_formdata.append("Quesubcat", subcat);
      ...
      success:function(returndata)
      {
		...
		<div id="sectab">
			...
			<div class="sidebar_gap">
				...
				<textarea class="form-control form-height" id="secDesc" name="txtQuestion" class="form-control  tempinput editordesc" rows="6"/></textarea>
		...
		<div id="pagetab">
			...
			<textarea class="form-control form-height" id="pageDesc" name="txtQuestion" class="form-control tempinput editordesc" rows="6"/></textarea>
...
<div id="sticky-anchor">
	<div class='totshow'>
		<h4 class="Optional_quiz"><b>Total Questions : <span id="Qspan">0</span></b></h4>
	</div>
</div>
<div class="top-head-box">
<div id="sticky" class="">
	<h4 class="Optional_quiz" style="display: inline-block;margin: 8px 20px !important;">
...
<?php if ($parent_id != "0"): ?>
	...
	if($this->session->userdata('addExamToCourse'))
	{
		...
		?>
		<a href='<?php echo base_url().$this->session->userdata('addExamToCourse');?>' style="float: right;" class='btn '>Cancel</a>
		<?php
	}else
	{
		?>
		<a href='<?php echo base_url(); ?>admin/exams/examlist' style="float: right;" class='btn '>Cancel</a>
		<?php
	}
	?>
<?php else: ?>
...
<?php if ($qid != "0"): ?>
    ...
    <?php endif ?>
    		<a style="float: right; margin-right:10px;" class="btn " onclick="return validate()">Save</a>
                ...
                <!-- <input id="exam_id" type="hidden" class="" name="exam_id" maxlength="256" value="<?php echo (isset($quiz->exam_id) ? $quiz->exam_id : '0'); ?>" > -->
					<div class="form-group">
						...
						<div class="col-sm-9">
                           ...
                           <input id="ex_name" class="form-control form-height" type="text" class="" name="name" maxlength="256" value="<?php echo set_value('name', (isset($quiz->exam_title)) ? $quiz->exam_title : ''); ?>"   data-validation-error-msg="Enter valid exam name." />
...
<!-- tooltip area finish -->
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
                       	...
                       	<textarea class="form-control form-height" id="description" class="form-control form-height"  name="description22"  class="ex-desc" rows="6"/><?php echo ($this->input->post('description')) ? $this->input->post('description') : ((isset($quiz->description)) ? $quiz->description : ''); ?></textarea>
                      	<!-- tooltip area -->
                      	<textarea class="form-control form-height" id="ex_desc" class="form-control form-height" name="description" style="display: none" ><?php echo ($this->input->post('description')) ? $this->input->post('description') : ((isset($quiz->description)) ? $quiz->description : ''); ?></textarea>
...
<!-- tooltip area finish -->
                    ...
                    <div class="form-group">
	                        ...
	                        <div class="col-sm-9"> 
	                        <textarea class="form-control form-height" style="width: 100%" name="instructions" rows="4"></textarea></div>
                	</div>
                  ...
                  <div class="form-group" style="margin: 0px -30px">
                    ...
                    <div class="col-sm-6 Optional_quiz">
                        ...
                        <div class="col-sm-8">
	                        <input required="" class="form-control form-height"  name="pass_score" id="pass_score" type="number" min="0" max="100"  style="width: 100px;background-image: url('<?php echo base_url(); ?>public/images/percent.jpg')!important;background-repeat: no-repeat!important;background-position: center right 55%!important">
				...
				<div class="Optional_quiz">
                	<div class="form-group" style="margin: 0px -30px">
	                    <div class="col-sm-6">
	                        ...
	                        <textarea class="form-control form-height" required=""  name="pass_feedback" rows="4" >Congratulations, you passed.</textarea>
	                   ...
	                   <div class="col-sm-6">
	                        ...
	                        <textarea class="form-control form-height" required="" name="fail_feedback" rows="4" >Sorry, you failed.</textarea>
                    ...
                    <div class="col-xs-6 form-inline">
                        ...
                        <div class="row" id="exam_time" style="padding-top: 20px;margin-bottom: 0px;display: none" >
                                    <div class="col-sm-3" style="text-align: center;padding: 0px;margin: 0px;float: left;">
                                        <input name="duration_h" class="form-control form-height" hours-only="" type="text" style="width: 50px;text-align: center" placeholder="00"><br>Hours                           
                                    </div>
                                    <div class="col-sm-3" style="text-align: center;padding: 0px;margin: 0pxfloat: left;">
                                        <input class="form-control form-height" name="duration_m" id="duration_m" minutes-only="" type="text" style="width: 50px;text-align: center" placeholder="00"><br>Minutes                         
                                    </div>
                            </div>
                    </div>
                    <div class="col-xs-6 form-inline">
                        ...
                        <div class="row" id="wait_time" style="padding-top: 20px;margin-bottom: 0px;display: none">
                                    <div class="col-sm-3" style="text-align: center;padding: 0px;margin: 0px;">
                                        <input class="form-control form-height" name="wait_w" type="text"  weeks-only="" style="width: 50px;text-align: center"><br>Weeks                                   
                                         </div>
                                    <div class="col-sm-3" style="text-align: center;padding: 0px;margin: 0px">
                                        <input class="form-control form-height" name="wait_d" type="text" days-only="" style="width: 50px;text-align: center"><br>Days                                    
                                    </div>
                                    <div class="col-sm-3" style="text-align: center;padding: 0px;margin: 0px">
                                        <input class="form-control form-height" name="wait_h" type="text"  hours-only="" style="width: 50px;text-align: center"><br>Hours                                   
                                    </div>
                                    <div class="col-sm-3" style="text-align: center;padding: 0px;margin: 0px">
                                        <input class="form-control form-height" name="wait_m" type="text" minutes-only="" style="width: 50px;text-align: center"><br>Minutes                                    
                                    </div>
                                </div>
                    </div>
                </div>
...
<div class="page_block page ui-state-default sortable2" id="page_1">
 ...
 -->
	...
	<div class="page_block section ui-state-default sortable2" id="section_1" >		
		...
		<div class='Qjson' id="Quejson_1" style="display: none;" data="" marks=""></div>
...
<script src="<?php echo base_url(); ?>public/js/exam/exam.js?ver=14"></script>
...
jQuery(document).ready(function(){
	...
	$('#Exist_ques').on('click', function(){
		$(document).find('#Qform').hide();
		$(document).find('#Qexist').show();
		$(document).find('#Qupload').hide();
		$(document).find('.autoQue').find("option[value='']").attr('selected', true);
		$('table#dataTable tr:not(:first-child)').remove();
		$(document).find('#chk_all').prop("checked", false);
...
$('table#dataTable tr:not(:first-child)').remove();
	...
	$j.ajax({
	 type: 'POST',
        ...
        url: base_url+'admin/exams/GetClassQues',
        success: function(data){
        	if(data){
        	...
        	for (var i=0; i<= data.length - 1; i++) { 
        		var rowCount = table.rows.length;
			     ...
			     cell2.innerHTML = data[i]['cat']+data[i]['subcat'];
