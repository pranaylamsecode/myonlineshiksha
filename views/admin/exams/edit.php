...
<div id="sticky" class="">
	<h4 class="Optional_quiz" style="display: inline-block;margin: 8px 20px !important;"><b>Total Marks : <span id="mkspan"> <?php echo $quiz->total_marks ? $quiz->total_marks : '0'; ?> </span></b>
	<input value="<?php echo $quiz->total_marks ? $quiz->total_marks : '0'; ?>" name="total_marks" class='totmk' type="hidden"> 
	<input value="<?php echo (isset($quiz->exam_id) ? $quiz->exam_id : '0'); ?>" id="exam_id" name="exam_id" type="hidden"> </h4>
...
<?php if ($parent_id != "0"): ?>
	...
	?>
<?php else: ?>
<a href='<?php echo base_url(); ?>quizzes/<?php echo $page?>/' style="float: right;" class='btn '>Cancel</a>
<?php endif ?>
<?php else: ?>
<?php if ($qid != "0"): ?>
	    ...
	    <?php else: ?>
	    	 ...
	    	 <a href='<?php echo base_url(); ?>quizzes/newque/<?php echo $page?>/' style="float: right;" class='btn'>Cancel</a>

	    <?php endif ?>

    <?php endif ?>
    	<a style="float: right; margin-right:10px;" class="btn " onclick="return validate()">Update</a>
			...
			<div class="panel-body form-horizontal form-groups-bordered">
                ...
                <div class="form-group">
						...
						<div class="col-sm-9">
                           ...
                           <input id="ex_name" type="text " class="form-control form-height" name="name" maxlength="256" value="<?php echo set_value('name', (isset($quiz->exam_title)) ? $quiz->exam_title : ''); ?>"   data-validation-error-msg="Enter valid quiz name." />
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
                      	...
                      	<textarea id="description"  name="description22"  class="ex-desc form-control form-height" rows="6"/><?php echo ($this->input->post('description')) ? $this->input->post('description') : ((isset($quiz->description)) ? $quiz->description : ''); ?></textarea>
                      	<!-- tooltip area -->
                      	<textarea id="ex_desc" name="description" class="form-control form-height" style="display: none" ><?php echo ($this->input->post('description')) ? $this->input->post('description') : ((isset($quiz->description)) ? $quiz->description : ''); ?></textarea>
                    ...
                    <div class="form-group">
	                        ...
	                        <div class="col-sm-9"> 
	                        <textarea style="width: 100%" name="instructions" class="form-control form-height" rows="4"><?php echo ($this->input->post('instructions')) ? $this->input->post('instructions') : ((isset($quiz->instructions)) ? $quiz->instructions : ''); ?></textarea></div>
                	</div>
                	<div class="form-group">
                		<div class="">  
							<div class="checkbox">
                  ...
                  <div class="form-group" style="margin: 0px -30px">
                    ...
                    <div class="col-sm-6 Optional_quiz">
                        ...
                        <div class="col-sm-8">
                        <input required="" class="form-control form-height" name="pass_score" id="pass_score" type="number" min="0" max="100" value="<?php echo $quiz->passing_score ? $quiz->passing_score : ''; ?>" style="width: 100px;background-image: url('/public/images/percent3.jpg')!important;background-repeat: no-repeat!important;background-position: center right 55%!important">
				...
				<div class="Optional_quiz">
                	<div class="form-group" style="margin: 0px -30px">
	                    <div class="col-sm-6">
	                        ...
	                        <textarea required=""  name="pass_feedback" rows="4" class="form-control form-height" ><?php echo ((isset($quiz->pass_feedback)) ? $quiz->pass_feedback : 'Congratulations, you passed.'); ?></textarea>
	                    </div>
	                   <div class="col-sm-6">
	                        ...
	                        <textarea required="" name="fail_feedback" rows="4" class="form-control form-height"><?php echo ((isset($quiz->fail_feedback)) ? $quiz->fail_feedback : 'Sorry, you failed.'); ?></textarea>
	                    </div>
                  	</div>
                    <div class="form-group" style="margin: 0px -30px">
                            ...
                            <div class="radio-set radioGraySet">
                                ...
                                <label class="radio" style="margin-right: 20px">
                                    ...
                                    <div id="times" style="text-align: center;padding: 0px;margin: 0px;float: left;display: <?php  echo (($quiz->retake==1) ? 'block' : 'none'); ?> ">
                                        <select name="attempt_limit" class="form-control form-height" style="margin-left: 10px">
                    ...
                    <div class="col-xs-6 form-inline">
                        ...
                        <div class="row" id="exam_time" style="padding-top: 0px;margin-bottom: 0px;display: <?php  echo (($quiz->time_limit_b==1) ? 'block' : 'none'); ?>" >
                                    <div class="col-sm-3" style="text-align: center;padding: 0px;margin: 0px;float: left;width: auto;margin-right: 10px">
                                        <input name="duration_h" hours-only="" type="text" class="form-control form-height" style="width: 50px;text-align: center" value="<?php echo ((isset($quiz->duration_h)) ? $quiz->duration_h : ''); ?> " placeholder="00" ><br>Hours                           
                                    </div>
                                    <div class="col-sm-3" style="text-align: center;padding: 0px;margin: 0px;float: left;width: auto;">
                                        <input name="duration_m" minutes-only="" class="form-control form-height" type="text" style="width: 50px;text-align: center" value="<?php echo ((isset($quiz->duration_m)) ? $quiz->duration_m : ''); ?> " placeholder="00"><br>Minutes                         
                                    </div>
                            </div>
                    </div>
                    <div class="col-xs-6 form-inline">
                        ...
                        <div class="row" id="wait_time" style="padding-top: 20px;margin-bottom: 0px;display: <?php  echo (($quiz->wait_b==1) ? 'block' : 'none'); ?>" >
                                    <div class="col-sm-3" style="text-align: center;padding: 0px;margin: 0px;">
                                        <input name="wait_w" type="text" class="form-control form-height"   weeks-only="" style="width: 50px;text-align: center" value="<?php echo ((isset($quiz->wait_w)) ? $quiz->wait_w : ''); ?> " ><br>Weeks                                   
                                         </div>
                                    <div class="col-sm-3" style="text-align: center;padding: 0px;margin: 0px">
                                        <input name="wait_d" type="text" class="form-control form-height" days-only="" style="width: 50px;text-align: center" value="<?php echo ((isset($quiz->wait_d)) ? $quiz->wait_d : ''); ?> " ><br>Days                                    
                                    </div>
                                    <div class="col-sm-3" style="text-align: center;padding: 0px;margin: 0px">
                                        <input name="wait_h" type="text" class="form-control form-height" hours-only="" style="width: 50px;text-align: center" value="<?php echo ((isset($quiz->wait_h)) ? $quiz->wait_h : ''); ?> " ><br>Hours                                   
                                    </div>
                                    <div class="col-sm-3" style="text-align: center;padding: 0px;margin: 0px">
                                        <input name="wait_m" type="text" class="form-control form-height" minutes-only="" style="width: 50px;text-align: center" value="<?php echo ((isset($quiz->wait_m)) ? $quiz->wait_m : ''); ?> " ><br>Minutes                                    
                                    </div>
                                </div>
                    </div>
                </div>
...
<div id="main" class="no-padding paper_pattern sortable3" style="background-color: transparent !important;">
<?php
