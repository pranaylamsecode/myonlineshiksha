	...
	<div id="toolbar-box">
	  <div class="m">
	    <div class="pagetitle icon-48-generic">
	    	<h2><?php echo ($updType == 'create') ? 'Add new subscriber' : 'Edit subscriber'?></h2>
	    </div>
	  </div>
	</div>
     ...
     <?php } ?>
				...
				<form role="form" class="form-horizontal form-groups-bordered">
					...
					<div class="form-group form-border">
                        ...
                        <label class='col-sm-12 control-label field-title' for="name">Full Name</label>
                    ...
                    <div class="form-group">
                        ...
                        <label class='col-sm-12 control-label field-title' for="name"><?php echo "Email"; ?></label>
				...
				<a href='<?php echo base_url(); ?>admin/newsletter-subscriptions' class='btn btn-red btn-dark-grey'><span class="icon-32-cancel"> </span>Cancel </a>
						</div>
					</div>
				</form>
