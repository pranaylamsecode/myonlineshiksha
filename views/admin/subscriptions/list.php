...
<div id="toolbar-box">
	<div class="m">
		<div class="pagetitle icon-48-generic">
			...
			<h6 class="pmaintitle main_subtitle">Manage newsletter subscribers of your online academy. You can export the list of subscribers for any mailing service.</h6>
		</div>
        ...
        ?>
        	<div id="sticky-anchor"></div>
      			<ul id="sticky" style="list-style: none; float: right; display: flex;">
      				<li id="toolbar-new" class="listbutton" style="margin-right:10px;">
      					<a href="<?php echo base_url(); ?>admin/create/newsletter-subscription/"  class="btn ">
                <i class="entypo entypo-popup"></i>
      					<span class="icon-32-new"></span>Add Subscriber</a>
              </li>
              <li id="toolbar-new"  class="listbutton">
      					<a href="<?php echo base_url(); ?>admin/subscriptions/excelSheet/"  class="btn ">
...
foreach ($allpages as $eachpage): ?>
	<tr class="camp<?php echo $i;?>"> 
			...
			<td class="field-title " ><?php echo $eachpage->name;?></td>
			
			<td class="field-title " ><?php echo $eachpage->email;?></td>
            
            <td class="field-title "><?php echo $eachpage->date_time.' GMT';?></td>
