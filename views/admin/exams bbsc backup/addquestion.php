...
#errorRQuestion, #errorSQuestion, #errorRPoints, #errorROptions, #errorMLTQuestion, #errorMedPoints, #errorMLTOptions
{
	color: red;
	font-size: 15px;
}
	...
	<div class="col-md-12 no-padding">
		<div>
		    ...
		    <select onchange="dispTab(this.value)" style="width: 170px;" class="form-control qty" name="q_type" id="qtype">
				<option value="regular" class='Optional_quiz'>Single Choice</option>
	        	<!-- <option value="matching">Match The Pair</option> -->
	        	<!-- <option value="truefalse">True/False</option> -->
	        	<option value="mcq" class='Optional_quiz'>Multiple Choice</option>
					...
					<div class="tab-pane Que-tab-pane active" id="regular">
						...
						<div class="form-group">						
							...
							<div class="col-sm-12 no-padding">			
	                      		<textarea id="que_reg" name="Question_reg" class="form-control txteditor tempinput" rows="6"></textarea>
						...
						<label class="col-sm-12 no-padding control-label" for="question">Add Question Attachment</label>
						<div class="col-sm-12 no-padding">	
							<div class="form-group que_attach_dv">
							    <input name="que_attach" id="que_attach" type="file" onchange="previewFile(this);">
							    <!-- <button type="button" class="btn btn-default" onclick="return add_attachment()">Upload</button> -->
							</div>
							<div id="prev_div" style="display: none;position: relative;">
								<img id="previewImg" name="previewImg" src="" height="75px" width="90px">
								<button type="button" class="btn btn-danger" onclick="remove_img()"><i class="fa fa-times"></i></button>
							</div>
						</div>
						<script type="text/javascript">
							function remove_img(){
								$(".que_attach_dv").html('<input name="que_attach" id="que_attach" type="file" onchange="previewFile(this);">');
	...
	function dispTab(val)
	{
      ...
      var exam_type = $("input[name=exam_type]:checked").val();
		if(exam_type==3){
			...
			// $('q_type')
			$('select#qtype option[value="subjective"]').attr("selected", "selected");
			$('#qtype').val('subjective'); 
	    	$('.Que-tab-pane').removeClass("active");
			$('.Que-tab-pane#subjective').addClass("active");
		}
		else{
