...
<div id="sticky" class="">
	<h2 class="Optional_quiz" style="display: inline-block;margin: 8px 20px !important;">
		<b>Total Marks : <input style="width: 100px" value="0" name="total_marks" class='totmk'> </b>

		 <!-- <span id="mkspan"> 0 </span> -->
		<?php // $auth = $this->session->userdata('logged_in');
// $CI = & get_instance();
			// $temp_id = $CI->getActivationCode(); ?>
...
<?php if ($qid != "0"): ?>
    ...
    <?php endif ?>
    		<a style="float: right; margin-right:10px;" class="btn btn-danger" id="btn_save" onclick="return validate()">Save</a>
...
function validate(){
	...
	$("#btn_save").html('wait... <i class="fa fa-spinner fa-spin fa-1x fa-fw"></i>');
