...
<div class="pagetitle icon-48-generic"><h2>Pages</h2>
        <h6 class="pmaintitle main_subtitle" style="margin-bottom: 0px;"> Create pages of your academy. </h6>
        </div>
		...
		<a href="<?php echo base_url(); ?>admin/learningpage/createpage"  class="btn btn-green">
...
<table class="table table-bordered table-striped datatable dataTable" id="table-2" aria-describedby="table-2_info">
	<thead>
		...
		<tr role="row">
            ...
            <th class="sorting col-sm-3" role="columnheader" tabindex="0" aria-controls="table-2" rowspan="1" colspan="1" aria-label="Student Name: activate to sort column ascending"><div class="col-sm-12 no-padding table-title">Page Title</div></th>
            
           <th class="sorting col-sm-3" role="columnheader" tabindex="0" aria-controls="table-2" rowspan="1" colspan="1" aria-label="Curriculum / Occupation: activate to sort column ascending"><div class="col-sm-12 no-padding table-title">Modified date</div></th>
            
            <th class="sorting col-sm-3" role="columnheader" tabindex="0" aria-controls="table-2" rowspan="1" colspan="1" aria-label="Curriculum / Occupation: activate to sort column ascending"><div class="col-sm-12 no-padding table-title">Status</div></th>
	...
	?>
        ...
        <tr class="odd" id="camp<?php echo $i;?>">
            ...
            <?php if($eachpage->status == "active"){?>
                 ...
                 <a title="Publish" href="<?php echo base_url(); ?>admin/pagecreator/unpublish/<?php echo $eachpage->page_id; ?>/"><div class='sprite 9999published' style="background-position: -340px 0;"></div></a>        
		         <?php        }else{ ?>        
		        
                 <a title="Unpublish" href="<?php echo base_url(); ?>admin/pagecreator/publish/<?php echo $eachpage->page_id;?>/"><div class='sprite 999publish' style=" background-position: -308px 0;"></div></a>        
		         <?php } ?>      
            </td>
			...
			<td class="editdelete">
		        ...
		        ?>       
		        <a class='' href="<?php echo base_url(); ?>admin/learningpage/editPage/<?php echo $eachpage->page_id ?>/"><div class='sprite 2edit' style="background-position: -32px 0;" title="Edit page"></div></a>      
		        	<?php
		        	...
		        	<a class='' onClick="return deleteconfirm('<?php echo $eachpage->page_id?>')" ><div class='sprite 4delete' style="background-position: -92px 0; width: 18px;" title="Delete"></div></a>
		        	<?php
		        	}
		        	?>
...
var $ =jQuery.noConflict(); 
	function deleteconfirm(id)
	{
		 ...
		 $.confirm({
               ...
               content: ' ',
               confirm: function(){ 
                                window.location.href = "<?php echo base_url(); ?>admin/learningpage/delete/"+id;
