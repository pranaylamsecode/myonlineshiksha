 <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.3/jquery.min.js" data-cfasync="false"></script>
...
<table class="table table-bordered responsive scroll" style="width: 100%;font-size:15px;">
	<thead>
		<tr>
			...
			<th style="color:#000;font-weight:bold;width: 52%">Quiz title</th>
...
//if ($quiz != NULL && is_object($quiz)) {
   ...
   // }                              ?>
	...
	<tr class="camp<?php echo $i;?>"> 	    
		<td style="width:7%;"><?php echo $j; ?></td>
	    <td style="width:60.8%;"><a href="javascript:void(0);" onclick="javascript:addquiz(<?php echo $quiz->exam_id?>);"><?php echo $quiz->exam_title; ?></a></td>		
	   <?php  
	    ...
	    <td style="width: 10%"><?php echo $quiz->total_marks; ?></td>
