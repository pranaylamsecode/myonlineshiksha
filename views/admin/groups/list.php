...
<div id="toolbar-box">
	...
	<div class="m">
      <div class="pagetitle icon-48-generic"><h2><?php echo 'User Roles';?></h2></div>
  </div>
	<div id="toolbar" class="toolbar-list">
		...
		<ul id="sticky" style="list-style:none; float: right;">        
			<li id="toolbar-new" class="listbutton">
            	<a href="<?php echo base_url(); ?>admin/create/category/" onclick="Joomla.submitbutton('edit')" class="btn">
  ...
  <table class="table table-bordered table-striped datatable dataTable" id="table-2" aria-describedby="table-2_info">
	<thead>
		<tr role="row">
            ...
            <th class="sorting col-sm-6" role="columnheader" tabindex="0" aria-controls="table-2" rowspan="1" colspan="1" aria-label="Student Name: activate to sort column ascending"><div class="col-sm-12 no-padding table-title">Roles</div></th>            
...
<?php foreach ($groups as $group): ?>
		...
		<tr class="odd">
			...
			<td class="field-title"><?php echo $group->title?></td>
			...
			<td class=" ">
              ...
              <div class='sprite 2edit' style="background-position: -32px 0;" title="Edit"></div>
              </a>
