<div id="content-top">
    ...
    <a href='<?php echo base_url(); ?>/admin/categories/<?=$parent_id?>' class='bforward'><?=lang('web_back_to_list')?></a>
...
echo ($updType == 'create') ? form_open(base_url().'admin/categories/create', $attributes) : form_open(base_url().'admin/categories/edit', $attributes); 
?>
