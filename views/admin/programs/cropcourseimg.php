...
<script type="text/javascript">
    window.onload = function() {
    	var avatar = $("#imagname",parent.document).attr('src');
...
function addcrop(img,img_name)//for add to favorites
    ...
    $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>admin/programs/uploadcourseimg/<?php echo $this->uri->segment(4);?>/<?php echo $this->uri->segment(5);?>",
