...
<script type="text/javascript">
    window.onload = function() {
        ...
        if(seg == "logo")
        {
              var avatar = $("#imgnamelogo",parent.document).attr('src'); 
        ...
        if(seg == "icon")
        {
             var avatar = $("#imgnameficon",parent.document).attr('src');
              var img_name = $('#favname',parent.document).val();
         }
...
function addcrop(img,img_name)//for add to favorites
    ...
    $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>admin/templates/uploadlogo/<?php echo $this->uri->segment(4);?>",
            ...
            success: function(data)
            {
                ...
                $("#imgnamelogo",parent.document).attr('src', img); 
                $("#imgname2logo",parent.document).attr('src', img);
                }
                if(seg == "icon")
                {
                //$("#demoinput",parent.document).val(data);
                $("#imgnameficon",parent.document).attr('src', img);
                }
