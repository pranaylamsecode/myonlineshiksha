            ...
            <div class="form-group form-border "> 
              ...
              <div class="col-sm-12 no-padding"> 
                <div class="fileinput fileinput-new" data-provides="fileinput" style="width:100%;margin-bottom:0px;">
                  ...
                  <img src="<?php echo base_url('public/images/images/placeholder.png'); ?>" alt="..." id="imgname" class="img-responsive profile-image"> 
...
<!--
  /*
<div class="modal fade edit_lecture_popup" id="myModalyoutube" role="dialog">
    <div class="modal-dialog">
      ...
      <div> 
        ...
        <div class="tab-content tab-box" style="display: -webkit-box;">
            ...
            <div class="default_image">
                <img src="<?php echo base_url(); ?>public/images/dafault_img.jpg">
            </div>
          <form id="vimeoForm" action="<?php echo base_url(); ?>admin/tasks/upload_vimeo" method="post" enctype="multipart/form-data">
            ...
            <label class="control-label"></label> 
              ...
              <div class="col-sm-12 txt_cntr_algn no-padding"> 
                  <input type="hidden" name="vimeo_section_id" id="vimeo_section_id" value="<?php echo $this->uri->segment(4); ?>" class="form-control">                  
                  <input type="hidden" name="vimeo_course_id" id="vimeo_course_id" value="<?php echo $this->uri->segment(5); ?>" class="form-control">
          ...
          <div class="tab-pane" id="vimeo-medlib" style="width:100%;"> 
            <div class="col-sm-12" id="vimeo_row_list" style="height: 175px;overflow: auto;">
               <button onclick="vimeoLoadData(1)"><i class="entypo-refresh"></i>Check Status11</button>
          ...
          <div class="tab-pane" id="videoins" style="width:100%;"> 
            ...
            <div class="col-sm-12" style="display:block;padding: 0px;">
              ...
              <div class="form-group form-border ">
                ...
                <div class="col-sm-12 no-padding select_new_btn"> 
                  <input type="button" id="videourl" class="btn btn-blue" value="Insert video" onclick="addVideoUrlNEmbed(this.id)"/>
                  <i class="fas fa-cloud-upload-alt"></i>
                </div>
          ...
          <div class="tab-pane" id="videoiframe" style="width:100%;"> 
            ...
            <div class="col-sm-12" style="display:block;padding:0px;">
              ...
              <div class="form-group form-border ">
                ...
                <div class="col-sm-12 no-padding select_new_btn"> 
                  <input type="button" id="videoembed" class="btn btn-blue" value="Embed Video" onclick="addVideoUrlNEmbed(this.id)"/>
                  <i class="fas fa-cloud-upload-alt"></i>
                </div>
              ...
              <div class="col-sm-12 txt_cntr_algn no-padding"> 
                <div class="fileinput fileinput-new" data-provides="fileinput" style="padding-left:0px;">
                  ...
                  <a href="#" class="close fileinput-exists" data-dismiss="fileinput" style="float: none">×</a> 
                                    ...
                                    <p>(Only mpeg, mp3 format are allowed)</p> 
