    ...
    <div id="toolbar" class="toolbar-list">
      ...
      <ul id="sticky" class="main-content-btn" style="list-style: none; float: right;">
       ...
       <li id="toolbar-new" class="listbutton" style="float: left; margin-right: 10px;">
        ...
        <!-- <a id="preview_btn" onclick="openmyModalpreview();" class="btn btn-success btn-blue" title="Inform about this change made in lecture to all the enrolled students of this course." ><span class="icon-32-cancel"> </span>Preview</a> -->
...
<div class="pagetitle"><h2><?php echo ($updType == 'create') ? "Lecture editor" : "Lecture editor";//echo lang(($updType == 'create') ? "web_add_category" : "web_edit_category")?></h2></div>
      ...
      cache: false,
       ...
       //  beforeSend : function(msg){ <div id="overlay"><img  style="width: 35px; margin-left: 95px;height: 26px;" src="<?php echo base_url(); ?>public/images/loading.gif" /></div> },
        ...
        {    
            ...
            {
              console.log(msg);
              $('#message').text('Successfully saved the lecture');
            $('#message').show();
