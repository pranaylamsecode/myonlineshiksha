...
<div class="col-md-12">
		...
		<div class="panel panel-primary card mb-0" data-collapsed="0">
			...
			<div class="panel-body cardBody">
				<!-- <p class="btxt help_breadcrum"><b>Academy Content and Design > Other Pages</b></p>	 -->
			<ul class="">
				<li>	
				<p class="btxt"> You can add new pages in the online academy (other than Homepage) and edit the default pages as
shown in the video below.</p>

		
				</li>
				<video class="FAQ" controls  disablePictureInPicture controlsList="nodownload">
  <source src="<?php echo base_url('public/images/help/Video 1.mp4') ?>" type="video/mp4">
</video>
				<li>
					You cannot delete Pages of <b>Contact Us, About Your Academy</b> and <b>Terms of Use, but you can fully edit them,Rename and Unpublish them.</b>
				</li>
				<li>
					 Other pages which you can create can be shown in the drop down menu under main menu item of MORE, as been shown below.
					
					
				</li>
				<video class="FAQ" controls  disablePictureInPicture controlsList="nodownload">
  <source src="<?php echo base_url('public/images/help/video 2.mp4') ?>" type="video/mp4">
</video>
				<li>You can add videos, images, texts and HTML in those pages and save them.</li>
				<li>
 You can further link your pages to the text of the blocks displayed on the Home page.
</li><li>
 Add proper Title,description and keywords to each page in its editor for Search engine
optimisation.</li>
			</ul>	
				</div>
