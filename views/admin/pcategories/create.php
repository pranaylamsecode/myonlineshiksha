...
<div id="toolbar-box">
	<div class="m top_main_content">
		<div class="pagetitle icon-48-generic"><h2><?php echo lang(($updType == 'create') ? "web_add_category" : "web_edit_category")?></h2>
        <h6 class="pmaintitle main_subtitle" style="margin-bottom: 0px;">Here you can create the categories for course of your online acedemy. If you want to create new categories then don't select any parent category. If you want to create sub-category then select any of the existing category as a parent category.</h6>
        </div>
			...
			<form class="form-horizontal form-groups-bordered" autocomplete="off" enctype="multipart/form-data" action="">
				...
				<div class="form-group form-border">
					...
					<div class="col-sm-12">
                        ...
                        <span id="slugval" style="display:none;"><?php if(!empty($category->slug)){echo $category->slug;}?> </span>
         				<span id="avail" style="padding-left: 50px;display:none;"></span>
					</div>
				</div>
				<?php } ?>
				        ...
				        <div id="localimage_i">
				            <div class="col-sm-8 no-padding">
				                ...
				                <div class="edit_course_cat_btn">
				                   ...
				                   <button type="button" class="upimg_pop btn " onclick="$('#imgname').click()">Upload Image</button>
				                </div>
				            </div>
				        </div>
				    </div>
