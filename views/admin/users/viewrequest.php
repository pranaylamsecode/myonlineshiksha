...
<div id="toolbar-box">
	<div class="m">
		<div class="pagetitle icon-48-generic"><h2><?php echo (($updType == 'edit')?'External User Profile':'Create User');?></h2>
		<h6><?php echo (($updType == 'edit')?'Profile':'Create User');?></h6>
		</div>
...
<!-- tooltip area finish -->
			...
			<?php echo form_submit( 'submit', ($updType == 'edit') ? "Save Changes" : "Save Changes", (($updType == 'create') ? "id='submit' class='btn'" : "id='submit' class='btn btn-default btn-green'")); ?>
            
            <a href='<?php echo base_url() ?>admin/users/' class='btn'><span class="icon-32-cancel"> </span>Cancel</a>
						</div>
					</div>
				</fieldset>
