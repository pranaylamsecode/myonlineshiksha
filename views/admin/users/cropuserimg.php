...
<div class="container">
    ...
    <div class="action">
        <input type="file" id="file" style="float:left; width: 217px">
...
<script type="text/javascript">
    window.onload = function() {
    	var ii = $("#imgname",parent.document).attr('src');
...
function addcrop(img,img_name)//for add to favorites
    {
    	$.session.set('somekey', img);
    	//var ssget = $.session.get('somekey');
    		//alert(ssget);
    		
    	var croptype ="<?php echo $this->uri->segment(5);?>";
    $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>admin/users/uploadUserimg/<?php echo $this->uri->segment(4);?>/<?php echo $this->uri->segment(5);?>",
            ...
            {
                // console.log(data);
              $("#imgname",parent.document).attr('src', img);
                $("#userimg",parent.document).val(data);    
              console.log('data');
