...
echo ($updType == 'create') ? form_open_multipart(base_url().'admin/medias/createsectionmedia', $attributes) : form_open_multipart(base_url().'admin/medias/createsectionmedia/'.$id, $attributes);
