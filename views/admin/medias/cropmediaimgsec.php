...
function addcrop(img)//for add to favorites
    ...
    $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>admin/medias/uploadmadiaimg/<?php echo $this->uri->segment(4);?>/<?php echo $this->uri->segment(5);?>",
            data: {img:img}, 
            success: function(data)
            {
                
              // $("#imgname",parent.document).attr('src', img);
              //   $("#cropmedia",parent.document).val(data);    
              ...
              //parent.jQuery.fancybox.close(); 
               ...
               window.location ="<?php echo base_url();?>admin/medias/createlecturemedia/firstmedia/1";
               
               //$("#name",parent.document).val('images'); 

                $("#images2",parent.document).val(img);
