...
<div id="toolbar-box">
  <div class="m">
     <div class="pagetitle icon-48-generic"><h2>Enrolled Students</h2></div>
    ...
    <div class=" top-head-box">
      <div id="table-3_length">
        <span >
              <input type="text" id="search_text" class="form-control form-height" maxlength="30" onkeyup="return get_payout(1,'enrolled-users')">
        </span>
        <span>
...
<script type="text/javascript">
  ...
  function get_payout(pay_page,controller) {
    ...
    $.ajax({
      ...
      type : "post",
      cache : false,
      data :  {pay_page : pay_page, teacher_id : teacher_id, search_text : search_text},
