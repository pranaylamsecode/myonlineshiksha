...
#table-3_filter input, #table-3_filter select, #table-3_filter label {
	width: 100% !important;
}
#table-3_filter {
	float: right;
...
<div id="toolbar-box">
	<div class="m">
		...
		<div class="pagetitle icon-48-generic"><h2><?php echo 'Orders';?></h2></div>
	</div>
</div>
<br>
<div class='clear'></div>
...
<div class='clear'></div>
	...
	<thead>
		<tr role="row">
            ...
            <th class="sorting col-sm-1" role="columnheader" tabindex="0" aria-controls="table-2" rowspan="1" colspan="1" aria-label="Average Grade: activate to sort column ascending" style="text-align: center;"><div class="col-sm-12 no-padding table-title">Ordered Date</div></th>
            
            <th class="sorting col-sm-1" role="columnheader" tabindex="0" aria-controls="table-2" rowspan="1" colspan="1" aria-label="Average Grade: activate to sort column ascending" style="text-align: center;"><div class="col-sm-12 no-padding table-title">Referral Code</div></th>
            
            <th class="sorting col-sm-1" role="columnheader" tabindex="0" aria-controls="table-2" rowspan="1" colspan="1" aria-label="Average Grade: activate to sort column ascending" style="text-align: center;"><div class="col-sm-12 no-padding table-title">Amount Paid</div></th>
...
<!--<td><?php //echo $order->id;?></td>-->
			...
			<td class="field-title" style="text-transform: capitalize;color: #949494;text-align:center!important;"><?php echo $order->amount; //echo $this->users_model->getPrice(@$coursearr[0]); ?></td>
			...
			<td class="field-title" style="text-transform: capitalize;color: #949494;text-align:center!important;"><?php if(!empty($order->referred_code)){ echo $order->referred_code;}else{ echo "-";}?></td>
			<td class="field-title" style="text-transform: capitalize;color: #949494;text-align:center!important;"><?php echo $order->amount_paid;?></td>
            ...
            <select name='status_id<?php echo $order->id; ?>' id='status_id<?php echo $order->id; ?>' class="form-control" onchange="statusorders(<?php echo $order->id; ?>,<?php echo $order->userid; ?>,<?php echo @$coursearr[0]; ?>);" >
									...
									<option value="SUCCESS" <?php echo ( @$order->status == 'SUCCESS' || @$order->status == 'Completed' )? 'selected="selected"' : '' ?> >Completed</option>
		...
		?>
			...
			<a class='col-sm-6 no-padding' href="<?php echo base_url(); ?>admin/orders/edit/<?php echo $order->id; ?>"><div class='sprite 2edit' style="background-position: -32px 0;" title="Edit order"></div></a>
