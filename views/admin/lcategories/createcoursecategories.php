...
label.labelforminline {
  padding-left: 2%;
  color: #000!important;
  font-weight: bold!important;
}
.col-sm-offset-3.col-sm-5.btn-width {
  width: 100%!important;
  margin: 0px auto;
  text-align: center;
}
...
echo form_open_multipart(base_url().'admin/pcategories/savecategory', $attributes);
...
<div id="toolbar-box">
	...
	<div class="m">
		...
		<div class="panel-title">
				<p class="pmcat">Create Category </p>
...
<span class="error"><?php echo form_error('name'); ?></span>
					...
					<div class="form-group">
						...
						<label class='col-sm-3 control-label' for="description"><?php echo "Description";?></label>
						<div class="col-sm-5">							
                            <textarea name="description" id="description" class="form-control" rows="6" placeholder="Description"><?php echo ($this->input->post('description')) ? $this->input->post('description') : ((isset($category->description) && $category->description!='') ? $category->description : ''); ?></textarea>
...
<!-- tooltip area finish -->
                    ...
                    <div class="form-group">
						...
						<label class='col-sm-3 control-label' for='category_id'>Parent Category</label>
						<div class="col-sm-5">
							<?php 
							$CI = & get_instance();
							$CI->load->model('admin/pcategories_model');
							$categories1 = $this->pcategories_model->getcategoriespop();
							//echo"<pre>";
							//print_r($categories1);
							//echo $categories1;
							//echo"</pre>";
...
?>
                   ...
                   <div id="localimage_i">
                      ...
                      <img src="<?php echo base_url();?>public/uploads/pcategories/img/<?php echo ($this->input->post('imagename')) ? $this->input->post('imagename') : 'no_images_category.png'?>" width="150" id="imgname">
                      <input type="hidden" id="cropimage" name="cropimage" value="" >
                      </div>
                      <div class="btn-right">
                      <a href="<?php echo base_url(); ?>admin/pcategories/cropcategoryimgpop/"  class="fancybox fancybox.iframe btn btn-success" onclick="setvalues()">Upload Image</a>
                      </div>
...
<!-- tooltip area finish -->
	<?php //echo form_error('published'); ?>
                    ...
                    <br/>
					<div class="form-group">
						<div class="col-sm-offset-3 col-sm-5 btn-width">
							
                            <a>
			<?php //echo form_submit( 'submit', 'Save',  "id='submit' class='btn btn-default'"); ?>
         					</a>
                          <input type="button" name="save" id="save" value="Save" onclick="create_category();">  
...
{	
	...
	$("#empty_msg").text("Name and Description are mandatory fields.");
	 return false;
	     ...
	     jQuery.ajax({
	        type: "POST",
	        url: "<?php echo base_url('admin/pcategories/savecategory'); ?>",
