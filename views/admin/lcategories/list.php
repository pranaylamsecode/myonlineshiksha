        ...
        <?php if(isset($category->parent_id) && $category->parent_id>0)
        {
            ...
            <?php
                ...
                ?>
                    ...
                    <?php }else{?>
                    <a title="Click to Publish Category" type="button" onclick="return change_Status(<?php echo $category ->id.','.$category->published;?>)"><div class='sprite 999publish center' style=" background-position: -308px 0;"></div></a>
