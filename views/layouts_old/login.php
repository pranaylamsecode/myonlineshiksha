...
<div class="login-container">	
	...
	<div class="login-bottom-links" style="padding-top: 10px; text-align: center;">© <?php echo date('Y') ?> 
		<a target="_top" href="<?php echo base_url(); ?>" id="link-forgot-passwd">
			<?php $academy_nm = substr(base_url(), 8,-5);
			 ?>
    	 <span><?php //echo $academy_nm."
    	 echo " Network Mastery University, All Rights Reserved.​ "; ?></span>
        </a>
	</div>
