...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
	...
	<link rel="stylesheet" href="<?php echo base_url("assets/css/neon-core-min.css"); ?>" />-->
	<link rel="stylesheet" href="<?php echo base_url("assets/css/neon-theme.css"); ?>" />
	<!--<link rel="stylesheet" href="<?php echo base_url("assets/css/neon-theme-min.css"); ?>" />-->
	<link rel="stylesheet" href="<?php echo base_url("assets/css/custom.css"); ?>" />
	<link rel="stylesheet" href="<?php echo base_url("assets/css/neon-core.css"); ?>" />
    <link rel="stylesheet" href="<?php echo base_url("assets/css/skins/white.css"); ?>" />
	<!--<link rel="stylesheet" href="<?php echo base_url("assets/css/rickshaw/rickshaw.min.css"); ?>" />-->
...
<body class="page-body skin-white loaded" data-url="http://demo.neontheme.com" cz-shortcut-listen="true">
<?php
...
<div id="mlmspopdiv">
    ...
    <div class="popdiv">
        ...
        <input type="text" name="institutename" id='institutename' value="" placeholder="Enter your institute name here..." class="popinput" /><div id="institutenameerror"></div>
...
<div id="mlmspopdiv">
    ...
    <div class="popdiv">
        ...
        <table>
            ...
            </tr>			<tr><td colspan="2"><div id='logouplaoderror'></div></td></tr>
    ...
    <div class="popdiv">
        ...
        <table width="100%" cellpadding="0" cellspacing="0" class="tablelayout">
          ...
          <tr>
            ...
            <td><input type="radio" checked="checked" name="topmenu" value='0' checked="checked" />Left <input type="radio" name="topmenu" value='1'  />Right</td>
          ...
          <tr>
            ...
            <td><input type="radio" checked="checked" name="searchbox" value="0" checked="checked" />Enable <input type="radio" name="searchbox" value="1" />Disable</td>
          ...
          <tr>
            ...
            <td><input type="radio" checked="checked" name="signupbox" value='0' checked="checked" />Left <input type="radio" name="signupbox" value='1' />Right</td>
          ...
          <tr>
            ...
            <td><input type="radio" checked="checked" name="sidebar" value='0' checked="checked" />Left <input type="radio" name="sidebar" value='1' />Right</td>
...
<div class="page-container">	
	...
	<div class="sidebar-menu" style="min-height: 1409px;">
		...
		<header class="logo-env" style="background-color: rgba(207, 207, 207, 0.61);">
			...
			<div class="logo">
				<a href="#">
					<img src="http://216.185.43.221/prshah8333/public/img/admin/logo.png" alt="">
				</a>
			</div>
			...
			<div class="sui-normal">
				<a href="#" class="user-link">
					<img src="http://demo.neontheme.com/assets/images/thumb-1.png" alt="" class="img-circle">
					
					<span>Welcome,</span>
					<strong>Admin (VeerIT)</strong>
				</a>
			</div>
...
<li class="active root-level">
	...
	<li class="root-level has-sub">
        <a href="#"><i class="entypo-layout"></i><span>Users Management</span></a>
        	<ul class="visible">
                	<?php
                    if(($u_data['groupid']=='4') || ($maccessarr['users']=='modify_all'))
                    {
                 	?>
					<li class="active root-level">
					<a href="<?php echo base_url(); ?>admin/groups/create/1"><span>Create Group</span></a>
					</li>
                 	<?php
                  	}
                 	?>
					...
					<li class="active root-level">
					<a href="<?php echo base_url(); ?>admin/groups/"><span><?=lang('web_groups')?></span></a>
					</li>
                    ...
                    if(($u_data['groupid']=='4') || ($maccessarr['users']=='modify_all'))
                    {
                 	?>
					<li class="active root-level">
					<a href="<?php echo base_url(); ?>admin/users/create/"><span>Create User</span></a>
					</li>
					<?php
					}
					?>
					...
					<li class="active root-level">
					<a href="<?php echo base_url(); ?>admin/users/"><span>Users</span></a>
					</li>
                	...
                	?>
					<li class="active root-level">
					<a href="<?php echo base_url(); ?>admin/aclp/"><span>Access Permissions</span></a>
					</li>
					 <?php
                		}
                	?>           
...
?>
	...
	<!--<li class="root-level">
		<a href="#" target="_blank"><i class="entypo-monitor"></i><span>Frontend</span></a>
	</li>
-->
<?php
if($u_data['groupid']==='4')
{
 ?>
<li class="root-level has-sub">
		<a href="#"><i class="entypo-newspaper"></i><span>Settings</span></a>
		<ul style="opacity: 0.19999999999999996; height: 0px;" class="">
		<li>
			<a href="<?php echo base_url(); ?>admin/settings/"><span><?php echo 'General'?></span></a>
		</li>

		<li>
			<a href="<?php echo base_url(); ?>admin/settings/layouts"><span><?php echo 'Layouts'?></span></a>
		</li>

		<li>
			<a href="<?php echo base_url(); ?>admin/settings//progressbar"><span><?php echo 'Progress Bar'?></span></a>
		</li>

		<li>
			<a href="<?php echo base_url(); ?>admin/settings/emailsetting"><span><?php echo 'Email'?></span></a>
		</li>

		<li>
			<a href="<?php echo base_url(); ?>admin/settings/promotionbox"><span><?php echo 'Promotion box'?></span></a>
		</li>

		<li>
			<a href="<?php echo base_url(); ?>admin/settings/quizcountdown"><span><?php echo 'Quiz Countdown'?></span></a>
		</li>

		<li>
			<a href="<?php echo base_url(); ?>admin/certificates"><span><?php echo 'Certificates'?></span></a>
		</li>

		<li>
			<a href="<?php echo base_url(); ?>admin/sociallinks/createLink"><span><?php echo 'Social Links'?></span></a>
		</li>

		<li>
			<a href="<?php echo base_url(); ?>admin/settings/sociallogins"><span><?php echo 'Social Logins'?></span></a>
		</li>
...
<!--<li class="root-level has-sub">
		...
		<li>
			<a href="#"><i class="entypo-inbox"></i><span>Inbox</span></a>
		</li>

		<li>
			<a href="#"><i class="entypo-pencil"></i><span>Compose Message</span></a>
		</li>

		<li>
			<a href="#"><i class="entypo-attach"></i><span>View Message</span></a>
		</li>
...
?>
<li class="root-level has-sub">
		<a href="#"><i class="entypo-doc-text"></i><span>Managers</span></a>
		<ul style="opacity: 0.2; height: 0px;">
		...
		<li>
			<a href="<?php echo base_url(); ?>admin/orders/"><span>Users Report</span></a>
		</li>

		<li>
			<a href="<?php echo base_url(); ?>admin/promocodes/"><span>Promocodes</span></a>
		</li>

		<li>
			<a href="<?php echo base_url(); ?>admin/testimonials/"><span>Testimonials</span></a>
		</li>

		<li>
			<a href="<?php echo base_url(); ?>admin/userreport/"><span>Data Validation</span></a>
		</li>
		<?php /* ?>  <li><span class="file">
		...
		<li>
			<a href="<?php echo base_url(); ?>admin/studreport/"><span>Report</span></a>
		</li>

		<li>
			<a href="<?php echo base_url(); ?>admin/pagecreator/"><span>Page Manager</span></a>
		</li>

		<li>
			<a href="<?php echo base_url(); ?>admin/widgets/"><span>Widgets</span></a>
		</li>

		<li>
			<a href="<?php echo base_url(); ?>admin/templates/"><span>Templates</span></a>
		</li>
		<li>
            <a href="<?php echo base_url(); ?>admin/subscriptions/"><span>Subscriptions</span></a>
		</li>
		</ul>
</li>
<?php 
...
<!--<li class="root-level has-sub">
		<a href="#"><i class="entypo-window"></i><span>Tables</span></a>
		

		<ul style="opacity: 0.2; height: 0px;">
		<li>
			<a href="#"><span>Basic Tables</span></a>
		</li>

		<li>
			<a href="#"><span>Data Tables</span></a>
		</li>
...
?>
<li class="has-sub">
		<a href="#"><i class="entypo-flow-tree"></i><span>Training</span><!--<span class="badge badge-info badge-roundless">New Items</span>--></a>
		<ul style="opacity: 0.2; height: 0px;">
       		 <?php
              ...
              ?>
			<li class="has-sub">
				<a href="<?php echo base_url(); ?>admin/programs/"><span><?php echo 'Courses'; //echo lang('web_products')?></span>
            	<!--<span class="badge badge-success">3</span>--></a>
				<ul>
					<li>
						<a href="<?php echo base_url(); ?>admin/pcategories/"><span><?php echo 'Course Categories'; //echo lang('web_products')?></span></a>
					</li>
			        <?php /* ?>
					<li>
                    <span class="file">
           <a href="<?php echo base_url(); ?>admin/programs/" style="background-position: 0px 0px;"><?php echo 'Courses'; //echo lang('web_products')?></a>
            ...
            <?php
                ...
                ?>
				<li class="has-sub">
                <a href="#"><span class="folder"><?php echo 'Media Library'; //echo lang('web_products')?></span></a>
                
					<ul>
                        <li>
						<a href="<?php echo base_url(); ?>admin/mcategories/"><span><?php echo 'Media Categories'; //echo lang('web_products')?></span></a>
						</li>

                        <li>
                        <a href="<?php echo base_url(); ?>admin/medias/"><span><?php echo 'Media'; //echo lang('web_products')?></span></a>
                        </li>
					</ul>
				</li>
               <?php  } ?>
               ...
               if(($u_data['groupid']==='4')||(in_array('quizzes',$this->session->userdata('mparr'))))
               {
                ?>
				<li>
                <a href="<?php echo base_url(); ?>admin/quizzes/" style="background-position: 0px 0px;">
				<span><?php echo 'Quizzes'; //echo lang('web_products')?></span>
                </a>
                </li>
              	<?php  } ?>
         </ul>
...
?>
		<li class="has-sub">
			<a href="#"><i class="entypo-bag"></i><span>Subscriptions</span></a>
		<ul>
			<li>
				<a href="<?php echo base_url(); ?>admin/subplans/"><span><?php echo 'Sub Plans'; //echo lang('web_products')?></span></a>
			</li>

			<li>
				<a href="<?php echo base_url(); ?>admin/subplans/create/"><span><?php echo 'Create Sub Plans'; //echo lang('web_products')?></span></a>
			</li>
		</ul>
		</li>
<?php } ?>
...
?>
		...
		<ul>
			<li>
				<a href="<?php echo base_url(); ?>admin/teachercourses/"><span><?php echo 'Courses'; ?></span></a>
			</li>
		</ul>
		</li>
<?php } ?>
		...
		<ul>
			<li>
				<a href="<?php echo base_url(); ?>admin/blogs/"><span><?php echo 'Blog List'; ?></span></a>
			</li>
		</ul>
		</li>
		...
		<ul>
			<li>
				<a id="coursewizardshooter" href="<?php echo base_url(); ?>admin/smartcoursemanager/">
                <span><?php echo 'Smart Course Manager Wizard'; ?></span>
                </a>
			</li>
...
</li>				<div id="ascrail2001" class="nicescroll-rails" style="padding-right: 3px; width: 10px; z-index: 1000; position: absolute; top: 0px; left: -10px; height: 0px; cursor: default; display: none;"><div style="position: relative; top: 0px; float: right; width: 5px; height: 0px; background-color: rgb(212, 212, 212); border: 1px solid rgb(204, 204, 204); background-clip: padding-box; border-top-left-radius: 1px; border-top-right-radius: 1px; border-bottom-right-radius: 1px; border-bottom-left-radius: 1px;"></div></div><div id="ascrail2001-hr" class="nicescroll-rails" style="height: 7px; z-index: 1000; top: -7px; left: 0px; position: absolute; cursor: default; display: none;"><div style="position: relative; top: 0px; height: 5px; width: 0px; background-color: rgb(212, 212, 212); border: 1px solid rgb(204, 204, 204); background-clip: padding-box; border-top-left-radius: 1px; border-top-right-radius: 1px; border-bottom-right-radius: 1px; border-bottom-left-radius: 1px;"></div></div></ul>
...
<li class="external">
	<a href="http://demo.neontheme.com/mailbox/main/">All Messages</a>
</li>				<div id="ascrail2002" class="nicescroll-rails" style="padding-right: 3px; width: 10px; z-index: 1000; position: absolute; top: 0px; left: -10px; height: 0px; cursor: default; display: none;"><div style="position: relative; top: 0px; float: right; width: 5px; height: 0px; background-color: rgb(212, 212, 212); border: 1px solid rgb(204, 204, 204); background-clip: padding-box; border-top-left-radius: 1px; border-top-right-radius: 1px; border-bottom-right-radius: 1px; border-bottom-left-radius: 1px;"></div></div><div id="ascrail2002-hr" class="nicescroll-rails" style="height: 7px; z-index: 1000; top: -7px; left: 0px; position: absolute; cursor: default; display: none;"><div style="position: relative; top: 0px; height: 5px; width: 0px; background-color: rgb(212, 212, 212); border: 1px solid rgb(204, 204, 204); background-clip: padding-box; border-top-left-radius: 1px; border-top-right-radius: 1px; border-bottom-right-radius: 1px; border-bottom-left-radius: 1px;"></div></div></ul>
...
</li>				<div id="ascrail2003" class="nicescroll-rails" style="padding-right: 3px; width: 10px; z-index: 1000; position: absolute; top: 0px; left: -10px; height: 0px; cursor: default; display: none;"><div style="position: relative; top: 0px; float: right; width: 5px; height: 0px; background-color: rgb(212, 212, 212); border: 1px solid rgb(204, 204, 204); background-clip: padding-box; border-top-left-radius: 1px; border-top-right-radius: 1px; border-bottom-right-radius: 1px; border-bottom-left-radius: 1px;"></div></div><div id="ascrail2003-hr" class="nicescroll-rails" style="height: 7px; z-index: 1000; top: -7px; left: 0px; position: absolute; cursor: default; display: none;"><div style="position: relative; top: 0px; height: 5px; width: 0px; background-color: rgb(212, 212, 212); border: 1px solid rgb(204, 204, 204); background-clip: padding-box; border-top-left-radius: 1px; border-top-right-radius: 1px; border-bottom-right-radius: 1px; border-bottom-left-radius: 1px;"></div></div></ul>
	...
	<div class="col-md-6 col-sm-4 clearfix hidden-xs">
		...
		<ul class="list-inline links-list pull-right">
				...
				<a href="#" class="dropdown-toggle" data-toggle="dropdown" data-close-others="true">
					<img src="http://demo.neontheme.com/assets/images/flag-uk.png">
				</a>
				
				<ul class="dropdown-menu pull-right">
					<li>
						<a href="#">
							<img src="http://demo.neontheme.com/assets/images/flag-de.png">
							<span>Deutsch</span>
						</a>
					</li>
					<li class="active">
					...
					<li>
						<a href="#">
							<img src="http://demo.neontheme.com/assets/images/flag-fr.png">
							<span>François</span>
						</a>
					</li>
					<li>
						<a href="#">
							<img src="http://demo.neontheme.com/assets/images/flag-al.png">
							<span>Shqip</span>
						</a>
					</li>
					<li>
						<a href="#">
							<img src="http://demo.neontheme.com/assets/images/flag-es.png">
							<span>Español</span>
						</a>
					</li>
				</ul>
...
<footer class="main">
	...
	<?php //$this->load->view('admin/template/header');?>
		...
		<span class="navtreewrap" style="float:left;display:inline;">

		<?php

        //$this->load->view("admin/partials/treeview");?>
		...
		<script type="text/javascript">$(function() {	$('#logoimage').live('change',function(e) {	 var ftpfilename;		 filenameerror = '';		$.ajaxFileUpload({		url :'<?php echo base_url(); ?>admin/admin/upload_image/',		secureuri :false,		fileElementId :'logoimage',		dataType : 'json',		success : function(data,status)		{              $('#ajax11').html(data.msg);		   if(data.status == 'success')		   {			ftpfilpreview = '<img src="<?php echo base_url(); ?>/public/uploads/settings/img/'+data.filename+'" width="164px" height="44px">';			$('#previewimage').html(ftpfilpreview);			ftpfilename = data.filename;			document.getElementById("logoimagename").value = ftpfilename;			$('#logouplaoderror').html('');			}else{			ftpfilename = data.filename;			document.getElementById("logoimagename").value = ftpfilename;			if(ftpfilename==''){			filenameerror = '';			}			$('#logouplaoderror').html('<span class="error">'+data.msg+'</span>');			}		}		});	});			$('#wimage').live('change',function(e) {	 var ftpfilename;		$.ajaxFileUpload({		url :'<?php echo base_url(); ?>admin/admin/upload_welcome_image/',		secureuri :false,		fileElementId :'wimage',		dataType : 'json',		success : function(data,status)		{              $('#ajax11').html(data.msg);		   if(data.status == 'success')		   {			ftpfilpreview = '<img src="<?php echo base_url(); ?>/public/uploads/settings/img/'+data.filename+'" width="164px" height="44px">';			$('#previewwelcomeimage').html(ftpfilpreview); 			ftpfilename = data.filename;			document.getElementById("wimagename").value = ftpfilename;			$('#wimageerror').html('');			}else{			ftpfilename = data.filename;			document.getElementById("wimagename").value = ftpfilename;			if(ftpfilename==''){			filenameerror = '';			}			$('#wimageerror').html('<span class="error">'+data.msg+'</span>');			}		}		});	});	});</script><script>  $(document).ready( function() {	     $('#wdesc').redactor();	 $('#adesc').redactor(); } );
...
<!--<script type="text/javascript" src="<?php echo base_url("assets/js/main/gsap.js"); ?>"></script>-->
...
<script type="text/javascript" src="<?php echo base_url("assets/js/cookies.min.js"); ?>"></script>
<script type="text/javascript" src="<?php echo base_url("assets/js/jvectormap/jquery-jvectormap-1.2.2.min.js"); ?>"></script>
<script type="text/javascript" src="<?php echo base_url("assets/js/jvectormap/jquery-jvectormap-europe-merc-en.js"); ?>"></script>
<script type="text/javascript" src="<?php echo base_url("assets/js/jquery.sparkline.min.js"); ?>"></script>
<script type="text/javascript" src="<?php echo base_url("assets/js/rickshaw/vendor/d3.v3.js"); ?>"></script>
<script type="text/javascript" src="<?php echo base_url("assets/js/rickshaw/rickshaw.min.js"); ?>"></script>
...
<!--<script type="text/javascript" src="<?php echo base_url("ga.js"); ?>"></script>-->

<!--<script type="text/javascript" src="<?php echo base_url("assets/js/aci-tree/js/jquery.aciTree.core.js"); ?>"></script>
<script type="text/javascript" src="<?php echo base_url("assets/js/aci-tree/js/jquery.aciTree.min.js"); ?>"></script>
<script type="text/javascript" src="<?php echo base_url("assets/js/aci-tree/js/jquery.aciTree.persist.js"); ?>"></script>
<script type="text/javascript" src="<?php echo base_url("assets/js/aci-tree/js/jquery.aciTree.hash.js"); ?>"></script>-->
