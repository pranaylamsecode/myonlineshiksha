            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-8 col-xs-12 newBannerContant">
                        <h1>कक्षा 11वीं मास्टर क्लासेज 2021-22</h1>
                    ...
                    <div class="col-sm-4 col-xs-12 rightDetailBox">
                        <div class="content">
                            <div class="innercontent">
                                <div class="innersect">
                                    <div class=""> <img src="https://vidyakul-courses.s3.ap-south-1.amazonaws.com/fulllivecourse/new-full-livecourse/82990.jpg
" width="100%">
                                        </div>
                                </div>
                                        ...
                                        <div class="plan changeplan active" id="changeplan20" data-id="20"> <span class="radio checked"><i class="fa fa-check" aria-hidden="true"></i></span>
                                            <div class="flex space-between full-width">
                                                <div class="plan-detail flex columnwise justify-center">
                                                    <h4 class="ellipsis" title="Target 2022 Exams">टारगेट 2022 परीक्षा</h4>
                                                    <h5>परीक्षा 2022 के लिए</h5> </div>
                                                <div class="price-detail">
                                                    <h4 class="priceamount" data-price="₹2499">
                                                        ₹2499
                                                        </h4>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-8">
                  ...
                  Join Class 11th <span>Online</span> Tuition
               </h2>
                        <div class="features-top">
                            ...
                            <div class="subscription">
                              ...
                              subscription starts from
                                        ...
                                        <h4>₹ 799/month</h4> </div>
                                    <div> <a href="https://vidyakul.com/class-11th/subscription-plans" class="start_learning_btn_page subscriptionbtnCTA" data-source="Explore Page Top">
                           Get Subscription
                           </a> </div>
                                </div>
                            </div>
            ...
            <div class="bundles-section1">
                <div class="row">
                    <div class="flex space-between align-center full-width mb-30">
                        <p class="live_class_title">Top Educators</p> <a href="https://vidyakul.com/class-11th/top-educators" class="see-all-btn see_all_CTA" data-source="Explore Page Top Educators">See All</a> </div>
            ...
            <div class="bundles-section1">
                <div class="row">
                    ...
                    <div class="mastercourses">
                        <div class="slider">
                            <a href="https://vidyakul.com/live-course-profile/class-11th-zoology-masterclasses-2021-22" class="slider__item">
                                <div class="lockblock"> <i class="fa fa-lock" aria-hidden="true"></i> </div> <img src="https://vidyakul-courses.s3.ap-south-1.amazonaws.com/fulllivecourse/new-full-livecourse/43773.jpg" alt="MixCourse"> 
                            </a>
                            <a href="https://vidyakul.com/live-course-profile/class-11th-masterclasses-2021-22" class="slider__item">
                                <div class="lockblock"> <i class="fa fa-lock" aria-hidden="true"></i> </div> <img src="https://vidyakul-courses.s3.ap-south-1.amazonaws.com/fulllivecourse/new-full-livecourse/82990.jpg" alt="MixCourse"> 
                            </a>
                            <a href="https://vidyakul.com/live-course-profile/class-11th-zoology-masterclasses-2021-22" class="slider__item">
                                <div class="lockblock"> <i class="fa fa-lock" aria-hidden="true"></i> </div> <img src="https://vidyakul-courses.s3.ap-south-1.amazonaws.com/fulllivecourse/new-full-livecourse/43773.jpg" alt="MixCourse"> 
                            </a>
                    ...
                    <div class="flex justify-center full-width mt-20"> <a href="https://vidyakul.com/class-11th/subscription-plans" class="start_learning_btn_page subscriptionbtnCTA" data-source="Explore Page Master classes">
                         Get Subscription
                        </a> </div>
                </div>
            </div>
