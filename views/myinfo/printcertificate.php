...
<form name="savePdf" method="post" action="<?php echo base_url() ?>/myinfo/pdf/<?php echo $date_completed;  ?>/<?php echo $coursename; ?>/<?php echo $author_name; ?>/<?php echo $certificateid; ?>/<?php echo $cid; ?>">
