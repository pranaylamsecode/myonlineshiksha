...
// $imagename[0]["templates1"]  = str_replace("[LOGO_IMG]", $logoimg, $imagename[0]["templates1"]);

?>

<table style="padding-top:0px;padding-bottom: 0px; padding-left:90px; color:<?php echo "#".$imagename[0]["design_text_color"]; ?>">
    <tr>
        <td>
    ...
    <tr>
        <td style="text-align: center;margin-top: -10px;"><img src="<?php echo base_url() ?>public/uploads/settings/img/logo/<?php echo $logoimg; ?>" title="<?php echo base_url() ?>" > </td>
    </tr>
</table>
