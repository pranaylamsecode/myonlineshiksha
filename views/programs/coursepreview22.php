...
.box .element-view-content > .bx-wrapper > .bx-viewport, .box #sldrhght_2, .box #sldrhght_1 {
	width: 100% !important;
	height: auto !important;
}
.box[data-type="Gallery"] .bx-wrapper {
...
.box[data-type="Gallery"] .bx-wrapper img {
...
.ud-lectureangular > div, .asset-container #media_15 {
	padding-left: 0px !important;
}
.asset-container {
	padding: 0% 2% 2%;
}
.quiz_timer .panel-title p {
...
$(document).ready(function(){
	...
	window.location.href = "<?php echo base_url(); ?>admin/programs/";	
