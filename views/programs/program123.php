...
input#promoapply {
  ...
  text-shadow: none;
  background-color: rgb(1, 106, 193);
}
span.strikediag {
  padding: 0px 0.15em;
...
<div class="section" data-id="1"> 
  ...
  <div style="padding: 0;"> <?php echo $programs->description;?>
    ...
    <hr />
     <?php if (!$days && $programs->webstatus == 'active' && $programs->course_type == '2') { 
     $proid = $this->uri->segment(3);
     $webinar = $this->programs_model->getWebinar2($proid); 
       ?>

     <p><b>Schedule On :
      <a><?php $date = new DateTime($webinar->fromdate); echo $date->format('d M y').' at '. $webinar->fromtime; ?></b></a>
   </p>
   <p><b>Lecture Duration : <a><?php echo $webinar->web_duration." mins"; ?></a></b></p>
    <?php 
  } 
    ...
    <p><b>Certificate term:</b>
      <?php
            ...
            ?>
          <?php if($webinars){ ?>
    </p><hr/><br><h3>Webinars</h3>
    <b><div class="col-sm-5">Title </div> <div  style="float:left">Webinar Schedule </div> <div style="float:right">Duration </div></b><br>
<br/>
    <?php    foreach ($webinars as $webinars) {   ?>

      <b><div id="web" ><div class="col-sm-5"><?php echo $webinars->title; ?></div>
        <span class="fa fa-calendar-check-o" style="">
        <?php $date = new DateTime($webinars->fromdate); echo $date->format('d M y').' at '. $webinars->fromtime;?></span>
   
   <div style="float:right"><?php echo $webinars->web_duration." mins"; ?></div></div></b>
   <hr/>
   <?php } ?>
 ...
 <?php }  } else { ?>
  ...
  <?php
      ...
      ?>
  <?php 
 if ($days  || ($programs->webstatus == 'active' && $programs->course_type == '2'))
 // if ($days)
{
?>
  ...
  <div class="leftcontent">
    <div id="coursesection">
      ...
      <div id="coursesectionlecture">
        <?php
       // $lessons11 = $this->Program_model->get_all_Quiz($day->id);
       //  echo '<pre>'; print_r($lessons11);
...
?>
      ...
      ?>
              ...
              <div class="cattext1">
                ...
                <i class="entypo-clipboard" style=" margin-right: 10px;"></i> 
                <!--<span><?php echo ucfirst($lesson->name);?></span>--><!--</a>-->
                <div class="lect-text"><?php echo ucfirst($lesson->name);?></div>
                <!--<span style='float:right'><?php echo ucfirst($texty);?></span>-->
                <div class="lect-text1" style='float:right'><?php if($lesson->lecture_duration){echo ucfirst($lesson->lecture_duration);}else{
                  echo '00.00 Hrs';}?></div>
                <br>
              </div>
...
?>
  <div class="leftcontent"> 
    ...
    <?php      
      ...
      <div id="coursesection">
    <div class="title">- Final Exam 
    <span style="float:right;padding-right: 13px;max-width: 94px;">Duration</span></div>
    ...
    <div class="cattext1">
      <div class="smltext" style="margin-top:12px;">
                ...
                <i class="entypo-book" style=" margin-right: 10px;"></i> 
              
                <div class="lect-text"><?php echo $finalexaminfo->name ?></div>
               
                <div class="lect-text1" style="float:right"><?php echo $finalexaminfo->limit_time." Mins"; ?></div>
                <br>
              </div>
              </div>
              <div class="submtwo"> 
    <?php    
    // print_r($finalexaminfo);
      //  echo $finalexaminfo->name;
...
<!---Average Rating-->
  ...
  if(intval($programs->fixedrate) == 0.00 && ($default_plans['0']['default_new']) == 1)
  {
    ...
    <strike> <span style="color: #54b551;font-size: 16px;font-weight: 700;margin-top: 5px;"><?php  if($assigned) { echo ''; } else if(intval($programs->demoprice) > 0) { echo $currency_symbol.$programs->demoprice;} else { echo "";} ?></span></strike>
    ...
    ?>
        ...
        else if(($default_plans['0']['default_new']) == 1) 
          { 
            echo $currency_symbol.$default_plans['0']['price']." / <span style='color: #54b551;font-size: 16px;font-weight: 600;'>".$default_plans['0']['term']." ".$default_plans['0']['period']."</span>"; } else { echo "FREE"; } ?></span> </p>
    ...
    else
    {
        ?>
      <div>
      <p style="text-align:center;"><strong style="font-size:18px; text-transform:uppercase; font-weight: 600;">Price :</strong><strike> <span style="color: #54b551;font-size: 18px;font-weight: 700;margin-top: 5px;"><?php  if($assigned) { echo ''; } else if(intval($programs->demoprice) > 0) { echo $currency_symbol.$programs->demoprice;} else { echo "";} ?></span></strike> <span style="color: #54b551;font-size: 26px;font-weight: 700;margin-top: 5px;"><?php  if($assigned) { echo 'FREE'; } else if(intval($programs->fixedrate) > 0) { echo $currency_symbol.$programs->fixedrate;} else { echo "FREE";} ?></span> </p>
          ...
          else
          {
            if($programs->course_type == '2')
            {
             ...
             if($webinars2->attendees_limit == '' || $webinars2->attendees_limit > $en_count )
             {
               ...
               echo "id='go'".' '."rel='leanModal'".' '."name='signup'".' '."href='#signup'".' '."onclick='showEnrollnotify()'";
             }
            }
            else
            {             
    ...
    if(($programs->pre_req!= '0') || ($programs->pre_req_books != '0') || ($programs->reqmts != '0') || count($preq_reqt) > 0)
    {
    ?>
        <div class="rightsidebar-1"> 
...
<div id="payment"  style="display: none; position: fixed; opacity: 1; z-index: 11000; left: 50%; margin-left: -202px; top: 100px;">
  <div id="payment-ct"> 
   ...
   // echo form_open_multipart(base_url().'programs/payment', $attributes); 
    ...
    <div id="promoApplyContainer" style="padding-top: 10px;padding-bottom: 43px;border-bottom-style: inset;border-bottom-width: 1px;">
        <div style="float: left;width: 48%;padding-left: 8px;padding-top: 7px;padding-bottom: 9px;">
        
          <span style="font-weight: 900;font-size: 20px;">price :</span>
          <span id="pricerate1" class="pricerate2"><?php  if($assigned) { echo ''; } else if(intval($programs->fixedrate) > 0) { echo $currency_symbol.$programs->fixedrate;} else { echo "";} ?></span>

          <span id="pricerate2" class="pricerate2"></span>
          
        </div>
        <div style="float: left;width: 35%;">
        <input type="text" value="" id="promocode" name="promocode" placeholder="Enter promocode" style="height: 36px;width: 97%;"></div>
          <div style="float: left;"><input class="apply" type="button" value="Apply" onclick="promoApply()" name="promoapply" id="promoapply"></div>
        
        <div style="float: left;width: 100%;text-align: center;padding-bottom: 5px;"><span id="promoMSg" ></span></div>
...
<!-- The number of attendees has reached its maximum limit.
...
<div id="cta-sticky">
 ...
 <ul class="stick-menu">
  ...
  if(intval($programs->fixedrate) == 0 && ($default_plans['0']['default_new']) == 1)
  {
    ...
    ?>
        <div >
        <p class="course-price-text">Price :
<strike> <span style="color: #54b551;font-size: 16px;font-weight: 700;margin-top: 5px;"><?php  if($assigned) { echo ''; } else if(intval($programs->demoprice) > 0) { echo $currency_symbol.$programs->demoprice;} else { echo "";} ?></span></strike>
        <span>
    <?php 
      if(($default_plans['0']['default_new']) == 1) 
    ...
    ?>
        <div>
        <p class="course-price-text">Price :
        <strike> <span style="color: #54b551;font-size: 18px;font-weight: 700;margin-top: 5px;"><?php  if($assigned) { echo ''; } else if(intval($programs->demoprice) > 0) { echo $currency_symbol.$programs->demoprice;} else { echo "";} ?></span></strike>
        <span>
        <?php if($assigned) { echo 'FREE'; } 
    ...
    else
    {
      ...
      <p class="course-price-text">Price :<strike><span><?php  if($assigned) { echo ''; } else if(intval($programs->demoprice) > 0) { echo $currency_symbol.$programs->demoprice;} else { echo "";} ?></span></strike>  <span><?php  if($assigned) { echo 'FREE'; } else if(intval($programs->fixedrate) > 0) { echo $currency_symbol.$programs->fixedrate;} else { echo "FREE";} ?></span> 
...
// var countDownDate = new Date("<?php echo $webinar->fromdate.' '.$webinar->fromtime; ?>").getTime();

// // Update the count down every 1 second
// var x = setInterval(function() {

//     // Get todays date and time
//     var now = new Date("<?php echo $gmdate; ?>").getTime();
...
function promoApply()
      {
               ...
               {  
                   ...
                   console.log(data);            
                    ...
                    else
                    {
                       ...
                       $("#coupencode").val(promocode);
                       $("#pricerate1").addClass("strikediag");
                       $("#pricerate1").removeClass("pricerate2");
                       $("#pricerate1").addClass("pricerate1");                       
                       $("#pricerate2").html('$'+data);
                       $("#promoapply").attr("disabled",true);
                       $("#promoMSg").css("color","green");
                       $("#promoMSg").html('Congratulation! Promo code has been applied');
                    }
               }
       ...
       {
        alert("Please Enter Promocode Here");
       }
