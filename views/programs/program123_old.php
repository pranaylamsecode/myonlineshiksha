...
<div style="width:100%;background-color:black;height: 350px;padding: 30px;">
	<div class="coursecontentholder">
		<div style="float: left;padding-right: 20px;"><img src="<?php echo base_url(); ?>public/uploads/programs/img/<?php echo $programs->image;?>"></div>
		<div class="head55d">
        <h1 style="color:white;font-weight:bold;"><?php echo $programs->name; ?></h1>

        <h3 style="font-weight:bold;"><?php echo character_limiter(strip_tags($programs->description),120); ?></h3>
		</div>
