...
?>
      ...
      ?>
              ...
              ?>
                ...
                <!--<span><?php echo ucfirst($lesson->name);?></span>--><!--</a>-->
                <div class="lect-text"><?php echo ucfirst($lesson->name);?></div></div>
                <!--<span style='float:right'><?php echo ucfirst($texty);?></span>-->

                <!-- <div class="lect-text11" style='float:right'><?php echo ucfirst($texty);?> -->
                <div class="lect-text11" style='float:left;'>

                <?php
                  $cnt = $lesson->lecture_content;
                //echo $cnt;
                if (strpos($cnt, 'Paragraph') !== false) {
                      echo 'Paragraph'.'</br>';
                }
                if (strpos($cnt, 'Videos') !== false) {
                      echo 'Video'.'</br>';
                }
                if (strpos($cnt, 'Flash') !== false) {
                      echo 'Flash'.'</br>';
                }
                if (strpos($cnt, 'Audio') !== false) {
                      echo 'Audio'.'</br>';
                }
                if (strpos($cnt, 'Gallery') !== false) {
                      echo 'Gallery'.'</br>';
                }
                if (strpos($cnt, 'Pdf') !== false) {
                      echo 'Pdf'.'</br>';
                }
                if (strpos($cnt, 'Image') !== false) {
                      echo 'Image'.'</br>';
                }
...
jQuery(document).ready(function(){
    jQuery("#lect_toggle").click(function(){
        jQuery(".lect-text11").toggle();
    });
});
</script>