...
foreach ($days as $day)
{
  ...
  <div class="leftcontent">
    <div id="coursesection">
      <div class="title"> <?php echo "Section ".++$i." : ".$day->title; ?>
      ...
      <div id="coursesectionlecture">
        ...
        <ul class="course_cat1">
          ...
          { 
            $entypo = 'entypo-book';
            //$texty = 'Text';
            $texty = "<i class='entypo entypo-text-doc-inverted'></i>";
          }
...
<!---Average Rating-->
  ...
  if(intval($programs->fixedrate) == 0.00 && ($default_plans['0']['default_new']) == 1)
  {
    ...
    ?>
        ...
        <p style="text-align:center;"><strong style="font-size:18px; text-transform:uppercase; font-weight: 600;">Price1 :</strong>
    ...
    ?>
        <div style="padding:15px; margin-top:10px;">
        <p style="text-align:center;"><strong style="font-size:18px; text-transform:uppercase; font-weight: 600;">Price2 :</strong> 
    ...
    else
    {
        ?>
      <div>
      <p style="text-align:center;"><strong style="font-size:18px; text-transform:uppercase; font-weight: 600;">Price3 :</strong> <span style="color: #54b551;font-size: 26px;font-weight: 700;margin-top: 5px;"><?php  if($assigned) { echo 'FREEs'; } else if(intval($programs->fixedrate) > 0) { echo $currency_symbol.$programs->fixedrate;} else { echo "FREEss";} ?></span> </p>
...
//echo $this->Program_model->checkEnrolled($user_id,$pro_id);
  ...
  //        }
    ...
    // {      
      ...
      echo '<a target="_blank" style="color:#0C0C0C; text-align:left; padding:10px; display: block;" href="'.base_url()."public/uploads/$pathurl/".$exfileinfo->media_title.'"><i class="entypo-attach"></i>|'.$exfileinfo->alt_title.'</a>';
    }
    ?>
      </div>
      <hr />
    ...
    <form id="subs_option" >
      ...
      <div style="width:100%; padding-top: 10px;">
        ...
        <div style="margin-top: 15px; float: left;">
                <h3 style="float:left; margin-right: 10px; margin-left: 45px;">Price4 :&nbsp;<i class="fa fa-usd"></i><?php echo $currency_symbol.$prog_plan->price; ?></h3>
...
function showodiv(j)
{
  ...
  document.getElementById("price").value = price.toFixed(2); //returns 2489.82
...
<div id="cta-sticky">
 ...
 <ul class="stick-menu">
  ...
  if(intval($programs->fixedrate) == 0 && ($default_plans['0']['default_new']) == 1)
  {
    ...
    ?>
        <div >
        <p class="course-price-text">Price5 :<span>
    <?php 
      if(($default_plans['0']['default_new']) == 1) 
      {
        echo $currency_symbol.$default_plans['0']['price']." / <span style='color: #54b551;font-size: 16px;font-weight: 600;'>".$default_plans['0']['term']." ".$default_plans['0']['period']."</span>"; 
    ...
    ?>
        <div>
        <p class="course-price-text">Price6 :<span>
        <?php if($assigned) { echo 'FREE'; } 
    ...
    else
    {
      ...
      <p class="course-price-text">Price7 :<span><?php  if($assigned) { echo 'FREE'; } else if(intval($programs->fixedrate) > 0) { echo $currency_symbol.$programs->fixedrate;} else { echo "FREE";} ?></span> 
