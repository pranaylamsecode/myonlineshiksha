...
function addcrop(img)//for add to favorites
    {
    	var croptype ="<?php echo $this->uri->segment(3);?>";
    $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>programs/uploadcategoryeimg",
            data: {img:img},
            ...
            success: function(data)
            {
                ...
                $("#setimg",parent.document).val(data);
                 window.location.href ='<?php echo base_url(); ?>programs/createcategory';
