...
<div class="table-scroll-resp" style="overflow-x:auto;">
	<div style="padding:0 20px;">
        ...
        <hr />-->
        <input type="hidden" id="teacher_id" name="teacher_id" value="<?php echo $teacher_info->id; ?>" />
        <input type="hidden" id='teacher_email' name="teacher_email" value="<?php echo $teacher_info->email; ?>" />
        <input type="hidden" id='your_name' name="your_name" value='<?php echo $name; ?>' />
        ...
        <table width="90%">
        	...
        	<tr>
            	<td><span style="color: #c42140;"> Your Message </span></td>
            </tr>
            
          
            <tr>
            	<td><textarea placeholder="Type your message..."  name="ask_question" id="ask_question" class="tform"></textarea></td>
            </tr>

            <tr>           
              <td><span id="msgsuccess"> </span></td>
            </tr>
            
            <tr>
                <td align="center"><input type="button" onclick="sendmsg()" name ="submit" class="btn-primary_red" value="Send Message" /></td>
            </tr>
...
//function sendmsg(follow_id, student_id)//for add to favorites
function sendmsg()//for add to favorites
{
	...
	$.ajax({
			type: "POST",
			url: "<?php echo base_url(); ?>programs/send_mail",
			data: {teacher_id:teacher_id,teacher_email:teacher_email,your_name:your_name,program_id:program_id,ask_question:ask_question}, 
