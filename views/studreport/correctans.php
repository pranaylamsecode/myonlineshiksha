...
?>
 <div id="editcell">
        <table class="table table-bordered responsive" width="100%">
            ...
            <table class="table table-bordered1 table-background responsive" style="font-size:15px">
                <thead>
                    <tr>
                        <th style="background-color:rgb(241, 241, 241);color:#000;"width="25%">Question</th>   
                        <th><?php echo $ques_data->question ?>
                        	<br/>
                        	<?php
					...
					<tr>
                        <th style="background-color:rgb(241, 241, 241);color:#000;" width="25%">Question Type</th>   
                        <th><?php echo $ques_data->question_type ?></th>                     
					</tr>
					<tr>
                        <th style="background-color:rgb(241, 241, 241);color:#000;" width="25%">Options</th>     
                        <th>
                        	<table>
                        		<thead>
                        		    <?php
