...
<thead>
				<tr>					
					...
					<th style="font-weight: bold">Enrolled Students1</th>
            ...
            <?php
				...
				<tr class="odd camp<?php echo $i;?>">
					<td class="product_name"><?php echo $eachcourse->name ?></td>
					<?php
...
<img align="viewed" src="<?php echo base_url();?>public/default/images/viewed.png" title="View Course Report">
                 ...
                 ?>
                 <?php if(!$courses) { ?> 
                 	<tr><td colspan="4">No certificate approved yet.</td></tr>
                 <?php }?>
...
padding: 10px;
font-size: 16px;
background-color: rgba(208, 209, 210, 0.2); font-weight:bold; text-align:center;'>User Detail</div>
</tr>
...
padding: 10px;
font-size: 16px;
background-color: rgba(208, 209, 210, 0.2); font-weight:bold; text-align:center;'>Course Detail</div>
</tr>
...
<table class="table table-bordered">
		<thead>
			<tr>
				<th colspan=2 class="text-center" style="font-size:16px;">Certificate Details</th>
			</tr>
		</thead>		
		<tbody>
			<tr>
		...
		?>
			<tr>
				...
				<td align='left' style="font-weight:bold;">Yes</td>
			</tr>
			<tr>
				<td class="text-center">Issued By</td>
				<td align='left' style="font-weight:bold;"><?php echo $this->programs_model->getUserName($certiStatus->issued_by); ?></td>
			</tr>
			<tr>
				<td class="text-center">Issued On</td>
				<td align='left' style="font-weight:bold;"><?php echo $certiStatus->issued_on.' GMT' ?></td>
			</tr>
		<?php
			}
			else
